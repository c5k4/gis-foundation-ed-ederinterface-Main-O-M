echo off
rem ===========================================================================
rem EDG_Map_Prod_01_DC1.bat
rem ---------------------------------------------------------------------------
rem This script starts the PSPS Map Production 1.0
rem 
rem Open a command window.
rem Navigate to script location.
rem Usage:  PSPS_Map_Prod.bat
rem This script will be run from Task Scheduler.
rem
rem Author: Carl Wei
rem ===========================================================================
...
if "%~1" == "" (
   echo Enter circuit list separated by commas
   goto end
)
echo %~1
set oldcircuits=%~1
set circuits=%oldcircuits:$=,%
echo %circuits%

cd /d "D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\PSPSMapProduction\"

rem set command=call "D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\PSPSMapProduction\Bin\PSPSMapProduction.exe" 1 %circuits%
set command=call "PSPSMapProduction.exe" 1 %circuits%
