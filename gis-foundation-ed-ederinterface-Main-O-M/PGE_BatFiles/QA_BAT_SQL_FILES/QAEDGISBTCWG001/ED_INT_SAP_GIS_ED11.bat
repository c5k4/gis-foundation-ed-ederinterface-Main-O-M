...
rem ===========================================================================
rem InterfaceIntegrationGatewayED11.bat
rem ---------------------------------------------------------------------------
...
rem Usage:  InterfaceIntegrationGatewayED11.bat
rem         
...
rem ---------------------------------------------------------------------------
reg copy       "HKCU\Control Panel\International" "HKCU\Control Panel\Int-Temp-ED11" /f >nul
...
set date_log=%date%
reg copy       "HKCU\Control Panel\Int-Temp-ED11" "HKCU\Control Panel\International" /f >nul
reg delete     "HKCU\Control Panel\Int-Temp-ED11"                                    /f >nul
rem ===========================================================================
...
echo ERRORCheck: %error_level%								>> %file_log_tmp% 2>&1
set /A error_level=%error_level% + %ERRORLEVEL%
