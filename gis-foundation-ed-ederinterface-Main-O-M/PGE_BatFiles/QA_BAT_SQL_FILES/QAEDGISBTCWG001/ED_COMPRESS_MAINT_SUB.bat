...
rem ===========================================================================
rem EDG_Compress_Maint_Sub.bat
rem ---------------------------------------------------------------------------
...
rem Usage:  EDG_Compress_Maint_Sub.bat
rem         
...
set DbType=EDERSUB_QA

set filename_script_01=EDG_sdemon_pause.bat
...
rem ---------------------------------------------------------------------------
reg copy       "HKCU\Control Panel\International" "HKCU\Control Panel\Int-Temp-Cmprs-Mnt-SuB" /f >nul
...
set date_log=%date%
reg copy       "HKCU\Control Panel\Int-Temp-Cmprs-Mnt-SuB" "HKCU\Control Panel\International" /f >nul
reg delete     "HKCU\Control Panel\Int-Temp-Cmprs-Mnt-SuB"                                    /f >nul
rem ===========================================================================
...
for /f %%a in ('PGE_DBPasswordManagement.exe GETPASSWORD SDE@EDERSUB_QA') do set "SDE_PWD=%%a"


sqlplus sde/"%SDE_PWD%"@EDERSUB_QA @"D:\edgisdbmaint\16_AfterOracle_restart_KeysetTableDrop_v2.sql"
