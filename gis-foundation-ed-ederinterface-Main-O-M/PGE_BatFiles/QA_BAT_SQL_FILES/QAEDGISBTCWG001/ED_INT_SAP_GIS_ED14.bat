...
rem ===========================================================================
rem InterfaceIntegrationGatewayED14.bat
rem ---------------------------------------------------------------------------
...
rem Usage:  InterfaceIntegrationGatewayED14.bat
rem         
...
rem ---------------------------------------------------------------------------
reg copy       "HKCU\Control Panel\International" "HKCU\Control Panel\Int-Temp-ED14" /f >nul
...
set date_log=%date%
reg copy       "HKCU\Control Panel\Int-Temp-ED14" "HKCU\Control Panel\International" /f >nul
reg delete     "HKCU\Control Panel\Int-Temp-ED14"                                    /f >nul
rem ===========================================================================
