echo off
rem ===========================================================================
rem EDG_ED_POWERBASE_TO_GIS.bat
rem ---------------------------------------------------------------------------
...
rem Usage:  EDG_ED_POWERBASE_TO_GIS.bat
...
set path_exe="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\PGE_PBGISUpdates"
set file_name_exe=Powerbase_To_GIS.exe
...
rem ---------------------------------------------------------------------------
reg copy       "HKCU\Control Panel\International" "HKCU\Control Panel\Int-Temp-Powerbase" /f >nul
...
set date_log=%date%
reg copy       "HKCU\Control Panel\Int-Temp-Powerbase" "HKCU\Control Panel\International" /f >nul
reg delete     "HKCU\Control Panel\Int-Temp-Powerbase"                                    /f >nul
rem ===========================================================================
