...
set filename_script_01=ED_sdemon_pause_ed_maint.bat
...
rem ---------------------------------------------------------------------------
reg copy       "HKCU\Control Panel\International" "HKCU\Control Panel\Int-Temp-Cmprs-Mnt" /f >nul
...
set date_log=%date%
reg copy       "HKCU\Control Panel\Int-Temp-Cmprs-Mnt" "HKCU\Control Panel\International" /f >nul
reg delete     "HKCU\Control Panel\Int-Temp-Cmprs-Mnt"                                    /f >nul
rem ===========================================================================
...
for /f %%a in ('PGE_DBPasswordManagement.exe GETPASSWORD SDE@EDER_QA') do set "PASSWORD=%%a"

sqlplus -s sde/%PASSWORD%@EDER_QA @"D:\edgisdbmaint\16_AfterOracle_restart_KeysetTableDrop_v2.sql"
