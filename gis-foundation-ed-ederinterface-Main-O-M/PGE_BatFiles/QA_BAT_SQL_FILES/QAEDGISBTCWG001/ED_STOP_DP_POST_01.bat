...
taskkill /F /IM "D:\Program Files (x86)\Miner and Miner\ArcFM Solution\Bin\GeodatabaseManagerServices.exe"
...
call sc config %ServiceName3% start= disabled                 >> %file_log% 2>&1
call net stop %ServiceName3%                                  >> %file_log% 2>&1
call sc config %ServiceName4% start= disabled                 >> %file_log% 2>&1
