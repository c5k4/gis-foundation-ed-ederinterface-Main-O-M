echo off
rem ===========================================================================
rem EDG_Clean_Session_Mgr_Sub.bat
rem ---------------------------------------------------------------------------
rem This script runs an executable that cleans orphan sessions from the GDBM.
rem 
...
rem Usage:  EDG_Clean_Session_Mgr_Sub.bat
...
set file_name_exe=PGE.BatchApplication.OrpanVersionCleanUp.exe -c Substation
...
rem ---------------------------------------------------------------------------
reg copy       "HKCU\Control Panel\International" "HKCU\Control Panel\Int-Temp-CLN-SN-MGR-SUB" /f >nul
...
set date_log=%date%
reg copy       "HKCU\Control Panel\Int-Temp-CLN-SN-MGR-SUB" "HKCU\Control Panel\International" /f >nul
reg delete     "HKCU\Control Panel\Int-Temp-CLN-SN-MGR-SUB"                                    /f >nul
rem ===========================================================================
...
if "%error_level_orig%" equ "1" set /A error_level=0
if "%error_level_orig%" equ "1" set /A error_level_orig=0
