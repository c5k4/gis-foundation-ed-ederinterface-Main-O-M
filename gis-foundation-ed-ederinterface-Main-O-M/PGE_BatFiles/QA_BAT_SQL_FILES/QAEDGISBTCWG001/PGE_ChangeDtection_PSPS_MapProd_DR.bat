echo off
rem Script Name: ED_PGE_ChangeDtection_PSPS_MapProd_DR.bat
...
set cmdPath="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\PGE_ChangeDetection_PSPS_MapProd"
set cmdLine="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\PGE_ChangeDetection_PSPS_MapProd\PGE_ChangeDtection_PSPS_MapProd.exe"
