...
for /f %%a in ('PGE_DBPasswordManagement.exe GETPASSWORD SDE@EDSUBPUB_QA_DC2A') do set "PASSWORD=%%a"

sqlplus -s sde/%PASSWORD%@EDSUBPUB_QA_DC2A @"D:\edgisdbmaint\16_AfterOracle_restart_KeysetTableDrop_v2.sql"
