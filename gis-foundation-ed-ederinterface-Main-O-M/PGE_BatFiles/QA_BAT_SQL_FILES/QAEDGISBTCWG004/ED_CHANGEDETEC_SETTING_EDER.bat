...
set cmdLine="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\Change Detection\PGE.BatchApplication.ChangeDetection.exe" -c SettingsDeltasToEderEtl.config
...
rem echo ""Executing MP_INIT_TABLECOPY"" 						>> %file_log% 2>&1
