echo off
rem Script Name: EDG_ChangeDetection_EDER_CIT.bat
...
set cmdLine="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\Change Detection\PGE.BatchApplication.ChangeDetection.exe" -c EDER_CIT.config
