echo off
rem ===========================================================================
rem Script Name: EDG_Process_CDW.bat
rem Created: Wednesday, July 16, 2014 10:34:03 AM
...
rem Set script variables.
rem ---------------------------------------------------------------------------
rem from prod: set cmdPath="D:\TLM\Utility\"

set cmdPath="D:\TLM\Utility"
set cmdLine=SMUtilityExport.exe TLM CDW
