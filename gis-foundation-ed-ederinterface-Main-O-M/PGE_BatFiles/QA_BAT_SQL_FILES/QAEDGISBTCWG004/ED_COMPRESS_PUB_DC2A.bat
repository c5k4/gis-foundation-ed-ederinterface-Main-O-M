...
rem Usage:  ED_COMPRESS_PUB_DC2A.bat
rem         
...
for /f %%a in ('PGE_DBPasswordManagement.exe GETPASSWORD SDE@EDPUB_QA_DC2A') do set "PASSWORD=%%a"

sqlplus -s sde/%PASSWORD%@EDPUB_QA_DC2A @"D:\edgisdbmaint\16_AfterOracle_restart_KeysetTableDrop_v2.sql"
