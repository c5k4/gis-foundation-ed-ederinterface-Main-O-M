...
set inifile=EDPUB_QA_DC1BUnlockconfig.ini
...
rem ---------------------------------------------------------------------------
reg copy       "HKCU\Control Panel\International" "HKCU\Control Panel\Int-Temp-Del-Lck-PUB-DC1B" /f >nul
...
set date_log=%date%
reg copy       "HKCU\Control Panel\Int-Temp-Del-Lck-PUB-DC1B" "HKCU\Control Panel\International" /f >nul
reg delete     "HKCU\Control Panel\Int-Temp-Del-Lck-PUB-DC1B"                                    /f >nul
rem ===========================================================================
