...
rem rem ===========================================================================
rem (05 May) Commented the copy section since we need to try multiple executions in a day
rem rem REM ----- This section of code will copy delta fgdb to geomart
