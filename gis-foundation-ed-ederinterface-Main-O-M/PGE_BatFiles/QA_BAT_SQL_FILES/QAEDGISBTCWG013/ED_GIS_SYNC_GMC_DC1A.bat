...
rem ---------------------------------------------------------------------------
reg copy       "HKCU\Control Panel\International" "HKCU\Control Panel\Int-Temp-Gmc-Sync-DC1A" /f >nul
...
set date_log=%date%
reg copy       "HKCU\Control Panel\Int-Temp-Gmc-Sync-DC1A" "HKCU\Control Panel\International" /f >nul
reg delete     "HKCU\Control Panel\Int-Temp-Gmc-Sync-DC1A"                                    /f >nul
rem ===========================================================================
...
FOR /F "tokens=* delims=" %%x in (%file_out%) DO set /A error_level=%error_level% + %%x
...
set export_remote_dir=\\QAETGISGENWC009\export
IF not exist G:\ (
...
rem CALL NET USE G: /DELETE
rem echo Removed the Mapping %export_remote_dir% from G: >> %file_log_tmp% 2>&1
