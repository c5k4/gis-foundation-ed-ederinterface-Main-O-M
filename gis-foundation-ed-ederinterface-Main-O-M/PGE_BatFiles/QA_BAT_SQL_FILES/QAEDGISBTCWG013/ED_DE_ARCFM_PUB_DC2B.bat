...
set config_name=PGE.Miscellaneous.DeArcFM_EDPUB_DC2B.exe.config
...
rem ---------------------------------------------------------------------------
reg copy       "HKCU\Control Panel\International" "HKCU\Control Panel\Int-Temp-DeArcFM-PUB-DC2B" /f >nul
...
set date_log=%date%
reg copy       "HKCU\Control Panel\Int-Temp-DeArcFM-PUB-DC2B" "HKCU\Control Panel\International" /f >nul
reg delete     "HKCU\Control Panel\Int-Temp-DeArcFM-PUB-DC2B"                                    /f >nul
rem ===========================================================================
