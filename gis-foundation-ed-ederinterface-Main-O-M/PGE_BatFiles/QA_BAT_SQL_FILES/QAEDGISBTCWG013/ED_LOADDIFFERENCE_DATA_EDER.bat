echo off
rem Script Name: ED_LOAD_DIFFERENCE_DATA_EDER.bat
...
set cmdLine="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\LoadDifference\PGE.BatchApplication.LoadDifference.exe" EDER
