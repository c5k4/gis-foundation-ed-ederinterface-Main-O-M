echo off
rem Script Name: EDG_Stop_Interface_Jobs_DC1_02.bat

rem ---------------------------------------------------------------------------
rem Set script variables.
rem ---------------------------------------------------------------------------
set cmdLine=RD /S/Q "%TEMP%"\.
...
taskkill /F /IM PGE.Interfaces.MapProductionAutomation.exe
taskkill /F /IM PGE.Interfaces.MapProduction.Exporter.exe
taskkill /F /IM PGE.Interface.Integration.DMS.Extractor.exe
...
if %ERRORLEVEL% neq 32 set /A error_level=%error_level% + %ERRORLEVEL%
