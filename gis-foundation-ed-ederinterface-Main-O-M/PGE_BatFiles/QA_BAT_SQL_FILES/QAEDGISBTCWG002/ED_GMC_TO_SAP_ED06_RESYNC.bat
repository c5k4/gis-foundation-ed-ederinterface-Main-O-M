...
set cmdLine="d:\Program Files (x86)\Miner and Miner\PG&E Custom Components\SAP Asset Synch\PGE.ReProcessSAPRecords.exe" -n 8
...
cd /d %cmdPath% 
taskkill /f /im PGE.ReProcessSAPRecords.exe 
