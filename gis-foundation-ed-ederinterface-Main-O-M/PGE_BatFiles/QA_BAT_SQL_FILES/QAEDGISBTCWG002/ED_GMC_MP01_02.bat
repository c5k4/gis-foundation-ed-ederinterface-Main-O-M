echo off
rem Script Name: EDG_Map_Prod_01_DC1_01.bat

rem ---------------------------------------------------------------------------
rem Set script variables.
rem ---------------------------------------------------------------------------
set cmdLine="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\Map Production 1.0\PGE.Interfaces.MapProduction.Exporter" -s 1 -e 7
