...
rem ---------------------------------------------------------------------------
set csvFile=\\rcedgis-nas01\rcedgis-nas02\Streetlight\data_from_rss\SL-3679.csv
set sqlCtlFile=load_cdxdata.ctl
set fieldDataPath=\\rcedgis-nas01\rcedgis-nas02\Streetlight\data_to_field
...
D:\Python27\ArcGIS10.2\python send_email.py  "Streetlight Weekly data"  email_msg.txt
set /A error_level=%error_level% + %ERRORLEVEL%
echo Error Level: %ERRORLEVEL%  					   >> %file_log% 2>&1
rem -------------------------------------------------------------------------
