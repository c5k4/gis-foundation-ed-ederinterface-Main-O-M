...
rem Usage:  ED_COMPRESS_PUB_DC2B.bat
rem         
...
for /f %%a in ('PGE_DBPasswordManagement.exe GETPASSWORD SDE@EDPUB_QA_DC2B') do set "PASSWORD=%%a"

sqlplus -s sde/%PASSWORD%@EDPUB_QA_DC2B @"D:\edgisdbmaint\16_AfterOracle_restart_KeysetTableDrop_v2.sql"
