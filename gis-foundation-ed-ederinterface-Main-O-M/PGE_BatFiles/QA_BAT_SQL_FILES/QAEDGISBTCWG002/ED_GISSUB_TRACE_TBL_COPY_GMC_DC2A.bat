...
set sqlDB=edsubgmc_qa_dc2a

@echo off

for /f %%a in ('PGE_DBPasswordManagement.exe GETPASSWORD uc4admin@edsubgmc_qa_dc2a') do set "sqlPWD=%%a"
...
sqlplus -s %sqlUSR%/%sqlPWD%@%sqlDB% @"D:\edgisdbmaint\Copy_trace_tbl_edsubgmc_qa_dc2a.sql"          >> %file_log% 2>&1
