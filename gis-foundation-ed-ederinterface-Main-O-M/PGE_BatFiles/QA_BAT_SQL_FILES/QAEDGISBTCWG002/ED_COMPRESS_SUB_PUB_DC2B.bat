...
rem ===========================================================================
rem ED_COMPRESS_SUB_PUB_DC2B.bat
rem ---------------------------------------------------------------------------
...
rem Usage:  ED_COMPRESS_SUB_PUB_DC2B.bat
rem         
...
for /f %%a in ('PGE_DBPasswordManagement.exe GETPASSWORD SDE@EDSUBPUB_QA_DC2B') do set "PASSWORD=%%a"

sqlplus -s sde/%PASSWORD%@EDSUBPUB_QA_DC2B @"D:\edgisdbmaint\16_AfterOracle_restart_KeysetTableDrop_v2.sql"
