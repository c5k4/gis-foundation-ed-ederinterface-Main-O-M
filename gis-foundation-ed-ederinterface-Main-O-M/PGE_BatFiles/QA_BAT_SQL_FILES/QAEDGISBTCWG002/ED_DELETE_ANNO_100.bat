...
set cmdLine=PGE.BatchApplication.DeleteAnnos.exe -100
...
echo Stopping GDBMPost ED006 Services...                              >> %file_log% 2>&1
call net stop %ServiceNameED006%                                >> %file_log% 2>&1
echo Stopped GDBMPost ED006 Services.                                 >> %file_log% 2>&1
