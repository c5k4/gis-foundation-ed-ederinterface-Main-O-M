...
for /f %%a in ('PGE_DBPasswordManagement.exe GETPASSWORD SDE@EDSUBGMC_QA_DC2B') do set "PASSWORD=%%a"
echo Output of print.exe is: %PASSWORD%

sqlplus -s sde/%PASSWORD%@EDSUBGMC_QA_DC2B @"D:\edgisdbmaint\16_AfterOracle_restart_KeysetTableDrop_v2.sql"
