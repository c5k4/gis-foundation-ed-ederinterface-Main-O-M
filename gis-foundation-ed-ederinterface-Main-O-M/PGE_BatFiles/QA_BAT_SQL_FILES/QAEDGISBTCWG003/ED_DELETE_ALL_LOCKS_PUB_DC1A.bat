...
set inifile=EDPUB_QA_DC1AUnlockconfig.ini
...
rem for /f %%a in ('PGE_DBPasswordManagement GETPASSWORD UC4ADMIN@EDPUB_QA_DC1B') do set "sqlPWD=%%a"
...
rem ---------------------------------------------------------------------------
reg copy       "HKCU\Control Panel\International" "HKCU\Control Panel\Int-Temp-Del-Lck-PUB-DC1A" /f >nul
...
set date_log=%date%
reg copy       "HKCU\Control Panel\Int-Temp-Del-Lck-PUB-DC1A" "HKCU\Control Panel\International" /f >nul
reg delete     "HKCU\Control Panel\Int-Temp-Del-Lck-PUB-DC1A"                                    /f >nul
rem ===========================================================================
