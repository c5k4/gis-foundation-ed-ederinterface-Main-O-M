...
for /f %%a in ('D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\PGE.PasswordMgmt\PGE_DBPasswordManagement.exe GETSDEFILE edgis@edgem1q') do set "sourcesde=%%a"

for /f %%a in ('D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\PGE.PasswordMgmt\PGE_DBPasswordManagement.exe GETSDEFILE edgis@edgep1aq') do set "targetsde=%%a"


set replicaname=Edpub_edgem1q_to_edgep1aq_Replica
set LOB=EDGIS
