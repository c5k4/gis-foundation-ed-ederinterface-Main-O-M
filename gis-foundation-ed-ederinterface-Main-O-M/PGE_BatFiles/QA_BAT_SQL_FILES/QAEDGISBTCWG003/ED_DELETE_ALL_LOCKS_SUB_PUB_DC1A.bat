...
set inifile=EDSUBPUB_QA_DC1AUnlockconfig.ini
...
rem for /f %%a in ('D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\PGE.PasswordMgmt\PGE_DBPasswordManagement.exe GETPASSWORD UC4ADMIN@EDSUBPUB_QA_DC1B') do set "sqlPWD=%%a"
...
rem ---------------------------------------------------------------------------
reg copy       "HKCU\Control Panel\International" "HKCU\Control Panel\Int-Temp-Del-Lck-SubPUB-DC1A" /f >nul
...
set date_log=%date%
reg copy       "HKCU\Control Panel\Int-Temp-Del-Lck-SubPUB-DC1A" "HKCU\Control Panel\International" /f >nul
reg delete     "HKCU\Control Panel\Int-Temp-Del-Lck-SubPUB-DC1A"                                    /f >nul
rem ===========================================================================
