...
set command=call "D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\Map Production 2.0\PGE.Interfaces.MapProductionAutomation.exe" -c "D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\Map Production 2.0\PGE.Interfaces.MapProductionAutomation.exe.config" -s 1 -e 16
