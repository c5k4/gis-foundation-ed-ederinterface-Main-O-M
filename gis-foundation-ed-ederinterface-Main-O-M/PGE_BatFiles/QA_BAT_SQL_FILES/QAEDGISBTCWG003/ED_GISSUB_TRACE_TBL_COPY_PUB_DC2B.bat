...
set sqlDB=EDSUBPUB_QA_DC2B

@echo off

for /f %%a in ('PGE_DBPasswordManagement.exe GETPASSWORD uc4admin@EDSUBPUB_QA_DC2B') do set "sqlPWD=%%a"
...
sqlplus -s %sqlUSR%/%sqlPWD%@%sqlDB% @"D:\edgisdbmaint\Copy_trace_tbl_edsubpub_qa_dc2b.sql"          >> %file_log% 2>&1
