...
set inifile=EDGMC_DC1Aconfig.ini
...
for /f %%a in ('PGE_DBPasswordManagement.exe GETPASSWORD SDE@EDGMC_QA_DC1A') do set "sqlPWD=%%a"
...
set prepsqlCommand=EDGMCpreparedeleteVersions.sql
