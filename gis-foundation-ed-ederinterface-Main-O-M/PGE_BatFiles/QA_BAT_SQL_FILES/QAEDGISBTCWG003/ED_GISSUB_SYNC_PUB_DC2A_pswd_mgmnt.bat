...
for /f %%a in ('D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\PGE.PasswordMgmt\PGE_DBPasswordManagement.exe GETSDEFILE edgis@edgsm1q') do set "sourcesde=%%a"

for /f %%a in ('D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\PGE.PasswordMgmt\PGE_DBPasswordManagement.exe GETSDEFILE edgis@edgsp2aq') do set "targetsde=%%a"

set replicaname=Edsubpub_edgsm1q_to_edgsp2aq_Replica
set LOB=EDGIS
