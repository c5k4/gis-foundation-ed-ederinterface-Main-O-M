...
for /f %%a in ('PGE_DBPasswordManagement.exe GETPASSWORD SDE@EDSUBPUB_QA_DC1B') do set "PASSWORD=%%a"

sqlplus -s sde/%PASSWORD%@EDSUBPUB_QA_DC1B @"D:\edgisdbmaint\16_AfterOracle_restart_KeysetTableDrop_v2.sql"
