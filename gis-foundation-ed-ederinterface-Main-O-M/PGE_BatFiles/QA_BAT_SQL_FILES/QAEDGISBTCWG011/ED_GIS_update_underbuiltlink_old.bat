...
set cmdPath="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\ET_GIS_update_underbuiltlink"
set cmdLine="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\ET_GIS_update_underbuiltlink\ET_GIS_update_underbuiltlink.exe"
