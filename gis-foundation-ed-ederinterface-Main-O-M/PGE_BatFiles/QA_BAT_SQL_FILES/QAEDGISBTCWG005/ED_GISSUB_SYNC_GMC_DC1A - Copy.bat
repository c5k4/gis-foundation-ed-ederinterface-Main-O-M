...
rem JFJ9 (12 Feb): replaced the below section with the one from GMC Sync bat file
rem ===========================================================================
...
rem JFJ9 (Feb 12): Copied the below section from GMC Sync bat file to replace the above section
rem ===========================================================================
rem Change the error_level to a positive integer
rem ---------------------------------------------------------------------------
...
if %error_level% lss 0 set error_level=0
