...
for /f %%a in ('PGE_DBPasswordManagement.exe GETSDEFILE EDGIS@EDSUBPUB_QA_DC2A') do set "targetsde=%%a"

set replicaname=EDERSUB_TO_EDSUBPUB_Replica
set LOB=EDGIS
...
rem ---------------------------------------------------------------------------
reg copy       "HKCU\Control Panel\International" "HKCU\Control Panel\Int-Temp-SubPub-Sync-DC2A" /f >nul
...
set date_log=%date%
reg copy       "HKCU\Control Panel\Int-Temp-SubPub-Sync-DC2A" "HKCU\Control Panel\International" /f >nul
reg delete     "HKCU\Control Panel\Int-Temp-SubPub-Sync-DC2A"                                    /f >nul
rem ===========================================================================
