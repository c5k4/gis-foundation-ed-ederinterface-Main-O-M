...
for /f %%a in ('PGE_DBPasswordManagement.exe GETSDEFILE EDGIS@EDSUBGMC_QA_DC1A') do set "targetsde=%%a"

rem set replicaname=EDERSUB_TO_EDSUBGMC_Replica
set replicaname=EDERSUB_TO_EDSUBGMCDC1A_Replica
set LOB=EDGIS
...
rem ---------------------------------------------------------------------------
reg copy       "HKCU\Control Panel\International" "HKCU\Control Panel\Int-Temp-SubGmc-Sync-DC1A" /f >nul
...
set date_log=%date%
reg copy       "HKCU\Control Panel\Int-Temp-SubGmc-Sync-DC1A" "HKCU\Control Panel\International" /f >nul
reg delete     "HKCU\Control Panel\Int-Temp-SubGmc-Sync-DC1A"                                    /f >nul
rem ===========================================================================
