...
rem set replicaname=EderDefault_To_PublicationDc1aDefault_Replica
set replicaname=EDER_DEFAULT_TO_EDPUB_DC1A
set LOB=EDGIS
...
rem ---------------------------------------------------------------------------
reg copy       "HKCU\Control Panel\International" "HKCU\Control Panel\Int-Temp-Pub-Sync-DC1A" /f >nul
...
set date_log=%date%
reg copy       "HKCU\Control Panel\Int-Temp-Pub-Sync-DC1A" "HKCU\Control Panel\International" /f >nul
reg delete     "HKCU\Control Panel\Int-Temp-Pub-Sync-DC1A"                                    /f >nul
rem ===========================================================================
...
rem set sourcesde=C:\Users\a9ksadmin\AppData\Local\Temp\5\EDGIS_EDER_QA_1_11_2022_23_55_54_133.sde
rem set targetsde=C:\Users\a9ksadmin\AppData\Local\Temp\5\EDGIS_EDPUB_QA_DC1A_1_11_2022_23_56_6_961.sde
