...
set sourcesde=D:\edgisdbmaint\conn_gdb\lob_source_edgis_edgem1q.sde
set targetsde=D:\edgisdbmaint\conn_gdb\gm_target_edgis_edged1aq.sde
set replicaname=GeoMart_EDGIS_Replica
set LOB=EDGIS
