...
for /f %%a in ('PGE_DBPasswordManagement.exe GETPASSWORD SDE@EDSCHM_QA') do set "PASSWORD=%%a"

sqlplus -s sde/%PASSWORD%@EDSCHM_QA @"D:\edgisdbmaint\16_AfterOracle_restart_KeysetTableDrop_v2.sql"
