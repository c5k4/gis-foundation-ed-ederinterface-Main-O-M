...
for /f %%a in ('PGE_DBPasswordManagement.exe GETSDEFILE EDGIS@EDPUB_QA_DC2A') do set "targetsde=%%a"

rem set replicaname=EDER_TO_EDPUB_Replica
set replicaname=EDER_TO_EDPUBDC2A_Replica
set LOB=EDGIS
...
rem ---------------------------------------------------------------------------
reg copy       "HKCU\Control Panel\International" "HKCU\Control Panel\Int-Temp-Pub-Sync-DC2A" /f >nul
...
set date_log=%date%
reg copy       "HKCU\Control Panel\Int-Temp-Pub-Sync-DC2A" "HKCU\Control Panel\International" /f >nul
reg delete     "HKCU\Control Panel\Int-Temp-Pub-Sync-DC2A"                                    /f >nul
rem ===========================================================================
