...
for /f %%a in ('PGE_DBPasswordManagement.exe GETSDEFILE EDGIS@EDERSUB_QA') do set "sourcesde=%%a"

for /f %%a in ('PGE_DBPasswordManagement.exe GETSDEFILE EDGIS@EDSUBPUB_QA_DC1A') do set "targetsde=%%a"

rem set replicaname=EDERSUB_TO_EDSUBPUB_Replica
rem set replicaname=EDERSUB_TO_EDSUBPUBDC1A_Replica
set replicaname=SUB_DEFAULT_TO_SUBPUB
set LOB=EDGIS
set pythonscript=D:\edgisdbmaint\LOB_to_SubPublication_ReplicaSync_Disconnected_Reconcile.py
...
rem ---------------------------------------------------------------------------
reg copy       "HKCU\Control Panel\International" "HKCU\Control Panel\Int-Temp-SubPub-Sync-DC1A" /f >nul
...
set date_log=%date%
reg copy       "HKCU\Control Panel\Int-Temp-SubPub-Sync-DC1A" "HKCU\Control Panel\International" /f >nul
reg delete     "HKCU\Control Panel\Int-Temp-SubPub-Sync-DC1A"                                    /f >nul
rem ===========================================================================
...
rem JFJ9 (12 Feb): replaced the below section with the one from PUB Sync bat file
rem ===========================================================================
...
rem JFJ9 (Feb 12): Copied the below section from Pub Sync bat file to replace the above section
rem ===========================================================================
rem Change the error_level to a positive integer
rem ---------------------------------------------------------------------------
