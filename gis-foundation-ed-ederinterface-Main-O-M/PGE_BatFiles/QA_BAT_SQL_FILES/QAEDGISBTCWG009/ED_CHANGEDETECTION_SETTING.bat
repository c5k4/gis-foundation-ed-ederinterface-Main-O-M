...
rem Script Name: EDG_CHANGEDETECTION_SETTING.bat

rem ---------------------------------------------------------------------------
rem Set script variables.
rem ---------------------------------------------------------------------------
set cmdPath="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\Change Detection"
set cmdLine="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\Change Detection\PGE.BatchApplication.ChangeDetection.exe" -c Settings.config
...
rem ---------------------------------------------------------------------------
rem Set script variables for Settings Notification.
rem ---------------------------------------------------------------------------
set cmdPath2="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\Settings Notification"
set cmdLine2="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\Settings Notification\PGE.Interfaces.SettingsEmailNotification.exe"

rem ---------------------------------------------------------------------------
rem Run the executable.
rem ---------------------------------------------------------------------------
cd /d %cmdPath2%                                             >> %file_log% 2>&1
echo Executing %cmdLine2%...                                 >> %file_log% 2>&1
rem call %cmdLine2%                                          >> %file_log% 2>&1
%cmdLine2%                                                   >> %file_log% 2>&1
set /A error_level=%error_level% + %ERRORLEVEL%
echo Executed  %cmdLine2%.                                   >> %file_log% 2>&1
echo Error Level: %error_level%                             >> %file_log% 2>&1
rem ---------------------------------------------------------------------------
