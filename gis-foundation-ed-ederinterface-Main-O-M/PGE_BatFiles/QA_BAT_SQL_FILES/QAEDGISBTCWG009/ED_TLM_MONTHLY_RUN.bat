@echo off
rem ===========================================================================
rem Script Name: EDG_TLM_ChangeDetection_Mnthly.bat
rem Created: Wednesday, July 16, 2014 10:34:04 AM
...
set file_script=%~f0
set path_log=%~dp0log
set file_log=%path_log%\%~n0_%date_time%_%1_%2.log
...
set cmdLine=SMUtilityExport.exe TLM MTR %1 %2
