...
rem OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO
echo off
rem Script Name: EDG_ChangeDetection_LoadData_ETL.bat

rem ---------------------------------------------------------------------------
rem Set script variables.
rem ---------------------------------------------------------------------------
set cmdPath="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\Change Detection"
set cmdLine="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\Change Detection\PGE.BatchApplication.ChangeDetection.exe" -c SchematicsGUIDTotalETL.config -o runETL
set sqlUSR=edgis

set sqlDB=EDSCHM
set sqlCommand="Scripts2-loaddata.sql"
for /f %%a in ('PGE_DBPasswordManagement.exe GETPASSWORD EDGIS@EDSCHM') do set "sqlPWD=%%a"
