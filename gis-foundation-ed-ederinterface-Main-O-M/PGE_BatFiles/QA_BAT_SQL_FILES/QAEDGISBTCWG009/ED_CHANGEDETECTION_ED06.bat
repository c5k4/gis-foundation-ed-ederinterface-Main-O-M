echo off
rem Script Name: EDG_CHANGEDETECTION_ED06.bat

rem ---------------------------------------------------------------------------
rem Set script variables.
rem ---------------------------------------------------------------------------
set cmdPath="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\SAP Asset Synch"
set cmdLine="PGE.Interfaces.SAP.ED06.Batch.exe"

set cmdPath_Fix="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\ED06JsonFix"
set cmdLine_Fix="JsonFix.exe"
...
rem Run the executable.
rem ---------------------------------------------------------------------------
rem cd /d %cmdPath_Fix%                                             >> %file_log% 2>&1
rem echo Executing %cmdLine_Fix%...                                 >> %file_log% 2>&1
rem call %cmdLine_Fix%                                              >> %file_log% 2>&1
rem set /A error_level=%error_level% + %ERRORLEVEL%
rem echo Executed  %cmdLine_Fix%.                                   >> %file_log% 2>&1
