...
echo off
rem ===========================================================================
rem Script Name: ED_ED6_AUTO_REPROCESS.bat
...
set SQLScript_path=D:\edgisdbmaint\ED_ED6_AUTO_REPROCESS.sql
...
echo Executing ED06 Interface AUTO RE-PROCESSING on %EDGIS_Database%.....  >> %file_log% 2>&1

sqlplus -s %uname%/%INTDATAARCH_PWD%@%EDGIS_Database% @%SQLScript_path% >> %file_log% '3' '0' '15' 2>&1
set /A error_level=%error_level% + %ERRORLEVEL%             


echo Completed executing ED06 Interface AUTO RE-PROCESSING on %EDGIS_Database% >> %file_log% 2>&1
