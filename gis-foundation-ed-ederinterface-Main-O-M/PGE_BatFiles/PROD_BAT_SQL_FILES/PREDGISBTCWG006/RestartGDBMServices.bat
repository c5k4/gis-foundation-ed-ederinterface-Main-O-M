...
echo Starting EDER_DATAPROCESSING_04 Services...                              >> %file_log% 2>&1
call net start %ServiceName1%                           >> %file_log% 2>&1
echo Started EDER_DATAPROCESSING_04 Services...     >> %file_log% 2>&1   

)
SC queryex "%ServiceName2%"|Find "STATE"|Find /v "Started">Nul&&(

echo Starting EDER_DATAPROCESSING_05 Services...                              >> %file_log% 2>&1
call net start %ServiceName2%                               >> %file_log% 2>&1
echo Started EDER_DATAPROCESSING_05 Services...     >> %file_log% 2>&1 
