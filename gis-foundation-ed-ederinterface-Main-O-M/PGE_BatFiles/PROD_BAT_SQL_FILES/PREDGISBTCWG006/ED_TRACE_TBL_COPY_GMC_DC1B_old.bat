echo off
rem ===========================================================================
rem Script Name: ED_TRACE_TBL_COPY_GMC_DC1B.bat
...
for /f %%a in ('PGE_DBPasswordManagement.exe GETPASSWORD uc4admin@EDGMC_PR_DC1B') do set "sqlPWD=%%a"
...
sqlplus -s %sqlUSR%/%sqlPWD%@%sqlDB% @"D:\edgisdbmaint\Copy_trace_tbl_edgmc_prod_dc1b1.sql"          >> %file_log% 2>&1
sqlplus -s %sqlUSR%/%sqlPWD%@%sqlDB% @"D:\edgisdbmaint\Copy_trace_tbl_edgmc_prod_dc1b2.sql"          >> %file_log% 2>&1
sqlplus -s %sqlUSR%/%sqlPWD%@%sqlDB% @"D:\edgisdbmaint\Copy_trace_tbl_edgmc_prod_dc1b3.sql"          >> %file_log% 2>&1
sqlplus -s %sqlUSR%/%sqlPWD%@%sqlDB% @"D:\edgisdbmaint\Copy_trace_tbl_edgmc_prod_dc1b4.sql"          >> %file_log% 2>&1
set /A error_level=%error_level% + %ERRORLEVEL%
