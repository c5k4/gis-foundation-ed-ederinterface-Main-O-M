...
rem ---------------------------------------------------------------------------
set cmdPath="D:\ED08"
set cmdLine="D:\ED08\export_tofgdb.py"
set args1 = "ED08LINE_T" 
set args2 = "ED08STRUCT_T"
...
rem ===========================================================================
set cmdLine1=%pythonexe% export_tofgdb.py ED08STRUCT_T 
set cmdLine2=%pythonexe% export_tofgdb.py ED08LINE_T
