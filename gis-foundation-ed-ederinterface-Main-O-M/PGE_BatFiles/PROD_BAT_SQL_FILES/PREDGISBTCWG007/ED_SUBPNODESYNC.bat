echo off
rem Script Name: EDG_SubPNodeSync.bat
rem Created: Wednesday, April 23, 2019
rem Windows HEAD - BEGIN

rem ---------------------------------------------------------------------------
rem Set script variables.
rem ---------------------------------------------------------------------------
set cmdPath="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\PNodeSynch\"
set cmdLine="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\PNodeSynch\PGE.Interface.PNodeSync.exe"
