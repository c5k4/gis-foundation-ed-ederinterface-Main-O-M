...
for /f %%a in ('PGE_DBPasswordManagement.exe GETSDEFILE GIS_I@EDGMC_QA') do set "filename_conn=%%a"


rem This command could work if the creating the sde conn file automatically does not work.
set command=call "D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\Map Production 2.0\PGE.Interfaces.MapProductionAutomation.exe" -c "D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\Map Production 2.0\PGE.Interfaces.MapProductionAutomation.Schematics.exe.config" -s 1 -e 8 
