...
set ServiceName3=EDER_RECONCILE_03
set ServiceName4=EDERSUB_RECONCILE_03
...
echo Starting GDBM EDER_DATAPROCESSING_06 Services...                              >> %file_log% 2>&1
call net start %ServiceName1%                           >> %file_log% 2>&1
echo Started GDBM EDER_DATAPROCESSING_06 Services...     >> %file_log% 2>&1   

)
SC queryex "%ServiceName2%"|Find "STATE"|Find /v "Started">Nul&&(

echo Starting EDER_DATAPROCESSING_07 Services...                              >> %file_log% 2>&1
call net start %ServiceName2%                               >> %file_log% 2>&1
echo Started EDER_DATAPROCESSING_07 Services...     >> %file_log% 2>&1 

)
SC queryex "%ServiceName3%"|Find "STATE"|Find /v "Started">Nul&&(

echo Starting EDER_RECONCILE_03 Services...                              >> %file_log% 2>&1
call net start %ServiceName3%                               >> %file_log% 2>&1
echo Started EDER_RECONCILE_03  Services...     >> %file_log% 2>&1 

)
SC queryex "%ServiceName4%"|Find "STATE"|Find /v "Started">Nul&&(

echo Starting EDERSUB_RECONCILE_03 Services...                              >> %file_log% 2>&1
call net start %ServiceName4%                               >> %file_log% 2>&1
echo Started EDERSUB_RECONCILE_03  Services...     >> %file_log% 2>&1 
