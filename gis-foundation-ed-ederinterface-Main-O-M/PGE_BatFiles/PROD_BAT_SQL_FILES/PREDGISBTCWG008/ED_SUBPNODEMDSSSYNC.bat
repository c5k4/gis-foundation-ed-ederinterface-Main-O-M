echo off
rem Script Name: EDG_SubPNodeMDSSSync.bat
rem Created: Thursday, July 25, 2019
rem Windows HEAD - BEGIN

rem ---------------------------------------------------------------------------
rem Set script variables.
rem ---------------------------------------------------------------------------
set cmdPath="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\PNodeMDSSSync"
set cmdLine="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\PNodeMDSSSync\PGE.Interface.PNodeMDSSSync.exe"
