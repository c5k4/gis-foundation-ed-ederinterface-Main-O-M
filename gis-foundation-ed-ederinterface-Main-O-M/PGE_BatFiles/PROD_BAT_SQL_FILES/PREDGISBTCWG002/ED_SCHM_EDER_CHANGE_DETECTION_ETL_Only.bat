...
set cmdLine="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\Change Detection\PGE.BatchApplication.ChangeDetection.exe" -c Schematics_only_for_ETL.config
