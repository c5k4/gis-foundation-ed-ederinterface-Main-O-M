...
for /f %%a in ('PGE_DBPasswordManagement.exe GETPASSWORD SDE@WIP_PR') do set "PASSWORD=%%a"
rem echo Output of print.exe is: %PASSWORD%
sqlplus -s SDE/%PASSWORD%@WIP_PR @"D:\edgisdbmaint\16_AfterOracle_restart_KeysetTableDrop_v2.sql"
