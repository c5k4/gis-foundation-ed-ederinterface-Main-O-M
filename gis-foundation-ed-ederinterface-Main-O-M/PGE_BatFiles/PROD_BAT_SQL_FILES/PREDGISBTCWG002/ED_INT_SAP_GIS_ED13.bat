...
rem ===========================================================================
rem InterfaceIntegrationGatewayED13.bat
rem ---------------------------------------------------------------------------
...
rem Usage:  InterfaceIntegrationGatewayED13.bat
rem         
...
rem ---------------------------------------------------------------------------
reg copy       "HKCU\Control Panel\International" "HKCU\Control Panel\Int-Temp-ED13" /f >nul
...
set date_log=%date%
reg copy       "HKCU\Control Panel\Int-Temp-ED13" "HKCU\Control Panel\International" /f >nul
reg delete     "HKCU\Control Panel\Int-Temp-ED13"                                    /f >nul
rem ===========================================================================
