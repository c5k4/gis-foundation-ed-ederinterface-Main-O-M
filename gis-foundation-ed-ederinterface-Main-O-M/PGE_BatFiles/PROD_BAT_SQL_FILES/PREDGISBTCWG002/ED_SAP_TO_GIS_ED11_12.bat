...
set cmdLine="d:\Program Files (x86)\Miner and Miner\PG&E Custom Components\ED11_12\PGE.Interfaces.ED11_12.exe" -c "D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\ED11_12\PGE.Interfaces.ED11_12.exe.config" -n 8 -SubmitToGDBMPost -UnknownErrors
