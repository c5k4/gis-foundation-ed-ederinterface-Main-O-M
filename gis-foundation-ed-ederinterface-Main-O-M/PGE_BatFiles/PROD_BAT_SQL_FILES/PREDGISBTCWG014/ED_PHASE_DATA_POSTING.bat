echo off
rem Script Name: EDG_PHASING_DATAUPDATE.bat
...
set cmdPath="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\PGE_IGPPhaseUpdate"
set cmdLine="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\PGE_IGPPhaseUpdate\PGE.BatchApplication.IGPPhaseUpdate.exe" -u
