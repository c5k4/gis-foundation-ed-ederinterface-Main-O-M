echo off
rem Script Name: ED_LOAD_DIFFERENCE_DATA_EDERSUB.bat
...
set cmdPath="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\LoadDifference"
set cmdLine="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\LoadDifference\PGE.BatchApplication.LoadDifference.exe" EDERSUB
