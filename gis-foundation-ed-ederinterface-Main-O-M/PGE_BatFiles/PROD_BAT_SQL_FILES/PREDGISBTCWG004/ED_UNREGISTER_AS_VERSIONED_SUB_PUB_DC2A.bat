...
rem ===========================================================================
rem ED_UNREGISTER_AS_VERSIONED_SUB_PUB_DC1B.bat
rem ---------------------------------------------------------------------------
rem This script calls a python script performs the
rem ESRI ArcGIS Server function Unversionise
...
rem Usage:  ED_UNREGISTER_AS_VERSIONED_SUB_PUB_DC1B.bat
rem         
...
rem ---------------------------------------------------------------------------
set error_level=0
set path_bat = D:\edgisdbmaint
set file_bat = "ED_DELETE_ALL_LOCKS_SUB_PUB_DC2A.bat"
set config_name=EDSUBPUB_DC2Aconfig.ini
set file_path="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\PGE.PublicationUpdate\Unversion"
set filename_script_01=Unversion.py

set filename_current=%~0
set path_current="%~dp0"
set file_current=%path_current%%filename_current%
set path_log=%path_current%log
set file_script_01=%filename_script_01%
rem ===========================================================================
