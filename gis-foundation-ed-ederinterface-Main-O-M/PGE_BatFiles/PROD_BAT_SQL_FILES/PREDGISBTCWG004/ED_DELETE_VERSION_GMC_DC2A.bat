...
rem ===========================================================================
rem ED_DELETE_VERSION_EDGMC_DC2B.bat
rem ---------------------------------------------------------------------------
rem This SQL Script
...
rem Usage:  ED_DELETE_VERSION_EDGMC_DC2B.bat
rem         
...
set inifile=EDGMC_DC2Aconfig.ini
...
for /f %%a in ('PGE_DBPasswordManagement.exe GETPASSWORD SDE@EDGMC_PR_DC2A') do set "sqlPWD=%%a"
