...
rem ===========================================================================
rem ED_DELETE_VERSION_EDSUBGMC_DC2B.bat
rem ---------------------------------------------------------------------------
rem This SQL Script
...
rem Usage:  ED_DELETE_VERSION_EDSUBGMC_DC2B.bat
rem         
...
set inifile=EDSUBGMC_DC2Bconfig.ini
...
for /f %%a in ('PGE_DBPasswordManagement.exe GETPASSWORD SDE@EDSUBGMC_PR_DC2B') do set "sqlPWD=%%a"
