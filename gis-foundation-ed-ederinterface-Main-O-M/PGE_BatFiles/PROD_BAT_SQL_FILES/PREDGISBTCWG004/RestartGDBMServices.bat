...
set ServiceName4=EDERSUB_RECONCILE_01
...
echo Starting EDER_DATAPROCESSING_02 Services...                              >> %file_log% 2>&1
call net start %ServiceName1%                           >> %file_log% 2>&1
echo Started EDER_DATAPROCESSING_02 Services...     >> %file_log% 2>&1   

)
SC queryex "%ServiceName2%"|Find "STATE"|Find /v "Started">Nul&&(

echo Starting EDER_DATAPROCESSING_03 Services...                              >> %file_log% 2>&1
call net start %ServiceName2%                               >> %file_log% 2>&1
echo Started EDER_DATAPROCESSING_03 Services...     >> %file_log% 2>&1 

)
SC queryex "%ServiceName3%"|Find "STATE"|Find /v "Started">Nul&&(

echo Starting EDERSUB_DATAPROCESSING_02 Services...                              >> %file_log% 2>&1
call net start %ServiceName3%                               >> %file_log% 2>&1
echo Started EDERSUB_DATAPROCESSING_02  Services...     >> %file_log% 2>&1 

)
SC queryex "%ServiceName4%"|Find "STATE"|Find /v "Started">Nul&&(

echo Starting EDERSUB_RECONCILE_01 Services...                              >> %file_log% 2>&1
call net start %ServiceName4%                               >> %file_log% 2>&1
echo Started EDERSUB_RECONCILE_01  Services...     >> %file_log% 2>&1 
