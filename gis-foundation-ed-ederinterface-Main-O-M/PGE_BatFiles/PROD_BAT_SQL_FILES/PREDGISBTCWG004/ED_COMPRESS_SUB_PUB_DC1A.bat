...
for /f %%a in ('PGE_DBPasswordManagement.exe GETPASSWORD SDE@EDSUBPUB_PR_DC1A') do set "PASSWORD=%%a"

sqlplus -s sde/%PASSWORD%@EDSUBPUB_PR_DC1A @"D:\edgisdbmaint\16_AfterOracle_restart_KeysetTableDrop_v2.sql"
