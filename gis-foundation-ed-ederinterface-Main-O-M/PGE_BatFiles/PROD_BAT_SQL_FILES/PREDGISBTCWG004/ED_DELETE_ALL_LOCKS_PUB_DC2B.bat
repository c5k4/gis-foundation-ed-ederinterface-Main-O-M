...
rem Usage:  DELETE_ALL_LOCKS_PUB.bat
rem         
...
set inifile=EDPUB_PR_DC2BUnlockconfig.ini
...
rem for /f %%a in ('PGE_DBPasswordManagement GETPASSWORD UC4ADMIN@EDPUB_PR_DC2B') do set "sqlPWD=%%a"
...
rem ---------------------------------------------------------------------------
reg copy       "HKCU\Control Panel\International" "HKCU\Control Panel\Int-Temp-Del-Lck-PUB-DC2B" /f >nul
...
set date_log=%date%
reg copy       "HKCU\Control Panel\Int-Temp-Del-Lck-PUB-DC2B" "HKCU\Control Panel\International" /f >nul
reg delete     "HKCU\Control Panel\Int-Temp-Del-Lck-PUB-DC2B"                                    /f >nul
rem ===========================================================================
