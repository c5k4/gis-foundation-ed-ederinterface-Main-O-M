...
set cmdLine=PGE.Interface.Integration.DMS.Extractor.exe -u
...
xcopy /y "\\rcnas01-smb\edgisrearchprod-fs01\INTERFACE\EDAMGIS_ED50_PRODUCER\OUTBOUND\*log.txt" "\\rcnas01-smb\edgisrearchprod-fs01\INTERFACE\EDAMGIS_ED50_PRODUCER\OUTBOUND\archive"
rem ---------------------------------------------------------------------------
