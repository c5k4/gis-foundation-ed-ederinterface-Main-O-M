echo off
rem ===========================================================================
rem Script Name: ED_GISSUB_TRACE_TBL_COPY_PUB_DC2B.bat
...
set sqlDB=EDSUBPUB_PR_DC2B

@echo off

for /f %%a in ('PGE_DBPasswordManagement.exe GETPASSWORD UC4ADMIN@EDSUBPUB_PR_DC2B') do set "sqlPWD=%%a"
...
sqlplus -s %sqlUSR%/%sqlPWD%@%sqlDB% @"D:\edgisdbmaint\Copy_trace_tbl_edsubpub_prod_dc2b.sql"          >> %file_log% 2>&1
