...
rem ===========================================================================
rem Script Name: ED_GISSUB_TRACE_TBL_COPY_PUB_DC2A.bat
...
set sqlDB=EDSUBPUB_PR_DC2A

@echo off

for /f %%a in ('PGE_DBPasswordManagement.exe GETPASSWORD UC4ADMIN@EDSUBPUB_PR_DC2A') do set "sqlPWD=%%a"
