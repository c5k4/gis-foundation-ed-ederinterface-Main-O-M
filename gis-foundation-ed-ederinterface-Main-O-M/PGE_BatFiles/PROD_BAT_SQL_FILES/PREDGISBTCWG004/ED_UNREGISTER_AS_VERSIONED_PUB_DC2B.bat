...
rem ===========================================================================
rem ED_UNREGISTER_AS_VERSIONED_PUB_DC1B.bat
rem ---------------------------------------------------------------------------
...
rem Usage:  ED_UNREGISTER_AS_VERSIONED_PUB_DC1B.bat
rem         
...
set file_bat = "ED_DELETE_ALL_LOCKS_PUB_DC2B.bat"
set config_name=EDPUB_DC2Bconfig.ini
