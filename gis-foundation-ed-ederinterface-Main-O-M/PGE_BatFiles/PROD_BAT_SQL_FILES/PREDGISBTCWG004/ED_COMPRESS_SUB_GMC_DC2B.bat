...
rem ===========================================================================
rem ED_COMPRESS_SUB_GMC_DC2A.bat
rem ---------------------------------------------------------------------------
...
rem Usage:   ED_COMPRESS_SUB_GMC_DC2A.bat
rem         
...
for /f %%a in ('PGE_DBPasswordManagement.exe GETPASSWORD SDE@EDSUBGMC_PR_DC2A') do set "PASSWORD=%%a"

sqlplus -s sde/%PASSWORD%@EDSUBGMC_PR_DC2A @"D:\edgisdbmaint\16_AfterOracle_restart_KeysetTableDrop_v2.sql"
