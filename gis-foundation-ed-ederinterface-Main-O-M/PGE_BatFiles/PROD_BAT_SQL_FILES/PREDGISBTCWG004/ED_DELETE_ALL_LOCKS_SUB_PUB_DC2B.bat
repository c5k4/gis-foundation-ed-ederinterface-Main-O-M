...
set inifile=EDSUBPUB_PR_DC2BUnlockconfig.ini
...
rem for /f %%a in ('D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\PGE.PasswordMgmt\PGE_DBPasswordManagement.exe GETPASSWORD UC4ADMIN@EDSUBPUB_PR_DC2B') do set "sqlPWD=%%a"
...
rem ---------------------------------------------------------------------------
reg copy       "HKCU\Control Panel\International" "HKCU\Control Panel\Int-Temp-Del-Lck-SUBPUB-DC2B" /f >nul
...
set date_log=%date%
reg copy       "HKCU\Control Panel\Int-Temp-Del-Lck-SUBPUB-DC2B" "HKCU\Control Panel\International" /f >nul
reg delete     "HKCU\Control Panel\Int-Temp-Del-Lck-SUBPUB-DC2B"                                    /f >nul
rem ===========================================================================
