...
COPY FROM EDGIS/&1@EDERSUB INSERT EDGIS.PGE_SUBGEOMNETWORK_TRACE_A USING SELECT * FROM EDGIS.PGE_SUBGEOMNETWORK_TRACE;
COMMIT;
...
COPY FROM EDGIS/&1@EDERSUB INSERT EDGIS.PGE_SUBGEOMNETWORK_TRACE_B USING SELECT * FROM EDGIS.PGE_SUBGEOMNETWORK_TRACE;
COMMIT;
exit;