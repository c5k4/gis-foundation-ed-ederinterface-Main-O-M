...
for /f %%a in ('PGE_DBPasswordManagement.exe GETSDEFILE EDGIS@EDSUBPUB_PR_DC2A') do set "targetsde=%%a"

set replicaname=EDERSUB_DEFAULT_TO_EDSUBPUB_DC2A
set LOB=EDSUBPUB
...
rem rem ===========================================================================
rem rem Change the error_level to a positive integer
rem rem ---------------------------------------------------------------------------
