echo off
rem ===========================================================================
rem Script Name: ED_GISSUB_TRACE_TBL_COPY_GMC_DC1B.bat
...
set sqlDB=EDSUBGMC_PR_DC1B

@echo off

for /f %%a in ('PGE_DBPasswordManagement.exe GETPASSWORD uc4admin@EDSUBGMC_PR_DC1B') do set "sqlPWD=%%a"
...
sqlplus -s %sqlUSR%/%sqlPWD%@%sqlDB% @"D:\edgisdbmaint\Copy_trace_tbl_edsubgmc_prod_dc1b.sql"          >> %file_log% 2>&1
