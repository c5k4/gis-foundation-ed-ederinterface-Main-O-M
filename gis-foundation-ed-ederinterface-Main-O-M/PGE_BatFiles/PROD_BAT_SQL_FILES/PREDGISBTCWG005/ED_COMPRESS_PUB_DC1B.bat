...
rem Usage:  ED_COMPRESS_PUB_DC1A.bat
rem         
...
for /f %%a in ('PGE_DBPasswordManagement.exe GETPASSWORD SDE@EDPUB_PR_DC1B') do set "PASSWORD=%%a"

sqlplus -s sde/%PASSWORD%@EDPUB_PR_DC1B @"D:\edgisdbmaint\16_AfterOracle_restart_KeysetTableDrop_v2.sql"
