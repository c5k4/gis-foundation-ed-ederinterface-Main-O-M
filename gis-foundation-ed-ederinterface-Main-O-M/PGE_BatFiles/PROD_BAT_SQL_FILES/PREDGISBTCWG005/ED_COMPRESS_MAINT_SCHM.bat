...
for /f %%a in ('PGE_DBPasswordManagement.exe GETPASSWORD SDE@EDSCHM_PR') do set "PASSWORD=%%a"

sqlplus -s sde/%PASSWORD%@EDSCHM_PR @"D:\edgisdbmaint\16_AfterOracle_restart_KeysetTableDrop_v2.sql"
