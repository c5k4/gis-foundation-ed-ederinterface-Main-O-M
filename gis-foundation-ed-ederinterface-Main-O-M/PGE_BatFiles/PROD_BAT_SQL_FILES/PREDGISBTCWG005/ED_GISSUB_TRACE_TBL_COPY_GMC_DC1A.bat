echo off
rem ===========================================================================
rem Script Name: ED_GISSUB_TRACE_TBL_COPY_GMC_DC1A.bat
...
set sqlDB=EDSUBGMC_PR_DC1A

@echo off

for /f %%a in ('PGE_DBPasswordManagement.exe GETPASSWORD uc4admin@EDSUBGMC_PR_DC1A') do set "sqlPWD=%%a"
...
sqlplus -s %sqlUSR%/%sqlPWD%@%sqlDB% @"D:\edgisdbmaint\Copy_trace_tbl_edsubgmc_prod_dc1a.sql"          >> %file_log% 2>&1
