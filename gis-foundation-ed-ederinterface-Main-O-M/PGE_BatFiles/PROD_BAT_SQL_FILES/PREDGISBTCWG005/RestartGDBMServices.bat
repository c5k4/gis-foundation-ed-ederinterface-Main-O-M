...
set ServiceName2=EDERSUB_DATAPROCESSING_05
set ServiceName3=EDER_RECONCILE_02
set ServiceName4=EDERSUB_RECONCILE_02
...
echo Starting GDBM EDER_DATAPROCESSING_04 Services...                              >> %file_log% 2>&1
call net start %ServiceName1%                           >> %file_log% 2>&1
echo Started GDBM EDER_DATAPROCESSING_04 Services...     >> %file_log% 2>&1   

)
SC queryex "%ServiceName2%"|Find "STATE"|Find /v "Started">Nul&&(

echo Starting EDERSUB_DATAPROCESSING_05 Services...                              >> %file_log% 2>&1
call net start %ServiceName2%                               >> %file_log% 2>&1
echo Started EDERSUB_DATAPROCESSING_05 Services...     >> %file_log% 2>&1 

)
SC queryex "%ServiceName3%"|Find "STATE"|Find /v "Started">Nul&&(

echo Starting EDER_RECONCILE_02 Services...                              >> %file_log% 2>&1
call net start %ServiceName3%                               >> %file_log% 2>&1
echo Started EDER_RECONCILE_02  Services...     >> %file_log% 2>&1 

)
SC queryex "%ServiceName4%"|Find "STATE"|Find /v "Started">Nul&&(

echo Starting EDERSUB_RECONCILE_02 Services...                              >> %file_log% 2>&1
call net start %ServiceName4%                               >> %file_log% 2>&1
echo Started EDERSUB_RECONCILE_02  Services...     >> %file_log% 2>&1 
