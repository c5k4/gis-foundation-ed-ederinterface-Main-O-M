...
rem ---------------------------------------------------------------------------
REM echo Starting GDBM Services...    
REM call sc config %ServiceName1% start= demand                  >> %file_log% 2>&1
REM call net start %ServiceName1%                                >> %file_log% 2>&1
REM call sc config %ServiceName2% start= demand                  >> %file_log% 2>&1
REM call net start %ServiceName2%                                >> %file_log% 2>&1
REM call sc config %ServiceName3% start= demand                  >> %file_log% 2>&1
REM call net start %ServiceName3%                                >> %file_log% 2>&1
REM call sc config %ServiceName4% start= demand                  >> %file_log% 2>&1
REM call net start %ServiceName4%                                >> %file_log% 2>&1
REM echo Started GDBM Services.                                  >> %file_log% 2>&1

echo.>"D:\edgisdbmaint\track_dppost_start.txt"
