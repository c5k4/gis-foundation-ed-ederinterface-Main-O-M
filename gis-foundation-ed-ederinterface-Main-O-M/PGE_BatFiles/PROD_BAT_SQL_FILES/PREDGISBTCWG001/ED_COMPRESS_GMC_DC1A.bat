...
rem Usage:  EDG_COMPRESS_GMC_DC1A.bat
rem         
...
for /f %%a in ('PGE_DBPasswordManagement.exe GETPASSWORD SDE@EDGMC_PR_DC1A') do set "PASSWORD=%%a"

sqlplus -s sde/%PASSWORD%@EDGMC_PR_DC1A @"D:\edgisdbmaint\16_AfterOracle_restart_KeysetTableDrop_v2.sql"
