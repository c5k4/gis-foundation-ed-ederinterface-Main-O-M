...
for /f %%a in ('PGE_DBPasswordManagement.exe GETPASSWORD SDE@EDER_PR') do set "PASSWORD=%%a"

sqlplus -s sde/%PASSWORD%@EDER_PR @"D:\edgisdbmaint\16_AfterOracle_restart_KeysetTableDrop_v2.sql"
