...
rem ---------------------------------------------------------------------------
IF EXIST "D:\edgisdbmaint\track_dppost_start.txt" (
...
call sc config %ServiceName3% start= demand                  >> %file_log% 2>&1
call net start %ServiceName3%                                >> %file_log% 2>&1
call sc config %ServiceName4% start= demand                  >> %file_log% 2>&1
call net start %ServiceName4%                                >> %file_log% 2>&1
echo Started GDBM Services.                                  >> %file_log% 2>&1
del D:\edgisdbmaint\track_dppost_start.txt
)
