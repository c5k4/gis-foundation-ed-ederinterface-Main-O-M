...
for /f %%a in ('PGE_DBPasswordManagement.exe GETPASSWORD SDE@EDERSUB_PR') do set "SDE_PWD=%%a"


sqlplus sde/"%SDE_PWD%"@EDERSUB_PR @"D:\edgisdbmaint\16_AfterOracle_restart_KeysetTableDrop_v2.sql"
