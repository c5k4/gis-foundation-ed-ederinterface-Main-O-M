...
REM rem ---------------------------------------------------------------------------
REM echo Stopping GDBM Services...    
...
REM call sc config %ServiceName3% start= disabled                 >> %file_log% 2>&1
REM call net stop %ServiceName3%                                  >> %file_log% 2>&1
REM call sc config %ServiceName4% start= disabled                 >> %file_log% 2>&1
REM call net stop %ServiceName4%                                  >> %file_log% 2>&1
REM echo Stopped  GDBM Services.                                  >> %file_log% 2>&1
echo.>"D:\edgisdbmaint\track_dppost_stop.txt"
...
rem call D:\GeodatabaseManager\GDBM_Logs\Move.bat  >> %file_log% 2>&1
