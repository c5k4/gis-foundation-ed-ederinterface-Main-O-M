...
rem Usage:  InterfaceIntegrationGatewayED15SUMM.bat
rem         
...
rem ---------------------------------------------------------------------------
reg copy       "HKCU\Control Panel\International" "HKCU\Control Panel\Int-Temp-ED15-SUMM" /f >nul
...
set date_log=%date%
reg copy       "HKCU\Control Panel\Int-Temp-ED15-SUMM" "HKCU\Control Panel\International" /f >nul
reg delete     "HKCU\Control Panel\Int-Temp-ED15-SUMM"                                    /f >nul
rem ===========================================================================
...
rem ---------------------------------------------------------------------------
set /A error_level_orig=%ERRORLEVEL%
