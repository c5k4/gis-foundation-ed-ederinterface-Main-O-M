echo off
rem ===========================================================================
rem Script Name: ED_DATA_RETEN_ED13.bat
...
for /f %%a in ('PGE_DBPasswordManagement.exe GETPASSWORD INTDATAARCH@EDGMC_PR') do set "INTDATAARCH_PWD=%%a"
...
sqlplus -s %uname%/%INTDATAARCH_PWD%@%EDGIS_Database% @%SQLScript_path% >> %file_log% 'ED13' 2>&1
set /A error_level=%error_level% + %ERRORLEVEL%             
