...
set EDGMC_Database=EDGMC_PR

set uname= INTDATAARCH
@echo off

for /f %%a in ('PGE_DBPasswordManagement.exe GETPASSWORD INTDATAARCH@EDGMC_PR') do set "EDGMC_INTDATAARCH_PWD=%%a"
