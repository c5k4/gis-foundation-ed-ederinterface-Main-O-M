echo off
rem Script Name: EDG_ChangeDetection_WIP.bat

rem ---------------------------------------------------------------------------
rem Set script variables.
rem ---------------------------------------------------------------------------
set cmdPath="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\Change Detection"
set cmdLine="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\Change Detection\PGE.BatchApplication.ChangeDetection.exe" -c WIP.config

rem set cmdPath1="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\PopulateCircuitIDTool"
rem set cmdLine1="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\PopulateCircuitIDTool\PGE.Interface.PopulateCircuitID.exe"
...
rem cd /d %cmdPath1%                                        >> %file_log% 2>&1
rem echo Executing %cmdLine1%...                            >> %file_log% 2>&1
rem call %cmdLine%                                          >> %file_log% 2>&1
rem %cmdLine1%                                              >> %file_log% 2>&1
rem set /A error_level=%error_level% + %ERRORLEVEL%
rem echo Executed  %cmdLine1%.                              >> %file_log% 2>&1
