echo off
rem Script Name: EDG_ChangeDetection_LBGIS.bat
exit 0
rem exit 0
...
set cmdLine="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\Change Detection\PGE.BatchApplication.ChangeDetection.exe" -c Landbase.config
...
#echo "Exit 0 is placed" >> %file_log% 2>&1
