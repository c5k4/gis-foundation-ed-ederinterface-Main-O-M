...
echo off
rem Script Name: EDG_WEBR_GEN_PGE_CIRCUITSOURCE.bat

rem ---------------------------------------------------------------------------
rem Set script variables.
rem ---------------------------------------------------------------------------
set cmdPath="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\PGE.PGE_FEEDERFEDFEEDER_INFO"
set cmdLine="PGE.BatchApplication.CircuitSource_Populate.exe"
