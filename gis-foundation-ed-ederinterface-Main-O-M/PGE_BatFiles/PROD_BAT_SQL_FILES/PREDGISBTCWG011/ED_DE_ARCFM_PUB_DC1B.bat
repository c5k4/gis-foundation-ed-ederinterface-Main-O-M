...
rem Usage:  ED_DeArcFMize_EDPUB.bat
rem         
...
set config_name=PGE.Miscellaneous.DeArcFM_EDPUB_DC1B.exe.config
...
rem ---------------------------------------------------------------------------
reg copy       "HKCU\Control Panel\International" "HKCU\Control Panel\Int-Temp-DeArcFM-PUB-DC1B" /f >nul
...
set date_log=%date%
reg copy       "HKCU\Control Panel\Int-Temp-DeArcFM-PUB-DC1B" "HKCU\Control Panel\International" /f >nul
reg delete     "HKCU\Control Panel\Int-Temp-DeArcFM-PUB-DC1B"                                    /f >nul
rem ===========================================================================
