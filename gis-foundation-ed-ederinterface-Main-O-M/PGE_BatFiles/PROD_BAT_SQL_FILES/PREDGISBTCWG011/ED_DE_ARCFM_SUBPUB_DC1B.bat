...
set config_name=PGE.Miscellaneous.DeArcFM_EDSUBPUB_DC1B.exe.config 
...
rem ---------------------------------------------------------------------------
reg copy       "HKCU\Control Panel\International" "HKCU\Control Panel\Int-Temp-DeArcFM-SUBPUB-DC1B" /f >nul
...
set date_log=%date%
reg copy       "HKCU\Control Panel\Int-Temp-DeArcFM-SUBPUB-DC1B" "HKCU\Control Panel\International" /f >nul
reg delete     "HKCU\Control Panel\Int-Temp-DeArcFM-SUBPUB-DC1B"                                    /f >nul
rem ===========================================================================
