...
rem ===========================================================================
rem ED_DELETE_VERSION_EDSUBGMC_DC1B.bat
rem ---------------------------------------------------------------------------
rem This SQL Script
...
rem Usage:  ED_DELETE_VERSION_EDSUBGMC_DC1B.bat
rem         
...
set inifile=EDSUBGMC_DC1Bconfig.ini
...
for /f %%a in ('PGE_DBPasswordManagement.exe GETPASSWORD SDE@EDSUBGMC_PR_DC1B') do set "sqlPWD=%%a"

echo Username:%sqlUSR%
echo Password:%sqlPWD%
echo Database:%sqlDB%

cd /d %file_path% 

set prepsqlCommand=EDSUBGMCpreparedeleteVersions.sql
set delsqlCommand=EDSUBGMCdeleteVersions.sql
...
rem ---------------------------------------------------------------------------
rem Execute Prepare Delete Versions List Sql.
rem ===========================================================================
...
rem sqlplus -s %sqlUSR%/%sqlPWD%@%sqlDB% @%delsqlCommand%    
