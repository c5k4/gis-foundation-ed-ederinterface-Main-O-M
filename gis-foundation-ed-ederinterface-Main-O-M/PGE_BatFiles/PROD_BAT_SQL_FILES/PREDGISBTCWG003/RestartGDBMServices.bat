...
rem set ServiceName4=EDERSUB_RECONCILE_01
...
echo Starting GDBM EDER_DATAPROCESSING_01 Services...                              >> %file_log% 2>&1
call net start %ServiceName1%                           >> %file_log% 2>&1
echo Started GDBM EDER_DATAPROCESSING_01 Services...     >> %file_log% 2>&1   

)
SC queryex "%ServiceName2%"|Find "STATE"|Find /v "Started">Nul&&(

echo Starting EDERSUB_DATAPROCESSING_01 Services...                              >> %file_log% 2>&1
call net start %ServiceName2%                               >> %file_log% 2>&1
echo Started EDERSUB_DATAPROCESSING_01 Services...     >> %file_log% 2>&1 

)
SC queryex "%ServiceName3%"|Find "STATE"|Find /v "Started">Nul&&(

echo Starting EDER_POST_01 Services...                              >> %file_log% 2>&1
call net start %ServiceName3%                               >> %file_log% 2>&1
echo Started EDER_POST_01  Services...     >> %file_log% 2>&1 

)
rem SC queryex "%ServiceName4%"|Find "STATE"|Find /v "Started">Nul&&(

rem echo Starting EDERSUB_POST_01 Services...                              >> %file_log% 2>&1
rem call net start %ServiceName4%                               >> %file_log% 2>&1
rem echo Started EDERSUB_POST_01  Services...     >> %file_log% 2>&1 
