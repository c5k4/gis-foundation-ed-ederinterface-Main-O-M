...
set inifile=EDSUBPUB_DC1Aconfig.ini
...
for /f %%a in ('PGE_DBPasswordManagement.exe GETPASSWORD SDE@EDSUBPUB_PR_DC1A') do set "sqlPWD=%%a"
...
set prepsqlCommand=EDSUBPUBpreparedeleteVersions.sql
