echo off
rem ===========================================================================
rem Script Name: ED_GIS_To_CCB_OUTBOUND_INTERFACE.bat
...
rem D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\CCBtoGISInterface
rem exit 0
...
rem Set script variables.
rem ---------------------------------------------------------------------------
set cmdPath="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\CCB"
rem set cmdLine=CCBtoGISInterface.exe
set cmdLine="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\CCB\PGE.Interfaces.CCBtoGISInterface.exe" OUTPROCESS
...
rem ---------------------------------------------------------------------------
rem Convert 9009 error to 0 for ignoring this message 'Program Complete , hit the X key to close'.
rem ---------------------------------------------------------------------------
if "%error_level%" equ "9009" set /A error_level=0
