...
for /f %%a in ('PGE_DBPasswordManagement.exe GETPASSWORD GIS_I@EDGMC') do set "sqlPWDs=%%a"
echo Output of print.exe is: %sqlPWD%
...
set cmdLine3="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\Map Production 2.0\PGE.Interfaces.MapProductionAutomation.exe" -c "D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\Map Production 2.0\MapProductionAutomation.exe.config" -i
set cmdLine4="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\Map Production 2.0\PGE.Interfaces.MapProductionAutomation.exe" -c "D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\Map Production 2.0\MapProductionAutomation.Schematics.exe.config" -i
...
REM rem ---------------------------------------------------------------------------
rem map_init_copy
echo ""Executing MP_INIT_TABLECOPY from EDGEM1T to EDGED1T"" 						>> %file_log% 2>&1
...
echo Executing %cmdLine4%...                                >> %file_log% 2>&1
call %cmdLine4%                                             >> %file_log% 2>&1
echo Error: %ERRORLEVEL%                                    >> %file_log% 2>&1
echo Executed  %cmdLine4%.                                  >> %file_log% 2>&1
