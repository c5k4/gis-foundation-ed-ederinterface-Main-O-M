echo off
rem ===========================================================================
rem Script Name: ED_DATA_RETEN_ED15.bat
...
set SQLScript_path=D:\edgisdbmaint\PGE_INT_DATA_RTNTN111.sql
...
sqlplus -s %uname%/%INTDATAARCH_PWD%@%EDGIS_Database% @%SQLScript_path% >> %file_log% 'ED151' 2>&1
set /A error_level=%error_level% + %ERRORLEVEL%             
