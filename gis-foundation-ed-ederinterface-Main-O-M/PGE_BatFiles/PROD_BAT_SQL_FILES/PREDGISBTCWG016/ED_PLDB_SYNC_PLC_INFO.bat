echo off
rem Script Name: PLDB_SynchPLCInfo.bat
...
set cmdPath="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\PLDBBatchProcess"
set cmdLine="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\PLDBBatchProcess\PGE.BatchApplication.PLDBBatchProcess.exe" -o SYNC_PLD_INFO
