echo off
rem Script Name: EDG_OldSessionNotification.bat
...
set cmdPath="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\PGE.OldSessionNotification"
set cmdLine="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\PGE.OldSessionNotification\PGE.BatchApplication.OldSessionNotification.exe"  PGE.BatchApplication.OldSessionNotification.config
