...
rem C:\Program Files (x86)\Miner and Miner\PG&E Custom Components\CCB
rem exit 0
...
set cmdLine="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\CCB\PGE.Interfaces.CCBtoGISInterface.exe" INPROCESS
