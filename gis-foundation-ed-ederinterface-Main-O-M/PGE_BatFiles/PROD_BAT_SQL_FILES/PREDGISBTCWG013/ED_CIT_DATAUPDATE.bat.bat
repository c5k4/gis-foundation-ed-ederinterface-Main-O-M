echo off
rem Script Name: EDG_CIT_DATAUPDATE.bat
...
set cmdPath="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\Conductor In Trench"
set cmdLine="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\Conductor In Trench\PGE.BatchApplication.ConductorInTrench.exe" DATAUPDATE
