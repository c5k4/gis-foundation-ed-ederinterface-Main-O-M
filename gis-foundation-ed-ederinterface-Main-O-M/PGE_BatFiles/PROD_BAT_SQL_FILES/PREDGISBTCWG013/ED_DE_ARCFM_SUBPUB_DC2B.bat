...
rem ===========================================================================
rem ED_DeArcFMize_EDSUBPUB.bat
rem ---------------------------------------------------------------------------
rem This script calls a python script performs the
rem ESRI ArcGIS Server function DeArcfMize Database
...
rem Usage:  ED_DeArcFMize_EDSUBPUB.bat
rem         
...
rem change config file name w.r.t. EDSUBPUB
set config_name=PGE.Miscellaneous.DeArcFM_EDSUBPUB_DC2B.exe.config 
set filename_script_01=PGE.Miscellaneous.DeArcFM.exe
set file_path="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\PGE.PublicationUpdate\DeArcFMize"

set filename_current=%~0
set path_current="%~dp0"
set file_current=%path_current%%filename_current%
set path_log=%path_current%log
set file_script_01=%file_path%\%filename_script_01% %config_name%
rem ===========================================================================

rem ===========================================================================
rem Get the Date into a variable.
rem ---------------------------------------------------------------------------
reg copy       "HKCU\Control Panel\International" "HKCU\Control Panel\Int-Temp-DeArcFM-SUBPUB-DC2B" /f >nul
...
set date_log=%date%
reg copy       "HKCU\Control Panel\Int-Temp-DeArcFM-SUBPUB-DC2B" "HKCU\Control Panel\International" /f >nul
reg delete     "HKCU\Control Panel\Int-Temp-DeArcFM-SUBPUB-DC2B"                                    /f >nul
rem ===========================================================================
