spool D:\DA_58_Scripts\Logs\SQL_12.txt
set serveroutput on
prompt Updating SERVICELOCATION ending with Objectid 2,3;
select current_timestamp from dual;

DECLARE
  x NUMBER := 0;  
  counter NUMBER := 0;
  cursor c1 is select * from edgis.SERVICELOCATION where objectid like ('%2') OR objectid like ('%3');
