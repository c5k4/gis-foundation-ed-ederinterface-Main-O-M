spool "D:\DQI_Scripts\Logs\SQL_POLE12345_DIVISION.txt"
SET SERVEROUTPUT ON
...
BEGIN
  ...
  exception when others then
    ...
    DBMS_OUTPUT.PUT_LINE ('Error in Pole Division update where error is '  || v_code || ' ' || v_errm);
    continue;
     end;
...
/
prompt Updating POLE intersect FOR division with  objectid  like 12345 is complete;
select current_timestamp from dual;
spool off;