spool "D:\DQI_Scripts\Logs\SQL_POLE67890_HFTD.txt"
SET SERVEROUTPUT ON
--set serveroutput on size 100000;
prompt Updating POLE intersect for hftd objectid like 67890 ;
...
/
prompt Updating POLE intersect FOR hftd with objectid  67890 is complete;
select current_timestamp from dual;
spool off;