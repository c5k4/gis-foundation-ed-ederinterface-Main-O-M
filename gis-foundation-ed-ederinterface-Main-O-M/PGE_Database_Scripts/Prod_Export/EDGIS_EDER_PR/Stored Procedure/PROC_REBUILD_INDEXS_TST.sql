--------------------------------------------------------
--  DDL for Procedure PROC_REBUILD_INDEXS_TST
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "EDGIS"."PROC_REBUILD_INDEXS_TST" (SchemaName IN NVARCHAR2, FreshExecution in BOOLEAN)
AS
