--------------------------------------------------------
--  DDL for Package LOCK_UTIL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "SDE"."LOCK_UTIL" 
/***********************************************************************
*
...
IS
  ...
  /* Type definitions. */
   ...
   SUBTYPE lock_type_t  IS SDE.table_locks.lock_type%TYPE;
   TYPE table_id_list_t IS TABLE OF table_id_t INDEX BY BINARY_INTEGER;
  ...
  /* Constants. */
   ...
   C_package_guid          CONSTANT VARCHAR2 (32):= 'EB567759EF814A27BE093976CAC4F1BD';
