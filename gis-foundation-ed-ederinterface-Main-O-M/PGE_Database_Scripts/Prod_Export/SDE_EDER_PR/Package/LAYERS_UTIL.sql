--------------------------------------------------------
--  DDL for Package LAYERS_UTIL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "SDE"."LAYERS_UTIL" 
/***********************************************************************
*
...
IS
  ...
  /* Type definitions. */
   ...
   SUBTYPE schema_name_t IS SDE.sde_util.identifier_t;
  ...
  /* Constants. */
   ...
   C_package_release       CONSTANT PLS_INTEGER := 1022;
   C_package_guid          CONSTANT VARCHAR2 (32):= '0B9445C940ED45BD86A455BDD112F3D3';
