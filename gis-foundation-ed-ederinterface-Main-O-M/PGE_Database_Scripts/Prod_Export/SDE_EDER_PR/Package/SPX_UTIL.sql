--------------------------------------------------------
--  DDL for Package SPX_UTIL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "SDE"."SPX_UTIL" Authid current_user 
/***********************************************************************
*
...
IS
   ...
   c_package_release              Constant pls_integer := 1179;
   C_package_guid                 CONSTANT VARCHAR2 (32):= '51079B12D57F47F79DF9C48A29FE4DF9';
   ...
   Type r_table_array IS Record (tab_object varchar2(128), curs number,
