--------------------------------------------------------
--  DDL for Package Body ST_TYPE_EXPORT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "SDE"."ST_TYPE_EXPORT" 
/***********************************************************************
*
...
Return varchar2
  ...
  tab_name     SDE.st_type_user.a_identifier_t;
  col_name     SDE.st_type_user.a_identifier_t;
  idx_name     SDE.st_type_user.a_identifier_t;
  tbs_name     SDE.st_type_user.a_identifier_t;
  geom_id      number;
  stmt         varchar2(4000);
  params       CLOB;
  old_param CLOB;
...
Procedure validate_sidx (table_owner IN nvarchar2, table_name IN nvarchar2, geom_id IN number)
  IS
    ...
    st_tab_name  SDE.st_type_user.a_identifier_t DEFAULT NULL;
    tab_cnt      INTEGER;
    pos          INTEGER;
...
Procedure validate_spref (table_owner IN nvarchar2, sr_name IN nvarchar2, srid IN number, x_offset IN float, y_offset IN float, xyunits IN float,
  ...
  pos2                  INTEGER;
  stmt                  VARCHAR2(4000);
  tab_owner             SDE.st_type_user.a_identifier_t;
  tab_name              SDE.st_type_user.a_identifier_t;
