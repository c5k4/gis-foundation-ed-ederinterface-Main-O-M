--------------------------------------------------------
--  DDL for Package LAYER_STATS_UTIL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "SDE"."LAYER_STATS_UTIL" 
/***********************************************************************
*
...
IS
  ...
  /* Type definitions. */
   ...
   DEF_column_name SDE.sde_util.identifier_t;
  ...
  /* Constants. */
   ...
   C_package_guid          CONSTANT VARCHAR2 (32):= 'C40A205D859943D39ED9E15AAB0A888E';
