--------------------------------------------------------
--  DDL for Package Body ST_TYPE_UTIL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "SDE"."ST_TYPE_UTIL" 
/***********************************************************************
*
...
IS
   ...
   G_current_user          SDE.st_type_util.spx_owner_t;
   tmp_user                SDE.st_type_util.spx_owner_t;
