--------------------------------------------------------
--  DDL for Package Body GDB_UTIL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "SDE"."GDB_UTIL" 
/***********************************************************************
*
...
/***********************************************************************
  ...
  ***********************************************************************/
  IS
    ...
    emaxx          number;
    emaxy          number;
    s_table        SDE.sde_util.identifier_t;
...
/***********************************************************************
  ...
  ***********************************************************************/
  IS 
    ...
    pos2           pls_integer;
    c_table        SDE.table_registry.table_name%TYPE;
    rowid_name     SDE.sde_util.a_column_t;
    p_name         varchar2(260);
    stmt           varchar2(512);
    i_val          pls_integer;
    owner_l        SDE.table_registry.owner%TYPE;
...
/***********************************************************************
  ...
  ***********************************************************************/
  ...
  IS
    ...
    stmt           varchar2(512);
    owner_l        SDE.sde_util.identifier_t;
    table_l        SDE.sde_util.identifier_t;
    column_l       SDE.sde_util.identifier_t;
...
/***********************************************************************
  ...
  ***********************************************************************/
  ...
  BEGIN
    ...
    if(ret != SDE.sde_util.se_success) Then
      return(NULL);
    End If;
...
/***********************************************************************
  ...
  ***********************************************************************/
  IS
    ...
    owner_l        SDE.sde_util.identifier_t;
    table_l        SDE.table_registry.owner%TYPE;
...
/***********************************************************************
  ...
  ***********************************************************************/
  IS
    ...
    table_l        SDE.table_registry.owner%TYPE;
    column_l       SDE.sde_util.identifier_t;
    i_column_l      SDE.sde_util.identifier_t;
    is_registered  boolean;
...
/***********************************************************************
  ...
  ***********************************************************************/
  IS
    ...
    TYPE t_varchar2 IS TABLE OF SDE.sde_util.a_owner_t;
...
/***********************************************************************
  ...
  ***********************************************************************/
  ...
  PROCEDURE update_open_cursors 
  /***********************************************************************
  *
  *N  {update_open_cursors}  --  updates the open_cursors parameter
  *        within the server_config table. 
  *
  *:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
  *
  *P  Purpose:
  *     This procedure updates the open_cursors parameter within the
  *   server_config the table.
  *E
  *:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
  *
  *A  Parameters:
  ...
  *H  History:
  *
  *    Josefina Santiago          08/15/16           Original coding.
  *E
  ***********************************************************************/
   IS
      PRAGMA AUTONOMOUS_TRANSACTION;
  
      -- Update the open_cursors parameter within the server_config table.
