--------------------------------------------------------
--  DDL for Package ST_TYPE_UTIL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "SDE"."ST_TYPE_UTIL" AS
/******************************************************************************
   name:       st_Type_Util
   purpose:
...
/* constants. */
   ...
   c_package_release                Constant pls_integer := 1115;
   C_package_guid                   CONSTANT VARCHAR2 (32):= '41FC032ED7C0404EA4DBFC1AF328E38C';
   ...
   Subtype spx_index_t              IS SDE.st_geometry_index.index_name%Type;
   ...
   st_invalid_unit_name             Constant number := -20102;
