--------------------------------------------------------
--  DDL for Package ST_TYPE_USER
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "SDE"."ST_TYPE_USER" AS
/******************************************************************************
   name:       st_Type_Util
   purpose:
...
/* constants. */
   ...
   c_package_release                Constant pls_integer := 1002;
   C_package_guid                   CONSTANT VARCHAR2 (32):= 'D74C31BAC1B54D0E8ECD96ACC407E378';   
   
   se_success                       Constant number := 0;

   -- Type definitions

   SUBTYPE spat_owner_t             IS SDE.ST_GEOMETRY_COLUMNS.owner%TYPE;

   SUBTYPE a_identifier_t           IS VARCHAR2(128);
