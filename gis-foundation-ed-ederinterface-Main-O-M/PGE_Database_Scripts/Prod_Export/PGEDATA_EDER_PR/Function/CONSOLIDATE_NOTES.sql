--------------------------------------------------------
--  DDL for Function CONSOLIDATE_NOTES
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "PGEDATA"."CONSOLIDATE_NOTES" (i_type varchar2, i_protection_id NUMBER, i_status_cd varchar2,
