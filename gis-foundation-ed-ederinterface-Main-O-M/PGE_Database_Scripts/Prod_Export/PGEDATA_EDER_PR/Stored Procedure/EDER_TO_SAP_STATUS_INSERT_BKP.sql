--------------------------------------------------------
--  DDL for Procedure EDER_TO_SAP_STATUS_INSERT_BKP
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "PGEDATA"."EDER_TO_SAP_STATUS_INSERT_BKP" 
(
    STATUS OUT VARCHAR,
...
END EDER_TO_SAP_STATUS_INSERT_BKP;
