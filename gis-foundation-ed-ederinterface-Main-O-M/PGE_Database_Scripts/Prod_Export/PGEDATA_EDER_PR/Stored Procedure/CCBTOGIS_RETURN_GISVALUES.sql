--------------------------------------------------------
--  DDL for Procedure CCBTOGIS_RETURN_GISVALUES
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "PGEDATA"."CCBTOGIS_RETURN_GISVALUES" AS
...
Insert into PGEDATA.TEMP_CCB_SP_OUT_A (
   ...
   sysdate,(select user from dual), --'GIS_I_WRITE',--M4JF Updated create_userid
