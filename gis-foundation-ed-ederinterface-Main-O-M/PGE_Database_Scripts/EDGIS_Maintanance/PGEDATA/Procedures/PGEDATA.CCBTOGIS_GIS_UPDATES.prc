Prompt drop Procedure CCBTOGIS_GIS_UPDATES;
DROP PROCEDURE PGEDATA.CCBTOGIS_GIS_UPDATES
/

Prompt Procedure CCBTOGIS_GIS_UPDATES;
--
-- CCBTOGIS_GIS_UPDATES  (Procedure) 
--
CREATE OR REPLACE PROCEDURE PGEDATA.CCBTOGIS_GIS_UPDATES(version_name IN VARCHAR2) AS
...
Prompt Grants on PROCEDURE CCBTOGIS_GIS_UPDATES TO EDGIS to EDGIS;
GRANT EXECUTE, DEBUG ON PGEDATA.CCBTOGIS_GIS_UPDATES TO EDGIS
/

Prompt Grants on PROCEDURE CCBTOGIS_GIS_UPDATES TO GIS_I to GIS_I;
GRANT EXECUTE, DEBUG ON PGEDATA.CCBTOGIS_GIS_UPDATES TO GIS_I
/

Prompt Grants on PROCEDURE CCBTOGIS_GIS_UPDATES TO GIS_I_WRITE to GIS_I_WRITE;
GRANT EXECUTE, DEBUG ON PGEDATA.CCBTOGIS_GIS_UPDATES TO GIS_I_WRITE
/

Prompt Grants on PROCEDURE CCBTOGIS_GIS_UPDATES TO IGPCITEDITOR to IGPCITEDITOR;
GRANT EXECUTE, DEBUG ON PGEDATA.CCBTOGIS_GIS_UPDATES TO IGPCITEDITOR
/

Prompt Grants on PROCEDURE CCBTOGIS_GIS_UPDATES TO IGPEDITOR to IGPEDITOR;
GRANT EXECUTE, DEBUG ON PGEDATA.CCBTOGIS_GIS_UPDATES TO IGPEDITOR
/

Prompt Grants on PROCEDURE CCBTOGIS_GIS_UPDATES TO SDE to SDE;
GRANT EXECUTE, DEBUG ON PGEDATA.CCBTOGIS_GIS_UPDATES TO SDE
/
