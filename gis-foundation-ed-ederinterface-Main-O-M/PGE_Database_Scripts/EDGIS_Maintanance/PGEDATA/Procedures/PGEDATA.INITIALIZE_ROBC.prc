Prompt drop Procedure INITIALIZE_ROBC;
DROP PROCEDURE PGEDATA.INITIALIZE_ROBC
/

Prompt Procedure INITIALIZE_ROBC;
--
-- INITIALIZE_ROBC  (Procedure) 
--
CREATE OR REPLACE PROCEDURE PGEDATA.Initialize_Robc
As
