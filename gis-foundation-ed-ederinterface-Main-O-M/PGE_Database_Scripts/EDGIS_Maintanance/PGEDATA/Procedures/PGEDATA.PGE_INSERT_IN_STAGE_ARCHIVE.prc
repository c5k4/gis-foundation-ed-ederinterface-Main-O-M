Prompt drop Procedure PGE_INSERT_IN_STAGE_ARCHIVE;
DROP PROCEDURE PGEDATA.PGE_INSERT_IN_STAGE_ARCHIVE
/

Prompt Procedure PGE_INSERT_IN_STAGE_ARCHIVE;
--
-- PGE_INSERT_IN_STAGE_ARCHIVE  (Procedure) 
--
CREATE OR REPLACE PROCEDURE PGEDATA."PGE_INSERT_IN_STAGE_ARCHIVE" AS
BEGIN
...
Prompt Grants on PROCEDURE PGE_INSERT_IN_STAGE_ARCHIVE TO GIS_I_WRITE to GIS_I_WRITE;
GRANT EXECUTE, DEBUG ON PGEDATA.PGE_INSERT_IN_STAGE_ARCHIVE TO GIS_I_WRITE
/

Prompt Grants on PROCEDURE PGE_INSERT_IN_STAGE_ARCHIVE TO IGPCITEDITOR to IGPCITEDITOR;
GRANT EXECUTE, DEBUG ON PGEDATA.PGE_INSERT_IN_STAGE_ARCHIVE TO IGPCITEDITOR
/

Prompt Grants on PROCEDURE PGE_INSERT_IN_STAGE_ARCHIVE TO IGPEDITOR to IGPEDITOR;
GRANT EXECUTE, DEBUG ON PGEDATA.PGE_INSERT_IN_STAGE_ARCHIVE TO IGPEDITOR
/
