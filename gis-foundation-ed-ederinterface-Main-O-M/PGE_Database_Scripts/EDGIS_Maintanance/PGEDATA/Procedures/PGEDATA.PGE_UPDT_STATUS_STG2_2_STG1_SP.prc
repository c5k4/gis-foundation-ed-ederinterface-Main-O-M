Prompt drop Procedure PGE_UPDT_STATUS_STG2_2_STG1_SP;
DROP PROCEDURE PGEDATA.PGE_UPDT_STATUS_STG2_2_STG1_SP
/

Prompt Procedure PGE_UPDT_STATUS_STG2_2_STG1_SP;
--
-- PGE_UPDT_STATUS_STG2_2_STG1_SP  (Procedure) 
--
CREATE OR REPLACE PROCEDURE PGEDATA.PGE_UPDT_STATUS_STG2_2_STG1_SP
IS
...
Prompt Grants on PROCEDURE PGE_UPDT_STATUS_STG2_2_STG1_SP TO GIS_I_WRITE to GIS_I_WRITE;
GRANT EXECUTE, DEBUG ON PGEDATA.PGE_UPDT_STATUS_STG2_2_STG1_SP TO GIS_I_WRITE
/

Prompt Grants on PROCEDURE PGE_UPDT_STATUS_STG2_2_STG1_SP TO IGPCITEDITOR to IGPCITEDITOR;
GRANT EXECUTE, DEBUG ON PGEDATA.PGE_UPDT_STATUS_STG2_2_STG1_SP TO IGPCITEDITOR
/

Prompt Grants on PROCEDURE PGE_UPDT_STATUS_STG2_2_STG1_SP TO IGPEDITOR to IGPEDITOR;
GRANT EXECUTE, DEBUG ON PGEDATA.PGE_UPDT_STATUS_STG2_2_STG1_SP TO IGPEDITOR
/
