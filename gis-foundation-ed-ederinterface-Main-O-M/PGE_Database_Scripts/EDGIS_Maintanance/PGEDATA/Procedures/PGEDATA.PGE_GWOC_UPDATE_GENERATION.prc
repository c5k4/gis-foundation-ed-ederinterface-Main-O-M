Prompt drop Procedure PGE_GWOC_UPDATE_GENERATION;
DROP PROCEDURE PGEDATA.PGE_GWOC_UPDATE_GENERATION
/

Prompt Procedure PGE_GWOC_UPDATE_GENERATION;
--
-- PGE_GWOC_UPDATE_GENERATION  (Procedure) 
--
CREATE OR REPLACE PROCEDURE PGEDATA."PGE_GWOC_UPDATE_GENERATION"
  (
...
Prompt Grants on PROCEDURE PGE_GWOC_UPDATE_GENERATION TO GIS_I_WRITE to GIS_I_WRITE;
GRANT EXECUTE, DEBUG ON PGEDATA.PGE_GWOC_UPDATE_GENERATION TO GIS_I_WRITE
/

Prompt Grants on PROCEDURE PGE_GWOC_UPDATE_GENERATION TO IGPCITEDITOR to IGPCITEDITOR;
GRANT EXECUTE, DEBUG ON PGEDATA.PGE_GWOC_UPDATE_GENERATION TO IGPCITEDITOR
/

Prompt Grants on PROCEDURE PGE_GWOC_UPDATE_GENERATION TO IGPEDITOR to IGPEDITOR;
GRANT EXECUTE, DEBUG ON PGEDATA.PGE_GWOC_UPDATE_GENERATION TO IGPEDITOR
/
