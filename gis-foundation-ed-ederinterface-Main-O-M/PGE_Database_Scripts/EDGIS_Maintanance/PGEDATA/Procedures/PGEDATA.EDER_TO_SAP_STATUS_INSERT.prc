Prompt drop Procedure EDER_TO_SAP_STATUS_INSERT;
DROP PROCEDURE PGEDATA.EDER_TO_SAP_STATUS_INSERT
/

Prompt Procedure EDER_TO_SAP_STATUS_INSERT;
--
-- EDER_TO_SAP_STATUS_INSERT  (Procedure) 
--
CREATE OR REPLACE PROCEDURE PGEDATA."EDER_TO_SAP_STATUS_INSERT"
(
    STATUS OUT VARCHAR,
...
begin
  ...
  insert into pgedata.EDER_TO_SAP_STATUS
	...
	WHEN o.STATUS = 'W'
        THEN 'W'
        ELSE 'E'
      END AS STATUS,o.status_message status_message,TRUNC(Sysdate) as date_inserted,
...
Prompt Grants on PROCEDURE EDER_TO_SAP_STATUS_INSERT TO GIS_I_WRITE to GIS_I_WRITE;
GRANT EXECUTE, DEBUG ON PGEDATA.EDER_TO_SAP_STATUS_INSERT TO GIS_I_WRITE
/

Prompt Grants on PROCEDURE EDER_TO_SAP_STATUS_INSERT TO IGPCITEDITOR to IGPCITEDITOR;
GRANT EXECUTE, DEBUG ON PGEDATA.EDER_TO_SAP_STATUS_INSERT TO IGPCITEDITOR
/

Prompt Grants on PROCEDURE EDER_TO_SAP_STATUS_INSERT TO IGPEDITOR to IGPEDITOR;
GRANT EXECUTE, DEBUG ON PGEDATA.EDER_TO_SAP_STATUS_INSERT TO IGPEDITOR
/
