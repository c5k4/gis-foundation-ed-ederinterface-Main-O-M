Prompt drop Procedure GENERATE_EXT_CCB_METER_LOAD_1;
DROP PROCEDURE PGEDATA.GENERATE_EXT_CCB_METER_LOAD_1
/

Prompt Procedure GENERATE_EXT_CCB_METER_LOAD_1;
--
-- GENERATE_EXT_CCB_METER_LOAD_1  (Procedure) 
--
CREATE OR REPLACE PROCEDURE PGEDATA."GENERATE_EXT_CCB_METER_LOAD_1"
As
     V_Date date;
