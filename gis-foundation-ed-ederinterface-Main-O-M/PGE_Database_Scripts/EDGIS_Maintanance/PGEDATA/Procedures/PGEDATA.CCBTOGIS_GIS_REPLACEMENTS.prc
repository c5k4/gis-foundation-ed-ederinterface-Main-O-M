Prompt drop Procedure CCBTOGIS_GIS_REPLACEMENTS;
DROP PROCEDURE PGEDATA.CCBTOGIS_GIS_REPLACEMENTS
/

Prompt Procedure CCBTOGIS_GIS_REPLACEMENTS;
--
-- CCBTOGIS_GIS_REPLACEMENTS  (Procedure) 
--
CREATE OR REPLACE PROCEDURE PGEDATA.CCBTOGIS_GIS_REPLACEMENTS(version_name IN VARCHAR2) AS
...
Prompt Grants on PROCEDURE CCBTOGIS_GIS_REPLACEMENTS TO EDGIS to EDGIS;
GRANT EXECUTE, DEBUG ON PGEDATA.CCBTOGIS_GIS_REPLACEMENTS TO EDGIS
/

Prompt Grants on PROCEDURE CCBTOGIS_GIS_REPLACEMENTS TO GIS_I to GIS_I;
GRANT EXECUTE, DEBUG ON PGEDATA.CCBTOGIS_GIS_REPLACEMENTS TO GIS_I
/

Prompt Grants on PROCEDURE CCBTOGIS_GIS_REPLACEMENTS TO GIS_I_WRITE to GIS_I_WRITE;
GRANT EXECUTE, DEBUG ON PGEDATA.CCBTOGIS_GIS_REPLACEMENTS TO GIS_I_WRITE
/

Prompt Grants on PROCEDURE CCBTOGIS_GIS_REPLACEMENTS TO IGPCITEDITOR to IGPCITEDITOR;
GRANT EXECUTE, DEBUG ON PGEDATA.CCBTOGIS_GIS_REPLACEMENTS TO IGPCITEDITOR
/

Prompt Grants on PROCEDURE CCBTOGIS_GIS_REPLACEMENTS TO IGPEDITOR to IGPEDITOR;
GRANT EXECUTE, DEBUG ON PGEDATA.CCBTOGIS_GIS_REPLACEMENTS TO IGPEDITOR
/

Prompt Grants on PROCEDURE CCBTOGIS_GIS_REPLACEMENTS TO SDE to SDE;
GRANT EXECUTE, DEBUG ON PGEDATA.CCBTOGIS_GIS_REPLACEMENTS TO SDE
/
