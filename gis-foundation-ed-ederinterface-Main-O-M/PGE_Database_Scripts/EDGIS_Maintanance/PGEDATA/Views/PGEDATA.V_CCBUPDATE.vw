Prompt drop View V_CCBUPDATE;
DROP VIEW PGEDATA.V_CCBUPDATE
/

/* Formatted on 6/27/2019 02:52:13 PM (QP5 v5.313) */
PROMPT View V_CCBUPDATE;
--
-- V_CCBUPDATE  (View)
--

CREATE OR REPLACE FORCE VIEW PGEDATA.V_CCBUPDATE
(
    OBJECTID,
    NEWBADGE,
    FMETRICOM,
...
AS
    SELECT a."OBJECTID",
      ...
      FROM EDGIS.STREETLIGHT_INV a, SLCDX_UNIQUEDATA b
     WHERE a.SP_id = b.SP_id
/


Prompt Grants on VIEW V_CCBUPDATE TO A0SW to A0SW;
GRANT SELECT ON PGEDATA.V_CCBUPDATE TO A0SW
/

Prompt Grants on VIEW V_CCBUPDATE TO GIS_I to GIS_I;
GRANT DELETE, INSERT, SELECT, UPDATE ON PGEDATA.V_CCBUPDATE TO GIS_I
/

Prompt Grants on VIEW V_CCBUPDATE TO S7MA to S7MA;
GRANT SELECT ON PGEDATA.V_CCBUPDATE TO S7MA
/
