...
/* Formatted on 6/27/2019 02:49:43 PM (QP5 v5.313) */
...
Prompt Grants on MATERIALIZED VIEW PGE_FEEDERFEDNETWORK_TRACE_VW TO PONS_RO to PONS_RO;
GRANT SELECT ON EDGIS.PGE_FEEDERFEDNETWORK_TRACE_VW TO PONS_RO
/

Prompt Grants on TABLE PGE_FEEDERFEDNETWORK_TRACE_VW TO WEBR to WEBR;
GRANT ALTER, DELETE, INDEX, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK ON EDGIS.PGE_FEEDERFEDNETWORK_TRACE_VW TO WEBR
/
