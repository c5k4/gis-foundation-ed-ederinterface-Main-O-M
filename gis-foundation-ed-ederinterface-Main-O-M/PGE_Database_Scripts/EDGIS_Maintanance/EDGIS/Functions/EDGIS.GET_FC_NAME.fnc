...
Prompt Grants on FUNCTION GET_FC_NAME TO IGPCITEDITOR to IGPCITEDITOR;
GRANT EXECUTE ON EDGIS.GET_FC_NAME TO IGPCITEDITOR
/

Prompt Grants on FUNCTION GET_FC_NAME TO IGPEDITOR to IGPEDITOR;
GRANT EXECUTE ON EDGIS.GET_FC_NAME TO IGPEDITOR
/
