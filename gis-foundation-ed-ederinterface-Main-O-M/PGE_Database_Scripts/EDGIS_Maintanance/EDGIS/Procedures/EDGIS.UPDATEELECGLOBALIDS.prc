Prompt drop Procedure UPDATEELECGLOBALIDS;
DROP PROCEDURE EDGIS.UPDATEELECGLOBALIDS
/

Prompt Procedure UPDATEELECGLOBALIDS;
--
-- UPDATEELECGLOBALIDS  (Procedure) 
--
CREATE OR REPLACE PROCEDURE EDGIS.UpdateElecGlobalIDs AS
...
Prompt Grants on PROCEDURE UPDATEELECGLOBALIDS TO GISINTERFACE to GISINTERFACE;
GRANT EXECUTE ON EDGIS.UPDATEELECGLOBALIDS TO GISINTERFACE
/
