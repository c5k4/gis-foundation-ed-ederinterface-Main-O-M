Prompt drop Procedure UPDATE_FI_MATERIALCODE;
DROP PROCEDURE EDGIS.UPDATE_FI_MATERIALCODE
/

Prompt Procedure UPDATE_FI_MATERIALCODE;
--
-- UPDATE_FI_MATERIALCODE  (Procedure) 
--
CREATE OR REPLACE PROCEDURE EDGIS.Update_FI_MATERIALCODE
IS
