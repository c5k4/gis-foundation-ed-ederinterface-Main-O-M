...
Prompt Grants on PROCEDURE NULL_NON_NUMERIC_SAPEQUIPID TO IGPCITEDITOR to IGPCITEDITOR;
GRANT EXECUTE ON EDGIS.NULL_NON_NUMERIC_SAPEQUIPID TO IGPCITEDITOR
/

Prompt Grants on PROCEDURE NULL_NON_NUMERIC_SAPEQUIPID TO IGPEDITOR to IGPEDITOR;
GRANT EXECUTE ON EDGIS.NULL_NON_NUMERIC_SAPEQUIPID TO IGPEDITOR
/
