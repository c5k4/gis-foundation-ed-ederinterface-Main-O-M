Prompt drop Procedure UPDATEFEATINFOTEMPTABLE;
DROP PROCEDURE EDGIS.UPDATEFEATINFOTEMPTABLE
/

Prompt Procedure UPDATEFEATINFOTEMPTABLE;
--
-- UPDATEFEATINFOTEMPTABLE  (Procedure) 
--
CREATE OR REPLACE PROCEDURE EDGIS.UpdateFeatInfoTempTable(temp_table_name IN VARCHAR2,index_name in VARCHAR2,startInsert in number,endInsert in number) AS
...
Prompt Grants on PROCEDURE UPDATEFEATINFOTEMPTABLE TO EDGISBO to EDGISBO;
GRANT EXECUTE ON EDGIS.UPDATEFEATINFOTEMPTABLE TO EDGISBO
/

Prompt Grants on PROCEDURE UPDATEFEATINFOTEMPTABLE TO GISINTERFACE to GISINTERFACE;
GRANT EXECUTE ON EDGIS.UPDATEFEATINFOTEMPTABLE TO GISINTERFACE
/

Prompt Grants on PROCEDURE UPDATEFEATINFOTEMPTABLE TO GIS_I to GIS_I;
GRANT EXECUTE ON EDGIS.UPDATEFEATINFOTEMPTABLE TO GIS_I
/

Prompt Grants on PROCEDURE UPDATEFEATINFOTEMPTABLE TO GIS_INTERFACE to GIS_INTERFACE;
GRANT EXECUTE ON EDGIS.UPDATEFEATINFOTEMPTABLE TO GIS_INTERFACE
/
