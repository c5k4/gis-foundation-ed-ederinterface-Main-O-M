Prompt drop Procedure UPDATE_NULLINSTALLATIONTYPE;
DROP PROCEDURE EDGIS.UPDATE_NULLINSTALLATIONTYPE
/

Prompt Procedure UPDATE_NULLINSTALLATIONTYPE;
--
-- UPDATE_NULLINSTALLATIONTYPE  (Procedure) 
--
CREATE OR REPLACE PROCEDURE EDGIS.UPDATE_NULLINSTALLATIONTYPE
IS
  -- VARIABLES
  regid     NUMBER(10);
