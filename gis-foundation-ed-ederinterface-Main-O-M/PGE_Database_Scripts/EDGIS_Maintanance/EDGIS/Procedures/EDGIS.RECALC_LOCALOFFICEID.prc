...
Prompt Grants on PROCEDURE RECALC_LOCALOFFICEID TO IGPCITEDITOR to IGPCITEDITOR;
GRANT EXECUTE ON EDGIS.RECALC_LOCALOFFICEID TO IGPCITEDITOR
/

Prompt Grants on PROCEDURE RECALC_LOCALOFFICEID TO IGPEDITOR to IGPEDITOR;
GRANT EXECUTE ON EDGIS.RECALC_LOCALOFFICEID TO IGPEDITOR
/
