Prompt drop Procedure TRUNCATETRACINGTABLES;
DROP PROCEDURE EDGIS.TRUNCATETRACINGTABLES
/

Prompt Procedure TRUNCATETRACINGTABLES;
--
-- TRUNCATETRACINGTABLES  (Procedure) 
--
CREATE OR REPLACE PROCEDURE EDGIS.TruncateTracingTables AS
...
Prompt Grants on PROCEDURE TRUNCATETRACINGTABLES TO GISINTERFACE to GISINTERFACE;
GRANT EXECUTE ON EDGIS.TRUNCATETRACINGTABLES TO GISINTERFACE
/
