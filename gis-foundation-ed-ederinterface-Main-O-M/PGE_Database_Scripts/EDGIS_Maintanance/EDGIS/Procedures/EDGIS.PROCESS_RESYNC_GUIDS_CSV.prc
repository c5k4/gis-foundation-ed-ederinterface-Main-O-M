...
Prompt Grants on PROCEDURE PROCESS_RESYNC_GUIDS_CSV TO IGPCITEDITOR to IGPCITEDITOR;
GRANT EXECUTE ON EDGIS.PROCESS_RESYNC_GUIDS_CSV TO IGPCITEDITOR
/

Prompt Grants on PROCEDURE PROCESS_RESYNC_GUIDS_CSV TO IGPEDITOR to IGPEDITOR;
GRANT EXECUTE ON EDGIS.PROCESS_RESYNC_GUIDS_CSV TO IGPEDITOR
/
