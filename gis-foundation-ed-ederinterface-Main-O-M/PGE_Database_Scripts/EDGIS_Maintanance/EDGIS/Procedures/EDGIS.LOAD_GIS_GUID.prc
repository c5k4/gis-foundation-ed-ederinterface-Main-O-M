Prompt drop Procedure LOAD_GIS_GUID;
DROP PROCEDURE EDGIS.LOAD_GIS_GUID
/

Prompt Procedure LOAD_GIS_GUID;
--
-- LOAD_GIS_GUID  (Procedure) 
--
CREATE OR REPLACE PROCEDURE EDGIS.LOAD_GIS_GUID
AS
BEGIN
  DECLARE
...
Prompt Grants on PROCEDURE LOAD_GIS_GUID TO GIS_I to GIS_I;
GRANT EXECUTE, DEBUG ON EDGIS.LOAD_GIS_GUID TO GIS_I
/
