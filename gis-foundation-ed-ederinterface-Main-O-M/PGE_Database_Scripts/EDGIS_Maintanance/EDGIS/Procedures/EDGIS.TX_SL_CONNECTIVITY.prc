Prompt drop Procedure TX_SL_CONNECTIVITY;
DROP PROCEDURE EDGIS.TX_SL_CONNECTIVITY
/

Prompt Procedure TX_SL_CONNECTIVITY;
--
-- TX_SL_CONNECTIVITY  (Procedure) 
--
CREATE OR REPLACE PROCEDURE EDGIS.TX_SL_CONNECTIVITY AS
...
Prompt Grants on PROCEDURE TX_SL_CONNECTIVITY TO GISINTERFACE to GISINTERFACE;
GRANT EXECUTE ON EDGIS.TX_SL_CONNECTIVITY TO GISINTERFACE
/

Prompt Grants on PROCEDURE TX_SL_CONNECTIVITY TO GIS_INTERFACE to GIS_INTERFACE;
