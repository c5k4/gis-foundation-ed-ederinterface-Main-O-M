...
/* Formatted on 6/27/2019 02:57:20 PM (QP5 v5.313) */
...
Prompt Grants on VIEW ZZ_MV_DCCONDUCTOR TO A0SW to A0SW;
GRANT SELECT ON EDGIS.ZZ_MV_DCCONDUCTOR TO A0SW
/
...
Prompt Grants on VIEW ZZ_MV_DCCONDUCTOR TO IGPCITEDITOR to IGPCITEDITOR;
GRANT DELETE, INSERT, SELECT, UPDATE ON EDGIS.ZZ_MV_DCCONDUCTOR TO IGPCITEDITOR
/

Prompt Grants on VIEW ZZ_MV_DCCONDUCTOR TO IGPEDITOR to IGPEDITOR;
GRANT DELETE, INSERT, SELECT, UPDATE ON EDGIS.ZZ_MV_DCCONDUCTOR TO IGPEDITOR
/

Prompt Grants on VIEW ZZ_MV_DCCONDUCTOR TO M4AB to M4AB;
GRANT SELECT ON EDGIS.ZZ_MV_DCCONDUCTOR TO M4AB
/
...
Prompt Grants on VIEW ZZ_MV_DCCONDUCTOR TO RSDH to RSDH;
GRANT DELETE, INSERT, SELECT, UPDATE ON EDGIS.ZZ_MV_DCCONDUCTOR TO RSDH
/

Prompt Grants on VIEW ZZ_MV_DCCONDUCTOR TO S7MA to S7MA;
GRANT SELECT ON EDGIS.ZZ_MV_DCCONDUCTOR TO S7MA
/
