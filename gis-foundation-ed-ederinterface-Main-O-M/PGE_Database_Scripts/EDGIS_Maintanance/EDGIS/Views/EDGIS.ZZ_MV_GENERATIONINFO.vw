...
/* Formatted on 6/27/2019 02:55:53 PM (QP5 v5.313) */
...
Prompt Grants on VIEW ZZ_MV_GENERATIONINFO TO A0SW to A0SW;
GRANT SELECT ON EDGIS.ZZ_MV_GENERATIONINFO TO A0SW
/
...
Prompt Grants on VIEW ZZ_MV_GENERATIONINFO TO IGPCITEDITOR to IGPCITEDITOR;
GRANT DELETE, INSERT, SELECT, UPDATE ON EDGIS.ZZ_MV_GENERATIONINFO TO IGPCITEDITOR
/

Prompt Grants on VIEW ZZ_MV_GENERATIONINFO TO IGPEDITOR to IGPEDITOR;
GRANT DELETE, INSERT, SELECT, UPDATE ON EDGIS.ZZ_MV_GENERATIONINFO TO IGPEDITOR
/
...
Prompt Grants on VIEW ZZ_MV_GENERATIONINFO TO S7MA to S7MA;
GRANT SELECT ON EDGIS.ZZ_MV_GENERATIONINFO TO S7MA
/
