Prompt drop View ZZ_MV_PADMOUNTSTRUCTURE;
DROP VIEW EDGIS.ZZ_MV_PADMOUNTSTRUCTURE
/

/* Formatted on 6/27/2019 02:54:39 PM (QP5 v5.313) */
PROMPT View ZZ_MV_PADMOUNTSTRUCTURE;
--
-- ZZ_MV_PADMOUNTSTRUCTURE  (View)
--

CREATE OR REPLACE FORCE VIEW EDGIS.ZZ_MV_PADMOUNTSTRUCTURE
(
    OBJECTID,
    GLOBALID,
    CREATIONUSER,
...
AS
    SELECT b.OBJECTID,
           ...
           b.SHAPE,
           0 SDE_STATE_ID
      FROM EDGIS.PADMOUNTSTRUCTURE  b,
...
Prompt Grants on VIEW ZZ_MV_PADMOUNTSTRUCTURE TO A0SW to A0SW;
GRANT SELECT ON EDGIS.ZZ_MV_PADMOUNTSTRUCTURE TO A0SW
/

Prompt Grants on VIEW ZZ_MV_PADMOUNTSTRUCTURE TO DAT_EDITOR to DAT_EDITOR;
GRANT DELETE, INSERT, SELECT, UPDATE ON EDGIS.ZZ_MV_PADMOUNTSTRUCTURE TO DAT_EDITOR
/

Prompt Grants on VIEW ZZ_MV_PADMOUNTSTRUCTURE TO EDGISBO to EDGISBO;
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK, MERGE VIEW ON EDGIS.ZZ_MV_PADMOUNTSTRUCTURE TO EDGISBO
/

Prompt Grants on VIEW ZZ_MV_PADMOUNTSTRUCTURE TO GISINTERFACE to GISINTERFACE;
GRANT SELECT ON EDGIS.ZZ_MV_PADMOUNTSTRUCTURE TO GISINTERFACE
/

Prompt Grants on VIEW ZZ_MV_PADMOUNTSTRUCTURE TO GIS_I to GIS_I;
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK, MERGE VIEW ON EDGIS.ZZ_MV_PADMOUNTSTRUCTURE TO GIS_I
/

Prompt Grants on VIEW ZZ_MV_PADMOUNTSTRUCTURE TO GIS_I_WRITE to GIS_I_WRITE;
GRANT DELETE, INSERT, SELECT, UPDATE ON EDGIS.ZZ_MV_PADMOUNTSTRUCTURE TO GIS_I_WRITE
/

Prompt Grants on VIEW ZZ_MV_PADMOUNTSTRUCTURE TO IGPCITEDITOR to IGPCITEDITOR;
GRANT DELETE, INSERT, SELECT, UPDATE ON EDGIS.ZZ_MV_PADMOUNTSTRUCTURE TO IGPCITEDITOR
/

Prompt Grants on VIEW ZZ_MV_PADMOUNTSTRUCTURE TO IGPEDITOR to IGPEDITOR;
GRANT DELETE, INSERT, SELECT, UPDATE ON EDGIS.ZZ_MV_PADMOUNTSTRUCTURE TO IGPEDITOR
/

Prompt Grants on VIEW ZZ_MV_PADMOUNTSTRUCTURE TO M4AB to M4AB;
GRANT SELECT ON EDGIS.ZZ_MV_PADMOUNTSTRUCTURE TO M4AB
/

Prompt Grants on VIEW ZZ_MV_PADMOUNTSTRUCTURE TO MM_ADMIN to MM_ADMIN;
GRANT DELETE, INSERT, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK, MERGE VIEW ON EDGIS.ZZ_MV_PADMOUNTSTRUCTURE TO MM_ADMIN
/

Prompt Grants on VIEW ZZ_MV_PADMOUNTSTRUCTURE TO RSDH to RSDH;
GRANT DELETE, INSERT, SELECT, UPDATE ON EDGIS.ZZ_MV_PADMOUNTSTRUCTURE TO RSDH
/

Prompt Grants on VIEW ZZ_MV_PADMOUNTSTRUCTURE TO S7MA to S7MA;
GRANT SELECT ON EDGIS.ZZ_MV_PADMOUNTSTRUCTURE TO S7MA
/

Prompt Grants on VIEW ZZ_MV_PADMOUNTSTRUCTURE TO SDE to SDE;
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK, MERGE VIEW ON EDGIS.ZZ_MV_PADMOUNTSTRUCTURE TO SDE
/

Prompt Grants on VIEW ZZ_MV_PADMOUNTSTRUCTURE TO SDE_EDITOR to SDE_EDITOR;
GRANT DELETE, INSERT, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK, MERGE VIEW ON EDGIS.ZZ_MV_PADMOUNTSTRUCTURE TO SDE_EDITOR
/

Prompt Grants on VIEW ZZ_MV_PADMOUNTSTRUCTURE TO SDE_VIEWER to SDE_VIEWER;
GRANT SELECT ON EDGIS.ZZ_MV_PADMOUNTSTRUCTURE TO SDE_VIEWER
/
