Prompt drop Package Body SDO_WFS_PROCESS_UTIL;
DROP PACKAGE BODY MDSYS.SDO_WFS_PROCESS_UTIL
/

Prompt Package Body SDO_WFS_PROCESS_UTIL;
--
-- SDO_WFS_PROCESS_UTIL  (Package Body) 
--
