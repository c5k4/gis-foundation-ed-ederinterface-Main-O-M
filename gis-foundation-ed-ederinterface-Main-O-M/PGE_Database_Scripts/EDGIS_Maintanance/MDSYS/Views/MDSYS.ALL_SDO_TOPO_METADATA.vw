Prompt drop View ALL_SDO_TOPO_METADATA;
DROP VIEW MDSYS.ALL_SDO_TOPO_METADATA
/

/* Formatted on 6/27/2019 02:52:00 PM (QP5 v5.313) */
PROMPT View ALL_SDO_TOPO_METADATA;
--
-- ALL_SDO_TOPO_METADATA  (View)
--

CREATE OR REPLACE FORCE VIEW MDSYS.ALL_SDO_TOPO_METADATA
(
    OWNER,
    TOPOLOGY,
    TOPOLOGY_ID,
...
Prompt Synonym ALL_SDO_TOPO_METADATA;
--
-- ALL_SDO_TOPO_METADATA  (Synonym) 
--
CREATE OR REPLACE PUBLIC SYNONYM ALL_SDO_TOPO_METADATA FOR MDSYS.ALL_SDO_TOPO_METADATA
/


Prompt Grants on VIEW ALL_SDO_TOPO_METADATA TO PUBLIC to PUBLIC;
