...
command="expdp $account/$password@$ORACLE_SID compression=all full=y reuse_dumpfiles=y directory=UC4_EXPORT_DIR dumpfile=$filename_export_parallel_tmp\%U.dmp logfile=$filename_export_log_tmp CLUSTER=N PARALLEL=4"
comecho="expdp $account/password@$ORACLE_SID compression=all full=y reuse_dumpfiles=y  directory=UC4_EXPORT_DIR dumpfile=$filename_export_parallel_tmp\%U.dmp logfile=$filename_export_log_tmp CLUSTER=N PARALLEL=4"
...
#============================================================================
# Copy Tmp Export File to Export File and chmod export files.
#----------------------------------------------------------------------------
max=4
i=0
dmpname=.dmp
