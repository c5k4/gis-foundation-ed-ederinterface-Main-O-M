#!/bin/sh
#============================================================================
# EDG_COPY_ED_TO_BATCH_DC2_DR.sh
#----------------------------------------------------------------------------
# USAGE:        EDG_COPY_ED_TO_BATCH_DC2_DR.sh
...
echo  "Removing edgisp4p dump file from edgisdboraprd02 .." >> $file_log_tmp 2>&1
echo " Removing edgisp4p dump file from edgisdboraprd02 .." >> $file_log 2>&1
ssh -q edgisdboraprd02 'rm /u02/uc4/edgisp3p/import/edgisp4p_01.dmp' >> $file_log_tmp 2>&1
ssh -q edgisdboraprd02 'rm /u02/uc4/edgisp3p/import/edgisp4p_02.dmp' >> $file_log_tmp 2>&1
ssh -q edgisdboraprd02 'rm /u02/uc4/edgisp3p/import/edgisp4p_03.dmp' >> $file_log_tmp 2>&1
ssh -q edgisdboraprd02 'rm /u02/uc4/edgisp3p/import/edgisp4p_04.dmp' >> $file_log_tmp 2>&1
#============================================================================
...
# Copy dump file from 
#----------------------------------------------------------------------------
echo " Copying edgisp4p dump file to edgisdboraprd02 .." >> $file_log_tmp 2>&1
echo " Copying edgisp4p dump file to edgisdboraprd02 .." >> $file_log 2>&1
