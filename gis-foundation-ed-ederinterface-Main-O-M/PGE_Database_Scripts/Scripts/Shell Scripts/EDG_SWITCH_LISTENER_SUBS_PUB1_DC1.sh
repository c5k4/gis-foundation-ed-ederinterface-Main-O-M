...
sqlplus UC4ADMIN/uc4admin@edsubp7p<<ENDOFSQL
set echo on term on
set serveroutput on size unlimited
#alter system set service_names='edsubp7p,edsubp7p.WORLD';
exec set_service_names('edsubp7p,edsubp7p.WORLD');
exit;
ENDOFSQL

sqlplus UC4ADMIN/uc4admin@edsubp1p <<ENDOFSQL
set echo on term on
set serveroutput on size unlimited
exec set_service_names('edsubp1p,edsubp1p.WORLD,EDSUBDC1_P,EDSUBDC1_P.WORLD');
exit;
ENDOFSQL
echo "Deactivated DC1-PUB2-edsubp7p"
echo "Activated DC1-PUB1-edsubp1p"
#============================================================================
...
sqlplus UC4ADMIN/uc4admin@edsubp7p << EOF_KILL_PROCESS
