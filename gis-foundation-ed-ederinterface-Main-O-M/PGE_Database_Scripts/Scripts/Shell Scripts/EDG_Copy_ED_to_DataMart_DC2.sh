#!/bin/sh
#============================================================================
# EDG_Copy_ED_to_DataMart_DC2.sh
#----------------------------------------------------------------------------
# USAGE:        EDG_Copy_ED_to_DataMart_DC2.sh
...
echo  " Removing edgisp1p dump file from edgisdboraprd06 .." >> $file_log_tmp 2>&1
echo " Removing edgisp1p dump file from edgisdboraprd06 .." >> $file_log 2>&1
ssh -q edgisdboraprd06 'rm /u02/uc4/eddatm2p/import/edgisp1p_01.dmp' >> $file_log_tmp 2>&1
ssh -q edgisdboraprd06 'rm /u02/uc4/eddatm2p/import/edgisp1p_02.dmp' >> $file_log_tmp 2>&1
ssh -q edgisdboraprd06 'rm /u02/uc4/eddatm2p/import/edgisp1p_03.dmp' >> $file_log_tmp 2>&1
ssh -q edgisdboraprd06 'rm /u02/uc4/eddatm2p/import/edgisp1p_04.dmp' >> $file_log_tmp 2>&1
#============================================================================

#============================================================================
# Copy dump file from 
#----------------------------------------------------------------------------
echo " Copying edgisp1p dump file to edgisdboraprd06 .." >> $file_log_tmp 2>&1
echo " Copying edgisp1p dump file to edgisdboraprd06 .." >> $file_log 2>&1
...
echo  " Changing permission of edgisp1p dump file from edgisdboraprd06 .." >> $file_log_tmp 2>&1
echo " Changing permission of edgisp1p dump file from edgisdboraprd06 .." >> $file_log 2>&1
ssh -q edgisdboraprd06 'chmod 777 /u02/uc4/eddatm2p/import/edgisp1p_01.dmp' >> $file_log_tmp 2>&1
ssh -q edgisdboraprd06 'chmod 777 /u02/uc4/eddatm2p/import/edgisp1p_02.dmp' >> $file_log_tmp 2>&1
ssh -q edgisdboraprd06 'chmod 777 /u02/uc4/eddatm2p/import/edgisp1p_03.dmp' >> $file_log_tmp 2>&1
ssh -q edgisdboraprd06 'chmod 777 /u02/uc4/eddatm2p/import/edgisp1p_04.dmp' >> $file_log_tmp 2>&1
#============================================================================
