#!/bin/sh
#=============================================================================
# EDG_Gather_Stats_Redline.sh
#-----------------------------------------------------------------------------
# USAGE:        EDG_Gather_Stats_Redline.sh
...
#-----------------------------------------------------------------------------
dbtype=redlinedc2
filename_script_2=rebuild_index_gather_stats_redline.sh
degree=8
#=============================================================================
...
command="$file_script_2 $account_webr    $password_webr   $oracle_sid $date_time $degree"
comecho="$file_script_2 $account_webr    ***************   $oracle_sid $date_time $degree"
