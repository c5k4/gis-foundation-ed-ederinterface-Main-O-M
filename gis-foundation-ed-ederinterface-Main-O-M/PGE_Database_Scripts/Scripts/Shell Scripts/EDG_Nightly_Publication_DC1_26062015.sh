#!/bin/sh
#=============================================================================
# EDG_Nightly_Publication_DC1.sh
#-----------------------------------------------------------------------------
# USAGE:        EDG_Nightly_Publication_DC1.sh
...
#=============================================================================
# Copy edgisp2p.dmp /u02/uc4/edgisp1p/import to /u02/uc4/edgisp2p/import
#-----------------------------------------------------------------------------

command="cp /u02/uc4/edgisp1p/import/edgisp2p.dmp /u02/uc4/edgisp2p/import/"
echo "Executing $command..."  >> $file_log_tmp 2>&1
$command      >> $file_log_tmp 2>&1
int_error_code=`expr $int_error_code + $?`
echo "Executed  $command."    >> $file_log_tmp 2>&1
...
#=============================================================================
# Import edgisp2p dmp file into edgisp2p of edgisdboraprd01 server
#-----------------------------------------------------------------------------
command="$file_script_2 edgisp2p edgisp2p $date_time"
comecho="$file_script_2 edgisp2p edgisp2p $date_time"
