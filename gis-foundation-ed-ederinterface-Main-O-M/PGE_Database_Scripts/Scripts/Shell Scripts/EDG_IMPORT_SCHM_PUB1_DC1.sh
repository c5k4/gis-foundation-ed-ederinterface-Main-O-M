#!/bin/sh
#=============================================================================
# EDG_Import_Schematic_Pub_DC1.sh
#-----------------------------------------------------------------------------
# USAGE:        EDG_Import_Batch_DC1.sh
...
#-----------------------------------------------------------------------------
dbtype_import=edschm
dbtype=edschmpub
filename_script_2=import_schm_pub.sh
filename_script_3=rebuild_index_gather_stats_schematics.sh
degree=4
#=============================================================================
...
password_lbgis=`$file_script_get_pwd       $account_lbgis       $oracle_sid`
...
#=============================================================================
# Execute Gather Stats and rebuild index.
#-----------------------------------------------------------------------------
command="$file_script_3 $account_sde      $password_sde   $oracle_sid $date_time $degree"
comecho="$file_script_3 $account_sde      *************     $oracle_sid $date_time $degree"
...
command="$file_script_3 $account_edgis      $password_edgis    $oracle_sid $date_time $degree"
comecho="$file_script_3 $account_edgis      *************     $oracle_sid $date_time $degree"
...
command="$file_script_3 $account_lbgis      $password_lbgis    $oracle_sid $date_time $degree"
comecho="$file_script_3 $account_lbgis      *************     $oracle_sid $date_time $degree"
