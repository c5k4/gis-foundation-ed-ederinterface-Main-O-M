...
dbtype_import=edaux
dbtype=datamart
filename_script_2=import_tlm.sh
filename_script_1=rebuild_index_gather_stats.sh
#=============================================================================
...
file_script_1=$path_script/$filename_script_1
...
command="$file_script_1 $account_edtlm      $password_edtlm      $oracle_sid $date_time 21"
comecho="$file_script_1 $account_edtlm       password_edtlm      $oracle_sid $date_time 21"
