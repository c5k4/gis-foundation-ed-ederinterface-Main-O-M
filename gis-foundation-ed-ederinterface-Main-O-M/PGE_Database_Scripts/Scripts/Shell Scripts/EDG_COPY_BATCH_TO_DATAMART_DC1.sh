#!/bin/sh
#============================================================================
# EDG_COPY_BATCH_TO_DATAMART_DC2.sh
#----------------------------------------------------------------------------
# USAGE:        EDG_COPY_BATCH_TO_DATAMART_DC2.sh
...
#-----------------------------------------------------------------------------
  file_fr=/u02/uc4/edgisp2p/export/edgisp2p.dmp
  file_to=/u02/uc4/eddatm1p/import/edgisp2p.dmp
