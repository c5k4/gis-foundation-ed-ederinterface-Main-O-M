...
echo  "UC4 WEBR DC1 Maintenance :"$date_time": "$filename_script_base".sh:\\n This is to inform you that, Import of EDG Publication DC1 is complete now.\\n WEBR DC1 will be ready shortly. \\n Please call EDGIS Support for more details. \\n Operations Team is performing a smoke test. They will get back to you if any issue is found." | mailx -s "WEBR DC1 System Maintenace Status." -r "EDGISSupport<EDGISSupport@Exchange.pge.com>" "ITGISINCIDENTTEAM<ITGISINCIDENTTEAM@Exchange.pge.com>" 
fi
#=============================================================================
