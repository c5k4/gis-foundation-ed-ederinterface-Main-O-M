#!/bin/sh
#============================================================================
# EDG_Copy_ED_to_DataMart_DC1.sh
#----------------------------------------------------------------------------
# USAGE:        EDG_Copy_ED_to_DataMart_DC1.sh
...
echo  " Removing edgisp1p dump file from edgisdboraprd05 .." >> $file_log_tmp 2>&1
echo " Removing edgisp1p dump file from edgisdboraprd05 .." >> $file_log 2>&1
ssh -q edgisdboraprd05 'rm /u02/uc4/eddatm1p/import/edgisp1p_01.dmp' >> $file_log_tmp 2>&1
ssh -q edgisdboraprd05 'rm /u02/uc4/eddatm1p/import/edgisp1p_02.dmp' >> $file_log_tmp 2>&1
ssh -q edgisdboraprd05 'rm /u02/uc4/eddatm1p/import/edgisp1p_03.dmp' >> $file_log_tmp 2>&1
ssh -q edgisdboraprd05 'rm /u02/uc4/eddatm1p/import/edgisp1p_04.dmp' >> $file_log_tmp 2>&1
#============================================================================

#============================================================================
# Copy dump file from 
#----------------------------------------------------------------------------
echo " Copying edgisp1p dump file to edgisdboraprd05 .." >> $file_log_tmp 2>&1
echo " Copying edgisp1p dump file to edgisdboraprd05 .." >> $file_log 2>&1
...
scp $srcfile  edgisdboraprd05:/u02/uc4/eddatm1p/import >> $file_log_tmp 2>&1
done
...
echo  " Changing permission of edgisp1p dump file from edgisdboraprd05 .." >> $file_log_tmp 2>&1
echo " Changing permission of edgisp1p dump file from edgisdboraprd05 .." >> $file_log 2>&1
ssh -q edgisdboraprd05 'chmod 777 /u02/uc4/eddatm1p/import/edgisp1p_01.dmp' >> $file_log_tmp 2>&1
ssh -q edgisdboraprd05 'chmod 777 /u02/uc4/eddatm1p/import/edgisp1p_02.dmp' >> $file_log_tmp 2>&1
ssh -q edgisdboraprd05 'chmod 777 /u02/uc4/eddatm1p/import/edgisp1p_03.dmp' >> $file_log_tmp 2>&1
ssh -q edgisdboraprd05 'chmod 777 /u02/uc4/eddatm1p/import/edgisp1p_04.dmp' >> $file_log_tmp 2>&1
#============================================================================
