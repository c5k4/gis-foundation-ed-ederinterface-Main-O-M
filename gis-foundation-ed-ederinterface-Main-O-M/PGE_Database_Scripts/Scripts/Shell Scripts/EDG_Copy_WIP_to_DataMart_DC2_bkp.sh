...
if [ "$machine" == 'edgisdboraprd01' ] ; then
   ...
   ssh -q edgisdboraprd06 'rm /u02/uc4/eddatm1p/import/$oracle_sid.dmp' >> $file_log_tmp 2>&1
else
...
if [ "$machine" == 'edgisdboraprd01' ] ; then
   ...
   scp  /u02/uc4/$oracle_sid/export/$oracle_sid.dmp  edgisdboraprd06:/u02/uc4/eddatm1p/import >> $file_log_tmp 2>&1
else
   if [ "$machine" == 'edgisdboraqa01' ] ; then
