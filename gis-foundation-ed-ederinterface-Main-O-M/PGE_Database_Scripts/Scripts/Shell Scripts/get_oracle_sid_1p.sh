...
if [ "$dbtype" == 'edmaint' ] ; then
  case $machine in
    ...
    "edgisdboraprd06") oracle_sid=edgis1p    ;;
  esac
fi
...
if [ "$dbtype" == 'edpub' ] ; then
  case $machine in
    ...
    "edgisdboraprd06") oracle_sid=edgisp1p ;;
...
if [ "$dbtype" == 'edsub' ] ; then
  case $machine in
    ...
    "edgisdboraprd06") oracle_sid=edsub1p    ;;
  esac
fi
...
if [ "$dbtype" == 'edsubpub' ] ; then
  case $machine in
    ...
    "edgisdboraprd06") oracle_sid=edsubp1p ;;
...
if [ "$dbtype" == 'redline' ] ; then
  case $machine in
    ...
    "edgisdboraprd05") oracle_sid=edgisw1p    ;;
    "edgisdboraprd06") oracle_sid=edgisw1p    ;;
...
if [ "$dbtype" == 'redlinedc2' ] ; then
  case $machine in
    ...
    "edgisdboraprd02") oracle_sid=edgisw1pdg  ;;
    "edgisdboraprd05") oracle_sid=edgisw1pdg  ;;
    "edgisdboraprd06") oracle_sid=edgisw1pdg  ;;
