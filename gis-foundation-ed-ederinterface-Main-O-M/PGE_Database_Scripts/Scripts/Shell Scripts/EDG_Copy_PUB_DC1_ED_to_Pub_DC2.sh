#!/bin/sh
#============================================================================
# EDG_Copy_PUB_DC1_ED_to_Pub_DC2.sh
#----------------------------------------------------------------------------
# USAGE:        EDG_Copy_PUB_DC1_ED_to_Pub_DC2.sh
...
echo  " Removing edgisp1p dump file from edgisdboraprd02 .." >> $file_log_tmp 2>&1
echo " Removing edgisp1p dump file from edgisdboraprd02 .." >> $file_log 2>&1
ssh -q edgisdboraprd02 'rm /u02/uc4/edgisp3p/import/edgisp1p_01.dmp' >> $file_log_tmp 2>&1
ssh -q edgisdboraprd02 'rm /u02/uc4/edgisp3p/import/edgisp1p_02.dmp' >> $file_log_tmp 2>&1
ssh -q edgisdboraprd02 'rm /u02/uc4/edgisp3p/import/edgisp1p_03.dmp' >> $file_log_tmp 2>&1
ssh -q edgisdboraprd02 'rm /u02/uc4/edgisp3p/import/edgisp1p_04.dmp' >> $file_log_tmp 2>&1
#============================================================================

#============================================================================
# Copy dump file from 
#----------------------------------------------------------------------------
echo " Copying edgisp1p dump file to edgisdboraprd02 .." >> $file_log_tmp 2>&1
echo " Copying edgisp1p dump file to edgisdboraprd02 .." >> $file_log 2>&1
...
while [ $((i+=1)) -le $max ]
do
srcfile=/u02/uc4/edgisp1p/export/edgisp1p\_0$i.dmp
scp $srcfile  edgisdboraprd02:/u02/uc4/edgisp3p/import >> $file_log_tmp 2>&1
done
...
#============================================================================
# Changing permission of destination dump file 
#----------------------------------------------------------------------------
echo $(date) >> $file_log_tmp 2>&1
echo $(date) >>  $file_log 2>&1

echo  " Changing permission of edgisp1p dump file from edgisdboraprd02 .." >> $file_log_tmp 2>&1
echo " Changing permission of edgisp1p dump file from edgisdboraprd02 .." >> $file_log 2>&1
ssh -q edgisdboraprd02 'chmod 777 /u02/uc4/edgisp3p/import/edgisp1p_01.dmp' >> $file_log_tmp 2>&1
ssh -q edgisdboraprd02 'chmod 777 /u02/uc4/edgisp3p/import/edgisp1p_02.dmp' >> $file_log_tmp 2>&1
ssh -q edgisdboraprd02 'chmod 777 /u02/uc4/edgisp3p/import/edgisp1p_03.dmp' >> $file_log_tmp 2>&1
ssh -q edgisdboraprd02 'chmod 777 /u02/uc4/edgisp3p/import/edgisp1p_04.dmp' >> $file_log_tmp 2>&1
#============================================================================
