...
#----------------------------------------------------------------------------
command="expdp $account/$password@$ORACLE_SID compression=all full=y reuse_dumpfiles=y directory=UC4_EXPORT_DIR dumpfile=$filename_export_tmp logfile=$filename_export_log"
comecho="expdp $account/password@$ORACLE_SID compression=all full=y reuse_dumpfiles=y  directory=UC4_EXPORT_DIR dumpfile=$filename_export_tmp logfile=$filename_export_log"
...
#----------------------------------------------------------------------------
command="$path_script/rm_old_dmp_files.sh $UC4_EXPORT_DIR 10"
...
#----------------------------------------------------------------------------
command="$path_script/gzip_old_log_files.sh $UC4_EXPORT_DIR 10"
