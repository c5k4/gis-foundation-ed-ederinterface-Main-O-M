...
#               this is a copy of the original export.sh 
#               it does a non-parallel full export of the oracle_sid passed
#============================================================================
...
#============================================================================
# Copy export files from edgisdboraprd02 to edgisdboraprd01
#----------------------------------------------------------------------------
echo "Executing copy from edgisdboraprd02 to edgisdboraprd01"
scp   edgisdboraprd02:/u02/uc4/edgisw1p/export/edgisw1p.dmp  /u02/uc4/edgisw1p/export
echo "Executed copy from edgisdboraprd02 to edgisdboraprd01"
#============================================================================
