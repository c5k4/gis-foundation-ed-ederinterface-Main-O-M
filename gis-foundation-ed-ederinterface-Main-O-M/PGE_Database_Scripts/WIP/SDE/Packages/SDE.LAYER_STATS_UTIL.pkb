Prompt drop Package Body LAYER_STATS_UTIL;
DROP PACKAGE BODY SDE.LAYER_STATS_UTIL
/

Prompt Package Body LAYER_STATS_UTIL;
--
-- LAYER_STATS_UTIL  (Package Body) 
--
CREATE OR REPLACE PACKAGE BODY SDE.layer_stats_util
/***********************************************************************
*
