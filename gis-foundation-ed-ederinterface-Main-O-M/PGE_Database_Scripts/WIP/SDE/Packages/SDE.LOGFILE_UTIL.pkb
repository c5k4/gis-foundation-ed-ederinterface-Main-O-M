Prompt drop Package Body LOGFILE_UTIL;
DROP PACKAGE BODY SDE.LOGFILE_UTIL
/

Prompt Package Body LOGFILE_UTIL;
--
-- LOGFILE_UTIL  (Package Body) 
--
CREATE OR REPLACE PACKAGE BODY SDE.logfile_util
/***********************************************************************
*
...
Prompt Grants on PACKAGE LOGFILE_UTIL TO PUBLIC to PUBLIC;
GRANT EXECUTE ON SDE.LOGFILE_UTIL TO PUBLIC WITH GRANT OPTION
/
