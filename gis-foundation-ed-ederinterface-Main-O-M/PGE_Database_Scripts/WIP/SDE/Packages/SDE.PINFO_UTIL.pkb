Prompt drop Package Body PINFO_UTIL;
DROP PACKAGE BODY SDE.PINFO_UTIL
/

Prompt Package Body PINFO_UTIL;
--
-- PINFO_UTIL  (Package Body) 
--
CREATE OR REPLACE PACKAGE BODY SDE.pinfo_util
/***********************************************************************
*
...
Prompt Grants on PACKAGE PINFO_UTIL TO PUBLIC to PUBLIC;
GRANT EXECUTE ON SDE.PINFO_UTIL TO PUBLIC WITH GRANT OPTION
/
