Prompt drop Package Body METADATA_UTIL;
DROP PACKAGE BODY SDE.METADATA_UTIL
/

Prompt Package Body METADATA_UTIL;
--
-- METADATA_UTIL  (Package Body) 
--
CREATE OR REPLACE PACKAGE BODY SDE.metadata_util
/***********************************************************************
*
...
Prompt Grants on PACKAGE METADATA_UTIL TO PUBLIC to PUBLIC;
GRANT EXECUTE ON SDE.METADATA_UTIL TO PUBLIC WITH GRANT OPTION
/
