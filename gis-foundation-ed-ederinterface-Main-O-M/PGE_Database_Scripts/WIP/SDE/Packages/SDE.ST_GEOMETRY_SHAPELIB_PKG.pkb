Prompt drop Package Body ST_GEOMETRY_SHAPELIB_PKG;
DROP PACKAGE BODY SDE.ST_GEOMETRY_SHAPELIB_PKG
/

Prompt Package Body ST_GEOMETRY_SHAPELIB_PKG;
--
-- ST_GEOMETRY_SHAPELIB_PKG  (Package Body) 
--
...
Prompt Grants on PACKAGE ST_GEOMETRY_SHAPELIB_PKG TO PUBLIC to PUBLIC;
GRANT EXECUTE ON SDE.ST_GEOMETRY_SHAPELIB_PKG TO PUBLIC WITH GRANT OPTION
/
