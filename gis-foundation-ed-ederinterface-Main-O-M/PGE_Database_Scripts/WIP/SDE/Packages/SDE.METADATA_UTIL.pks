Prompt drop Package METADATA_UTIL;
DROP PACKAGE SDE.METADATA_UTIL
/

Prompt Package METADATA_UTIL;
--
-- METADATA_UTIL  (Package) 
--
CREATE OR REPLACE PACKAGE SDE.metadata_util
/***********************************************************************
*
