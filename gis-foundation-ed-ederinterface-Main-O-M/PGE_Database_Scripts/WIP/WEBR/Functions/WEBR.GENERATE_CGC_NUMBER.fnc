...
Prompt Grants on FUNCTION GENERATE_CGC_NUMBER TO WIP_RO to WIP_RO;
GRANT EXECUTE ON WEBR.GENERATE_CGC_NUMBER TO WIP_RO
/

Prompt Grants on FUNCTION GENERATE_CGC_NUMBER TO WIP_RW to WIP_RW;
GRANT EXECUTE ON WEBR.GENERATE_CGC_NUMBER TO WIP_RW
/
