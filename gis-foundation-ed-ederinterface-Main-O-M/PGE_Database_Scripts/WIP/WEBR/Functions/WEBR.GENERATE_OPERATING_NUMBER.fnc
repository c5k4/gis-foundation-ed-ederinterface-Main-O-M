...
Prompt Grants on FUNCTION GENERATE_OPERATING_NUMBER TO WIP_RO to WIP_RO;
GRANT EXECUTE ON WEBR.GENERATE_OPERATING_NUMBER TO WIP_RO
/

Prompt Grants on FUNCTION GENERATE_OPERATING_NUMBER TO WIP_RW to WIP_RW;
GRANT EXECUTE ON WEBR.GENERATE_OPERATING_NUMBER TO WIP_RW
/
