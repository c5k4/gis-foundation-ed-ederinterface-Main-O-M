Prompt drop View SM_RECLOSER_ERD_VW;
DROP VIEW EDSETT.SM_RECLOSER_ERD_VW
/

/* Formatted on 7/1/2019 10:06:23 PM (QP5 v5.313) */
PROMPT View SM_RECLOSER_ERD_VW;
--
-- SM_RECLOSER_ERD_VW  (View)
--

CREATE OR REPLACE FORCE VIEW EDSETT.SM_RECLOSER_ERD_VW
(
    GLOBAL_ID,
    FEATURE_CLASS_NAME,
    OPERATING_NUM,
...
Prompt Grants on VIEW SM_RECLOSER_ERD_VW TO GIS_I to GIS_I;
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK, MERGE VIEW ON EDSETT.SM_RECLOSER_ERD_VW TO GIS_I
/
