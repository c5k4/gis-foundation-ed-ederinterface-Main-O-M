Prompt drop View SM_RECLOSER_TS_EAD_VW;
DROP VIEW EDSETT.SM_RECLOSER_TS_EAD_VW
/

/* Formatted on 7/1/2019 10:06:25 PM (QP5 v5.313) */
PROMPT View SM_RECLOSER_TS_EAD_VW;
--
-- SM_RECLOSER_TS_EAD_VW  (View)
--

CREATE OR REPLACE FORCE VIEW EDSETT.SM_RECLOSER_TS_EAD_VW
(
    ID,
    GLOBAL_ID,
    FEATURE_CLASS_NAME,
