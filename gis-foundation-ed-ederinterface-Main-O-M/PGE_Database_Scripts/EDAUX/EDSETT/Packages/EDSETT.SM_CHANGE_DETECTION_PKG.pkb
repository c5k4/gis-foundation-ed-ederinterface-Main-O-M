Prompt drop Package Body SM_CHANGE_DETECTION_PKG;
DROP PACKAGE BODY EDSETT.SM_CHANGE_DETECTION_PKG
/

Prompt Package Body SM_CHANGE_DETECTION_PKG;
--
-- SM_CHANGE_DETECTION_PKG  (Package Body) 
--
