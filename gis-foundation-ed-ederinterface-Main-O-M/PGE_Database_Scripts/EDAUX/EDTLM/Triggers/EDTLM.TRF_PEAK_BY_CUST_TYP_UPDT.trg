Prompt drop Trigger TRF_PEAK_BY_CUST_TYP_UPDT;
DROP TRIGGER EDTLM.TRF_PEAK_BY_CUST_TYP_UPDT
/

Prompt Trigger TRF_PEAK_BY_CUST_TYP_UPDT;
--
-- TRF_PEAK_BY_CUST_TYP_UPDT  (Trigger) 
--
