Prompt drop Trigger TRF_PEAK_GEN_HIST_UPDT;
DROP TRIGGER EDTLM.TRF_PEAK_GEN_HIST_UPDT
/

Prompt Trigger TRF_PEAK_GEN_HIST_UPDT;
--
-- TRF_PEAK_GEN_HIST_UPDT  (Trigger) 
--
