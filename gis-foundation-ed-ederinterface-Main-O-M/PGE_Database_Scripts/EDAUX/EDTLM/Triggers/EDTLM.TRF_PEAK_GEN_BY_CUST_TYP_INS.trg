Prompt drop Trigger TRF_PEAK_GEN_BY_CUST_TYP_INS;
DROP TRIGGER EDTLM.TRF_PEAK_GEN_BY_CUST_TYP_INS
/

Prompt Trigger TRF_PEAK_GEN_BY_CUST_TYP_INS;
--
-- TRF_PEAK_GEN_BY_CUST_TYP_INS  (Trigger) 
--
CREATE OR REPLACE TRIGGER EDTLM.TRF_PEAK_GEN_BY_CUST_TYP_INS BEFORE
  INSERT ON EDTLM.TRF_PEAK_GEN_BY_CUST_TYP FOR EACH ROW
