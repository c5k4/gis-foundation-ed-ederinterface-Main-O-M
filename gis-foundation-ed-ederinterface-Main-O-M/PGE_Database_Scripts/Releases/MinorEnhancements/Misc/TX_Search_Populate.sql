...
INSERT INTO EDGIS.T_CUSTADD(OBJECTID,SERVICEPOINTID,TRANSFORMERGUID,METERNUMBER,SPADDRESS,TXADDRESS) 
SELECT A.OBJECTID, A.SERVICEPOINTID,A.TRANSFORMERGUID,A.METERNUMBER,
