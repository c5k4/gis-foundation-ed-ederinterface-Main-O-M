Prompt drop Trigger EEP_REPORT_INS;
DROP TRIGGER ROBCAPP.EEP_REPORT_INS
/

Prompt Trigger EEP_REPORT_INS;
--
-- EEP_REPORT_INS  (Trigger) 
--
CREATE OR REPLACE TRIGGER ROBCAPP.EEP_REPORT_INS
BEFORE INSERT ON ROBCAPP.EEP_REPORT
FOR EACH ROW
BEGIN
