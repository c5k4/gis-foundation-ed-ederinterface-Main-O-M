Prompt drop Trigger TRF_CCB_METER_LOAD_INS;
DROP TRIGGER EDTLM.TRF_CCB_METER_LOAD_INS
/

Prompt Trigger TRF_CCB_METER_LOAD_INS;
--
-- TRF_CCB_METER_LOAD_INS  (Trigger) 
--
CREATE OR REPLACE TRIGGER EDTLM.TRF_CCB_METER_LOAD_INS
...
BEGIN <<COLUMN_SEQUENCES>>
  ...
  BEGIN
    IF INSERTING AND :NEW.ID IS NULL THEN
      SELECT EDTLM.TRF_CCB_METER_LOAD_SEQ.NEXTVAL INTO :NEW.ID FROM SYS.DUAL;
    END IF;
