Prompt drop Trigger TRF_PEAK_HIST_INS;
DROP TRIGGER EDTLM.TRF_PEAK_HIST_INS
/

Prompt Trigger TRF_PEAK_HIST_INS;
--
-- TRF_PEAK_HIST_INS  (Trigger) 
--
CREATE OR REPLACE TRIGGER EDTLM.TRF_PEAK_HIST_INS BEFORE
  INSERT ON EDTLM.TRF_PEAK_HIST FOR EACH ROW
