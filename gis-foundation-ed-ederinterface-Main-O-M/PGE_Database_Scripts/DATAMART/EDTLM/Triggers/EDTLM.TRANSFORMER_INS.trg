Prompt drop Trigger TRANSFORMER_INS;
DROP TRIGGER EDTLM.TRANSFORMER_INS
/

Prompt Trigger TRANSFORMER_INS;
--
-- TRANSFORMER_INS  (Trigger) 
--
CREATE OR REPLACE TRIGGER EDTLM.TRANSFORMER_INS BEFORE
  INSERT ON EDTLM.TRANSFORMER FOR EACH ROW
