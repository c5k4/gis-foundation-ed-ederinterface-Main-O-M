Prompt drop Trigger SP_PEAK_HIST_INS;
DROP TRIGGER EDTLM.SP_PEAK_HIST_INS
/

Prompt Trigger SP_PEAK_HIST_INS;
--
-- SP_PEAK_HIST_INS  (Trigger) 
--
CREATE OR REPLACE TRIGGER EDTLM.SP_PEAK_HIST_INS BEFORE
  INSERT ON EDTLM.SP_PEAK_HIST FOR EACH ROW
