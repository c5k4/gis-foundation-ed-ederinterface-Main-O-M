Prompt drop Package TLM_CD_MGMT_MONTHLY_ONE_TIME;
DROP PACKAGE EDTLM.TLM_CD_MGMT_MONTHLY_ONE_TIME
/

Prompt Package TLM_CD_MGMT_MONTHLY_ONE_TIME;
--
-- TLM_CD_MGMT_MONTHLY_ONE_TIME  (Package) 
--
CREATE OR REPLACE PACKAGE EDTLM."TLM_CD_MGMT_MONTHLY_ONE_TIME"
AS
