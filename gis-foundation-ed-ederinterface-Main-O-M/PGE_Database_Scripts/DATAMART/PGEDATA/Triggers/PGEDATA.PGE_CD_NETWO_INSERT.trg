Prompt drop Trigger PGE_CD_NETWO_INSERT;
DROP TRIGGER PGEDATA.PGE_CD_NETWO_INSERT
/

Prompt Trigger PGE_CD_NETWO_INSERT;
--
-- PGE_CD_NETWO_INSERT  (Trigger) 
--
CREATE OR REPLACE TRIGGER PGEDATA.PGE_CD_NETWO_INSERT AFTER INSERT on PGEDATA.PGEDATA_SM_NETWORK_PROT_EAD FOR EACH ROW
DECLARE
