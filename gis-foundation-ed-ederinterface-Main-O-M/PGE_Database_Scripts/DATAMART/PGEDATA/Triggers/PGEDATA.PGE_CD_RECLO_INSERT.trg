Prompt drop Trigger PGE_CD_RECLO_INSERT;
DROP TRIGGER PGEDATA.PGE_CD_RECLO_INSERT
/

Prompt Trigger PGE_CD_RECLO_INSERT;
--
-- PGE_CD_RECLO_INSERT  (Trigger) 
--
CREATE OR REPLACE TRIGGER PGEDATA.PGE_CD_RECLO_INSERT AFTER INSERT on PGEDATA.PGEDATA_SM_RECLOSER_EAD FOR EACH ROW
DECLARE
