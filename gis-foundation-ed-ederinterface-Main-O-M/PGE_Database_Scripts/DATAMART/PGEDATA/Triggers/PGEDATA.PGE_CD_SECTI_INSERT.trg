Prompt drop Trigger PGE_CD_SECTI_INSERT;
DROP TRIGGER PGEDATA.PGE_CD_SECTI_INSERT
/

Prompt Trigger PGE_CD_SECTI_INSERT;
--
-- PGE_CD_SECTI_INSERT  (Trigger) 
--
CREATE OR REPLACE TRIGGER PGEDATA.PGE_CD_SECTI_INSERT AFTER INSERT on PGEDATA.PGEDATA_SM_SECTIONALIZER_EAD FOR EACH ROW
DECLARE
