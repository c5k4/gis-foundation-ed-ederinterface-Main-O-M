Prompt drop Trigger PGE_CD_CAPAC_INSERT;
DROP TRIGGER PGEDATA.PGE_CD_CAPAC_INSERT
/

Prompt Trigger PGE_CD_CAPAC_INSERT;
--
-- PGE_CD_CAPAC_INSERT  (Trigger) 
--
CREATE OR REPLACE TRIGGER PGEDATA.PGE_CD_CAPAC_INSERT AFTER INSERT on PGEDATA.PGEDATA_SM_CAPACITOR_EAD FOR EACH ROW
DECLARE
