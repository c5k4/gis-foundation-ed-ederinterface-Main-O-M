Prompt drop Trigger PGE_CD_SCADA_INSERT;
DROP TRIGGER PGEDATA.PGE_CD_SCADA_INSERT
/

Prompt Trigger PGE_CD_SCADA_INSERT;
--
-- PGE_CD_SCADA_INSERT  (Trigger) 
--
CREATE OR REPLACE TRIGGER PGEDATA.PGE_CD_SCADA_INSERT AFTER INSERT on PGEDATA.PGEDATA_SM_SCADA_EAD FOR EACH ROW
DECLARE
