Prompt drop Trigger PGE_CD_REGUL_INSERT;
DROP TRIGGER PGEDATA.PGE_CD_REGUL_INSERT
/

Prompt Trigger PGE_CD_REGUL_INSERT;
--
-- PGE_CD_REGUL_INSERT  (Trigger) 
--
CREATE OR REPLACE TRIGGER PGEDATA.PGE_CD_REGUL_INSERT AFTER INSERT on PGEDATA.PGEDATA_SM_REGULATOR_EAD FOR EACH ROW
DECLARE
