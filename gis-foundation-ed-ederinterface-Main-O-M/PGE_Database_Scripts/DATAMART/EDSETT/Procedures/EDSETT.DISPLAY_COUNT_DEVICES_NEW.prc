Prompt drop Procedure DISPLAY_COUNT_DEVICES_NEW;
DROP PROCEDURE EDSETT.DISPLAY_COUNT_DEVICES_NEW
/

Prompt Procedure DISPLAY_COUNT_DEVICES_NEW;
--
-- DISPLAY_COUNT_DEVICES_NEW  (Procedure) 
--
