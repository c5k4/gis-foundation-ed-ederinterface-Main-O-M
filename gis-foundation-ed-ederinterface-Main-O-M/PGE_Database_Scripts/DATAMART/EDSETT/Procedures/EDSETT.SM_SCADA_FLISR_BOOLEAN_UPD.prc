Prompt drop Procedure SM_SCADA_FLISR_BOOLEAN_UPD;
DROP PROCEDURE EDSETT.SM_SCADA_FLISR_BOOLEAN_UPD
/

Prompt Procedure SM_SCADA_FLISR_BOOLEAN_UPD;
--
-- SM_SCADA_FLISR_BOOLEAN_UPD  (Procedure) 
--
CREATE OR REPLACE PROCEDURE EDSETT.SM_SCADA_FLISR_BOOLEAN_UPD
