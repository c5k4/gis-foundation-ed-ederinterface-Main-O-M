Prompt drop Procedure SP_SUBSTATION_MIG;
DROP PROCEDURE EDSETT.SP_SUBSTATION_MIG
/

Prompt Procedure SP_SUBSTATION_MIG;
--
-- SP_SUBSTATION_MIG  (Procedure) 
--
CREATE OR REPLACE PROCEDURE EDSETT.SP_SUBSTATION_MIG
AS
NUM  NUMBER;
