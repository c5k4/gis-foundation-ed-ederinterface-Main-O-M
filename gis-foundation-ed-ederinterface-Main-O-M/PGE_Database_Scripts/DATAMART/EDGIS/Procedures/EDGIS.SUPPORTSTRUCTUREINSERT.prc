Prompt drop Procedure SUPPORTSTRUCTUREINSERT;
DROP PROCEDURE EDGIS.SUPPORTSTRUCTUREINSERT
/

Prompt Procedure SUPPORTSTRUCTUREINSERT;
--
-- SUPPORTSTRUCTUREINSERT  (Procedure) 
--
CREATE OR REPLACE PROCEDURE EDGIS.SupportStructureInsert(clob_sapattributes IN CLOB)
as
