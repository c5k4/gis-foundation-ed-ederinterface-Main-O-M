Prompt drop Procedure SP_EDTLM_UPDATE_PEAKS;
DROP PROCEDURE EDGIS.SP_EDTLM_UPDATE_PEAKS
/

Prompt Procedure SP_EDTLM_UPDATE_PEAKS;
--
-- SP_EDTLM_UPDATE_PEAKS  (Procedure) 
--
CREATE OR REPLACE PROCEDURE EDGIS.SP_EDTLM_UPDATE_PEAKS AS
...
Prompt Grants on PROCEDURE SP_EDTLM_UPDATE_PEAKS TO GIS_I to GIS_I;
GRANT EXECUTE ON EDGIS.SP_EDTLM_UPDATE_PEAKS TO GIS_I
/
