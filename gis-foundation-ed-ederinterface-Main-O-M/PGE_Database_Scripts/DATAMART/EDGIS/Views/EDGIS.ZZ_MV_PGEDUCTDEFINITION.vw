...
/* Formatted on 7/2/2019 01:19:34 PM (QP5 v5.313) */
...
Prompt Grants on VIEW ZZ_MV_PGEDUCTDEFINITION TO BO_USER to BO_USER;
GRANT SELECT ON EDGIS.ZZ_MV_PGEDUCTDEFINITION TO BO_USER
/
