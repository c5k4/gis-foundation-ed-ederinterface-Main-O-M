Prompt drop View PGE_COUNT_FUSE;
DROP VIEW EDGIS.PGE_COUNT_FUSE
/

/* Formatted on 7/2/2019 01:18:06 PM (QP5 v5.313) */
PROMPT View PGE_COUNT_FUSE;
--
-- PGE_COUNT_FUSE  (View)
--

CREATE OR REPLACE FORCE VIEW EDGIS.PGE_COUNT_FUSE
(
    FEEDERID,
    GLOBALID,
    COUNT
...
Prompt Grants on VIEW PGE_COUNT_FUSE TO BO_USER to BO_USER;
GRANT SELECT ON EDGIS.PGE_COUNT_FUSE TO BO_USER
/
