Prompt drop View PGE_COUNT_DPD;
DROP VIEW EDGIS.PGE_COUNT_DPD
/

/* Formatted on 7/2/2019 01:18:05 PM (QP5 v5.313) */
PROMPT View PGE_COUNT_DPD;
--
-- PGE_COUNT_DPD  (View)
--

CREATE OR REPLACE FORCE VIEW EDGIS.PGE_COUNT_DPD
(
    FEEDERID,
    GLOBALID,
    COUNT
...
Prompt Grants on VIEW PGE_COUNT_DPD TO BO_USER to BO_USER;
GRANT SELECT ON EDGIS.PGE_COUNT_DPD TO BO_USER
/
