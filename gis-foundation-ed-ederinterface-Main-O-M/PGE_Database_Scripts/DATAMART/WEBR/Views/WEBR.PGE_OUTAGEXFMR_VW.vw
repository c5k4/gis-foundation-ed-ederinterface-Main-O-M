Prompt drop View PGE_OUTAGEXFMR_VW;
DROP VIEW WEBR.PGE_OUTAGEXFMR_VW
/

/* Formatted on 7/2/2019 01:18:02 PM (QP5 v5.313) */
PROMPT View PGE_OUTAGEXFMR_VW;
--
-- PGE_OUTAGEXFMR_VW  (View)
--

CREATE OR REPLACE FORCE VIEW WEBR.PGE_OUTAGEXFMR_VW
(
    OBJECTID,
    OUTAGE_NO,
    XFMR_GUID,
...
AS
    SELECT PGE_OUTAGETRANSFORMER.OBJECTID            OBJECTID,
           ...
           PGE_OUTAGENOTIFICATION.ETOR_TXT           ETOR_TXT,
           PGE_OUTAGENOTIFICATION.OUTAGE_START_TIME  OUTAGE_START_TIME,
           PGE_OUTAGENOTIFICATION.OUTAGE_START_TIME  OUTAGE_START_TIME_TXT,
     ...
     WHERE PGE_OUTAGETRANSFORMER.OUTAGE_NO = PGE_OUTAGENOTIFICATION.OUTAGE_NO
/


Prompt Grants on VIEW PGE_OUTAGEXFMR_VW TO GIS_I to GIS_I;
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK, MERGE VIEW ON WEBR.PGE_OUTAGEXFMR_VW TO GIS_I
/

Prompt Grants on VIEW PGE_OUTAGEXFMR_VW TO SDE to SDE;
GRANT SELECT ON WEBR.PGE_OUTAGEXFMR_VW TO SDE
/
