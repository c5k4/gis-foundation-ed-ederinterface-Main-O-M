Prompt drop Package ST_SPREF_UTIL;
DROP PACKAGE SDE.ST_SPREF_UTIL
/

Prompt Package ST_SPREF_UTIL;
--
-- ST_SPREF_UTIL  (Package) 
--
CREATE OR REPLACE PACKAGE SDE.st_spref_util AS
/******************************************************************************
   NAME:       st_spref_util
   PURPOSE:
