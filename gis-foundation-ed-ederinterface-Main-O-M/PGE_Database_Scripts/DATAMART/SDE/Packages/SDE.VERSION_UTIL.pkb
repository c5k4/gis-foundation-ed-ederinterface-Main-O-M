Prompt drop Package Body VERSION_UTIL;
DROP PACKAGE BODY SDE.VERSION_UTIL
/

Prompt Package Body VERSION_UTIL;
--
-- VERSION_UTIL  (Package Body) 
--
CREATE OR REPLACE PACKAGE BODY SDE.version_util
/***********************************************************************
*
 ...
 ***********************************************************************/
   ...
   G_current_state_id := C_base_state_id;
   G_no_state_sequence := dbms_utility.is_cluster_database;
...
Prompt Grants on PACKAGE VERSION_UTIL TO PUBLIC to PUBLIC;
GRANT EXECUTE ON SDE.VERSION_UTIL TO PUBLIC WITH GRANT OPTION
/
