Prompt drop Package DBMS_SHARED_POOL;
DROP PACKAGE SDE.DBMS_SHARED_POOL
/

Prompt Package DBMS_SHARED_POOL;
--
-- DBMS_SHARED_POOL  (Package) 
--
CREATE OR REPLACE PACKAGE SDE.dbms_shared_pool is
  ------------
  --  OVERVIEW
  --
...
Prompt Grants on PACKAGE DBMS_SHARED_POOL TO EXECUTE_CATALOG_ROLE to EXECUTE_CATALOG_ROLE;
GRANT EXECUTE ON SDE.DBMS_SHARED_POOL TO EXECUTE_CATALOG_ROLE
/
