Prompt drop Package ST_GEOMETRY_SHAPELIB_PKG;
DROP PACKAGE SDE.ST_GEOMETRY_SHAPELIB_PKG
/

Prompt Package ST_GEOMETRY_SHAPELIB_PKG;
--
-- ST_GEOMETRY_SHAPELIB_PKG  (Package) 
--
CREATE OR REPLACE PACKAGE SDE.st_geometry_shapelib_pkg AS
/******************************************************************************
   name:       iso_Shapelib
   purpose:
...
******************************************************************************/
  ...
  c_package_release       Constant pls_integer := 1112;
