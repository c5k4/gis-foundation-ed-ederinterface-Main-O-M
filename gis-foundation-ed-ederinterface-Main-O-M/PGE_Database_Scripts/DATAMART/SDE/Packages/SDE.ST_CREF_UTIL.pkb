Prompt drop Package Body ST_CREF_UTIL;
DROP PACKAGE BODY SDE.ST_CREF_UTIL
/

Prompt Package Body ST_CREF_UTIL;
--
-- ST_CREF_UTIL  (Package Body) 
--
CREATE OR REPLACE PACKAGE BODY SDE.st_cref_util AS
