Prompt drop Package Body SVR_CONFIG_UTIL;
DROP PACKAGE BODY SDE.SVR_CONFIG_UTIL
/

Prompt Package Body SVR_CONFIG_UTIL;
--
-- SVR_CONFIG_UTIL  (Package Body) 
--
CREATE OR REPLACE PACKAGE BODY SDE.svr_config_util
/***********************************************************************
*
