Prompt drop Package Body ST_TYPE_USER;
DROP PACKAGE BODY SDE.ST_TYPE_USER
/

Prompt Package Body ST_TYPE_USER;
--
-- ST_TYPE_USER  (Package Body) 
--
CREATE OR REPLACE PACKAGE BODY SDE.st_type_user 
/***********************************************************************
*
