Prompt drop Package LOGFILE_UTIL;
DROP PACKAGE SDE.LOGFILE_UTIL
/

Prompt Package LOGFILE_UTIL;
--
-- LOGFILE_UTIL  (Package) 
--
CREATE OR REPLACE PACKAGE SDE.logfile_util
/***********************************************************************
*
