Prompt drop Package Body SDE_UTIL;
DROP PACKAGE BODY SDE.SDE_UTIL
/

Prompt Package Body SDE_UTIL;
--
-- SDE_UTIL  (Package Body) 
--
CREATE OR REPLACE PACKAGE BODY SDE.sde_util
/***********************************************************************
*
