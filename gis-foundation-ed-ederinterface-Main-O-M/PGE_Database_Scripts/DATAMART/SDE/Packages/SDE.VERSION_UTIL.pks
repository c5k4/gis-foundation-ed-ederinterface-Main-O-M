Prompt drop Package VERSION_UTIL;
DROP PACKAGE SDE.VERSION_UTIL
/

Prompt Package VERSION_UTIL;
--
-- VERSION_UTIL  (Package) 
--
CREATE OR REPLACE PACKAGE SDE.version_util
/***********************************************************************
*
...
IS
  ...
  /* Constants. */
   ...
   C_package_release       CONSTANT PLS_INTEGER := 1077;
