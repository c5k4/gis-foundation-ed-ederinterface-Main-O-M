Prompt drop Procedure COMMON_ANCESTOR_EXE;
DROP PROCEDURE SDE.COMMON_ANCESTOR_EXE
/

Prompt Procedure COMMON_ANCESTOR_EXE;
--
-- COMMON_ANCESTOR_EXE  (Procedure) 
--
CREATE OR REPLACE PROCEDURE SDE.common_ancestor_exe AS
