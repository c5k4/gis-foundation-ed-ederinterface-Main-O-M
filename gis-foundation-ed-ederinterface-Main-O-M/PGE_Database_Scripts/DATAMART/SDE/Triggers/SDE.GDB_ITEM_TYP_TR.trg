Prompt drop Trigger GDB_ITEM_TYP_TR;
DROP TRIGGER SDE.GDB_ITEM_TYP_TR
/

Prompt Trigger GDB_ITEM_TYP_TR;
--
-- GDB_ITEM_TYP_TR  (Trigger) 
--
CREATE OR REPLACE TRIGGER SDE.GDB_ITEM_TYP_TR AFTER INSERT OR UPDATE OR DELETE ON SDE.GDB_ITEMTYPES
