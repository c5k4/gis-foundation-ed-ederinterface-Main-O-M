...
new_field_alias = "FeatureClassID"

# Type of the new field, just uncomment the correct one and comment out the others
new_field_type = "LONG" # Names or other textual qualities. 
...
new_field_is_nullable = "NON_NULLABLE" #  The field will allow null values. This is the default. 
