...
updateFC_name_list = ["CapacitorBank","DeviceGroup","DynamicProtectiveDevice","DistBusBar","ElectricStitchPoint","FaultIndicator","Fuse","OpenPoint","PrimaryGeneration","PrimaryRiser","PriOHConductor","PriUGConductor","Switch","Tie","Transformer","VoltageRegulator","ElectricDistNetwork_Junctions","StepDown","SecOHConductor","SecUGConductor","TransformerLead"]
#Name of the new field
new_field_name = "VERSIONNAME"
