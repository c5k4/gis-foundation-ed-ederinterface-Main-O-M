...
rem ===========================================================================
rem ED_DELETE_VERSION_EDGMC_DC1B.bat
rem ---------------------------------------------------------------------------
rem This SQL Script
...
rem Usage:  ED_DELETE_VERSION_EDGMC_DC1B.bat
rem         
...
for /f %%a in ('D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\PGE.PasswordMgmt\PGE_DBPasswordManagement.exe GETPASSWORD SDE@EDGMC') do set "sqlPWD=%%a"
...
set prepsqlCommand=EDGMCpreparedeleteVesrions.sql
set delsqlCommand=EDGMCdeleteVersions.sql
