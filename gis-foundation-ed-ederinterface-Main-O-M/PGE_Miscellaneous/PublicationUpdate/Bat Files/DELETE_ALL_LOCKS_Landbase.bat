...
rem ===========================================================================
rem DELETE_ALL_LOCKS_Landbase.bat
rem ---------------------------------------------------------------------------
rem This SQL Script
...
rem Usage:  DELETE_ALL_LOCKS_Landbase.bat
rem         
...
set file_path="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\PGE.PublicationUpdate\RemoveLocks"

set cmdinifile=ini.cmd
set inifile=LANDBASEUnlockconfig.ini
...
for /f %%a in ('D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\PGE.PasswordMgmt\PGE_DBPasswordManagement.exe GETPASSWORD UC4ADMIN@LANDBASE') do set "sqlPWD=%%a"
