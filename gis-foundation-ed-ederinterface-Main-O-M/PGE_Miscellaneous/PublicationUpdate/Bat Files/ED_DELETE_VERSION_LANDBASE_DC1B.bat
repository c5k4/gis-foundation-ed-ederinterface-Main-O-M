...
rem ===========================================================================
rem ED_DELETE_VERSION_LANDBASE_DC1B.bat
rem ---------------------------------------------------------------------------
rem This SQL Script
rem SQLPlus Connection with database
rem on a PG&E LANDBASE GIS database.
rem 
...
rem Usage:  ED_DELETE_VERSION_LANDBASE_DC1B.bat
rem         
...
set inifile=LANDBASEconfig.ini
...
for /f %%a in ('D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\PGE.PasswordMgmt\PGE_DBPasswordManagement.exe GETPASSWORD SDE@LANDBASE') do set "sqlPWD=%%a"
...
set prepsqlCommand=LANDBASEpreparedeleteVesrions.sql
set delsqlCommand=LANDBASEdeleteVersions.sql
