...
rem ===========================================================================
rem ED_DELETE_VERSION_SUB_PUB_DC1B.bat
rem ---------------------------------------------------------------------------
rem This SQL Script
rem SQLPlus Connection with database
rem on a PG&E EDSUBPUB GIS database.
rem 
...
rem Usage:  ED_DELETE_VERSION_SUB_PUB_DC1B.bat
rem         
...
set file_path="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\PGE.PublicationUpdate\Unversion\Delete_Version"
set cmdinifile=ini.cmd
set inifile=EDSUBPUBconfig.ini

rem set cmdinifile=%file_path%\%cmdinifile_name%
rem set inifile=%file_path%\%inifile_name%
...
for /f %%a in ('D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\PGE.PasswordMgmt\PGE_DBPasswordManagement.exe GETPASSWORD SDE@EDSUBPUB') do set "sqlPWD=%%a"
...
set prepsqlCommand=EDSUBPUBpreparedeleteVesrions.sql
set delsqlCommand=EDSUBPUBdeleteVersions.sql
