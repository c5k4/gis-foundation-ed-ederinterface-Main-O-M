...
echo %time% > LBGIS_Vendor_Landbase.tmp
rem Remove Fail File from Last Run
if exist LBGIS_Vendor_Landbase.fail del LBGIS_Vendor_Landbase.fail
rem ===========================================================================
rem ED_CreateReplica_LBGIS_Vendor_Landbase.bat
rem ---------------------------------------------------------------------------
...
rem Usage:  ED_CreateReplica_LBGIS_Vendor_Landbase.bat
rem         
...
set config_name=LBGIS_Vendor_Landbase.ini
...
if "%error_level_orig%" neq "0" (
  echo %time% > LBGIS_Vendor_Landbase.fail
