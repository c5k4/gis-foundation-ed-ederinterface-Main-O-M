...
echo %time% > LBGIS_Special_Project.tmp
rem Remove Fail File from Last Run
if exist LBGIS_Special_Project.fail del LBGIS_Special_Project.fail
rem ===========================================================================
rem ED_CreateReplica_LBGIS_Special_Project.bat
rem ---------------------------------------------------------------------------
...
rem Usage:  ED_CreateReplica_LBGIS_Special_Project.bat
rem         
...
set config_name=LBGIS_Special_Project.ini
...
if "%error_level_orig%" neq "0" (
  echo %time% > LBGIS_Special_Project.fail
