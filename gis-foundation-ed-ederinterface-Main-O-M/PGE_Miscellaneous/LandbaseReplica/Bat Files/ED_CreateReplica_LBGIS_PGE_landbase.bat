...
echo %time% > LBGIS_PGE_landbase.tmp
rem Remove Fail File from Last Run
if exist LBGIS_PGE_landbase.fail del LBGIS_PGE_landbase.fail
rem ===========================================================================
rem ED_CreateReplica_LBGIS_PGE_landbase.bat
rem ---------------------------------------------------------------------------
...
rem Usage:  ED_CreateReplica_LBGIS_PGE_landbase.bat
rem         
...
set config_name=LBGIS_PGE_landbase.ini
...
if "%error_level_orig%" neq "0" (
  echo %time% > LBGIS_PGE_landbase.fail
