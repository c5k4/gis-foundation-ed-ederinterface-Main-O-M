...
set filename_script_01=ED_CreateReplica_LBGIS_CA_Landbase.bat
set filename_script_02=ED_CreateReplica_LBGIS_PGE_Common_Landbase.bat
set filename_script_03=ED_CreateReplica_LBGIS_PGE_landbase.bat
set filename_script_04=ED_CreateReplica_LBGIS_Special_Project.bat
set filename_script_05=ED_CreateReplica_LBGIS_Vendor_Landbase.bat
set filename_script_06=ED_CreateReplica_LBGIS_VMSAlerts.bat
...
cd /d %file_path%
ECHO Starting %filename_script_01%...
ECHO Starting %filename_script_01%...   >> %file_log_tmp% 2>&1
START CMD /C CALL "%filename_script_01%"
cd /d %file_path%
ECHO Starting %filename_script_02%...
ECHO Starting %filename_script_02%...   >> %file_log_tmp% 2>&1
START CMD /C CALL "%filename_script_02%"
cd /d %file_path%
ECHO Starting %filename_script_03%...
ECHO Starting %filename_script_03%...   >> %file_log_tmp% 2>&1
START CMD /C CALL "%filename_script_03%"
cd /d %file_path%
ECHO Starting %filename_script_04%...
ECHO Starting %filename_script_04%...   >> %file_log_tmp% 2>&1
START CMD /C CALL "%filename_script_04%"
cd /d %file_path%
ECHO Starting %filename_script_05%...
ECHO Starting %filename_script_05%...   >> %file_log_tmp% 2>&1
START CMD /C CALL "%filename_script_05%"
cd /d %file_path%
ECHO Starting %filename_script_06%...
ECHO Starting %filename_script_06%...   >> %file_log_tmp% 2>&1
START CMD /C CALL "%filename_script_06%"
...
rem Change Error Level if any process fails
if exist *.fail set /A error_level=%error_level% + 1

set /A error_level=%error_level% + %ERRORLEVEL%
echo Executed  Replication for Landbase   >> %file_log_tmp% 2>&1
rem ===========================================================================
