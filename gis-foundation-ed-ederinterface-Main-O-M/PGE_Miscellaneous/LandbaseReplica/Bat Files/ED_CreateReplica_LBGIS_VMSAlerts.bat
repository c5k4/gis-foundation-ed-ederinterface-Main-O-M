...
echo %time% > LBGIS_VMSAlerts.tmp
rem Remove Fail File from Last Run
if exist LBGIS_VMSAlerts.fail del LBGIS_VMSAlerts.fail
rem ===========================================================================
rem ED_CreateReplica_LBGIS_VMSAlerts.bat
rem ---------------------------------------------------------------------------
...
rem Usage:  ED_CreateReplica_LBGIS_VMSAlerts.bat
rem         
...
set config_name=LBGIS_VMSAlerts.ini
...
if "%error_level_orig%" neq "0" (
  echo %time% > LBGIS_VMSAlerts.fail
