echo off
rem create Temp File That Process is running
echo %time% > LBGIS_PGE_Common_Landbase.tmp
rem Remove Fail File from Last Run
if exist LBGIS_PGE_Common_Landbase.fail del LBGIS_PGE_Common_Landbase.fail
rem ===========================================================================
rem ED_CreateReplica_LBGIS_PGE_Common_Landbase.bat
rem ---------------------------------------------------------------------------
...
rem Usage:  ED_CreateReplica_LBGIS_PGE_Common_Landbase.bat
rem         
...
set config_name=LBGIS_PGE_Common_Landbase.ini
set filename_script_00=DeleteDataset.py
set filename_script_01=CreateReplica.py
...
set file_script_00=%file_path%\%filename_script_00%
...
rem ===========================================================================
rem Run the program that does the Delete Job.
rem ---------------------------------------------------------------------------
cd /d %file_path%
set command=call %pythonexe% %file_script_00% %config_name%
...
if "%error_level_orig%" neq "0" (
  echo %time% > LBGIS_PGE_Common_Landbase.fail
...
del LBGIS_PGE_Common_Landbase.tmp
exit /b %error_level%
rem ===========================================================================
pause