...
echo %time% > LBGIS_TRA.tmp
rem Remove Fail File from Last Run
if exist LBGIS_TRA.fail del LBGIS_TRA.fail
rem ===========================================================================
rem ED_CreateReplica_LBGIS_TRA.bat
rem ---------------------------------------------------------------------------
...
rem Usage:  ED_CreateReplica_LBGIS_TRA.bat
rem         
