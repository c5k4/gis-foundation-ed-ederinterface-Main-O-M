...
<!-- Strings to append -->
<xsl:variable name="prefix" select="'arcfm8.ARCFM8.'"/>
<xsl:variable name="prefixsys" select="'sde.sde.'"/>
<xsl:variable name="prefixobject" select="'arcfm8.ARCFM8.'"/>
<xsl:variable name="prefixrelclass" select="'arcfm8.ARCFM8.'"/>
...
<xsl:template match="MODELNAMES/FIELDNAMES/NAME | FEATURECLASS/SUBTYPE/FIELD/FIELDNAME">
