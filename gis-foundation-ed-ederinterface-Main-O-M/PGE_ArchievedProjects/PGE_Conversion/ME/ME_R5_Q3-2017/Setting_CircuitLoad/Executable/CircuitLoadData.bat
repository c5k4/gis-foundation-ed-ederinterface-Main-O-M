echo off
rem ===========================================================================
rem Script Name: CircuitLoadData.bat
...
rem D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\Loaddata
rem exit 0
...
rem Set script variables.
rem ---------------------------------------------------------------------------
set cmdPath="D:\Program Files (x86)\Miner and Miner\PG&E Custom Components\Loaddata
set cmdLine=ChangeDetection_NP.exe
