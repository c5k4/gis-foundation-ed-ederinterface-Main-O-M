...
namespace PageTemplates
{
    ...
    public partial class Distribution_MapName_11x17P : UserControl, IPageTemplate, IPageTemplateView, IPageTemplateExport
    {
        private const string _maptype = "Distribution";

        public Distribution_MapName_11x17P()
        {
        ...
        {
            get { return "Distribution MapName 11x17 Portrait"; }
        }
