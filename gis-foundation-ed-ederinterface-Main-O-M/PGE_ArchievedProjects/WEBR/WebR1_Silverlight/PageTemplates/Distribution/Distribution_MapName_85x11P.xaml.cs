...
namespace PageTemplates
{
    ...
    public partial class Distribution_MapName_85x11P : UserControl, IPageTemplate, IPageTemplateView, IPageTemplateExport
    {
        private const string _maptype = "Distribution";

        public Distribution_MapName_85x11P()
        {
        ...
        {
            get { return "Distribution MapName 8.5x11 Portrait"; }
        }
