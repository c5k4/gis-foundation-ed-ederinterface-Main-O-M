...
namespace PageTemplates
{
    ...
    public partial class Distribution_MapName_11x17L : UserControl, IPageTemplate, IPageTemplateView, IPageTemplateExport
    {
        private const string _maptype = "Distribution";

        public Distribution_MapName_11x17L()
        {
        ...
        {
            get { return "Distribution MapName 11x17 Landscape"; }
        }
