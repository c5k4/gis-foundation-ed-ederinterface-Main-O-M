...
namespace PageTemplates
{
    ...
    public partial class Distribution_MapName_18x24P : UserControl, IPageTemplate, IPageTemplateView, IPageTemplateExport
    {
        private const string _maptype = "Distribution";

        public Distribution_MapName_18x24P()
        {
        ...
        {
            get { return "Distribution MapName 18x24 Portrait"; }
        }
