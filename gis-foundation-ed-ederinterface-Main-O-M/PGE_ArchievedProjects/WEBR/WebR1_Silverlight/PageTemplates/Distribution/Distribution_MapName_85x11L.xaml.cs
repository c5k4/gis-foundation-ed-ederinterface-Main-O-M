...
namespace PageTemplates
{
    ...
    public partial class Distribution_MapName_85x11L : UserControl, IPageTemplate, IPageTemplateView, IPageTemplateExport
    {
        private const string _maptype = "Distribution";

        public Distribution_MapName_85x11L()
        {
            Presenter = new TemplatePresenter
            {
                MapTitle = "Distribution Map Elements"
            };
        ...
        {
            get { return "Distribution MapName 8.5x11 Landscape"; }
        }
