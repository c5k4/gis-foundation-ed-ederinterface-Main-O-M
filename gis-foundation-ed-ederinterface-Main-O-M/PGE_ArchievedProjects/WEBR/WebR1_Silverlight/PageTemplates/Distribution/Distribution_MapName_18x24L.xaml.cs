...
namespace PageTemplates
{
    ...
    public partial class Distribution_MapName_18x24L : UserControl, IPageTemplate, IPageTemplateView, IPageTemplateExport
    {
        private const string _maptype = "Distribution";

        public Distribution_MapName_18x24L()
        {
        ...
        {
            get { return "Distribution MapName 18x24 Landscape"; }
        }
