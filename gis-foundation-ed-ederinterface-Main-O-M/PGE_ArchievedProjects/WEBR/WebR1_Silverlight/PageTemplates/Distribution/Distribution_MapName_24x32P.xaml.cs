...
namespace PageTemplates
{
    ...
    public partial class Distribution_MapName_24x32P : UserControl, IPageTemplate, IPageTemplateView, IPageTemplateExport
    {
        private const string _maptype = "Distribution";

        public Distribution_MapName_24x32P()
        {
        ...
        {
            get { return "Distribution MapName 24x32 Portrait"; }
        }
