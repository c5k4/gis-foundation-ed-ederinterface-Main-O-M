...
namespace PageTemplates
{
    ...
    public partial class AdHoc_18x24_P : UserControl, IPageTemplate, IPageTemplateView, IPageTemplateExport
    {
        private const string _maptype = "Ad Hoc";

        public AdHoc_18x24_P()
        {
        ...
        {
            get { return "Ad Hoc 18x24 Portrait"; }
        }
