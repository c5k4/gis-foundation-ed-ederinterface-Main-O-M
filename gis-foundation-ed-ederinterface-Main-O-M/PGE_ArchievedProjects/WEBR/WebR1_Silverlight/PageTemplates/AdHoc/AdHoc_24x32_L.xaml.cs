...
namespace PageTemplates
{
    ...
    public partial class AdHoc_24x32_L : UserControl, IPageTemplate, IPageTemplateView, IPageTemplateExport
    {
        private const string _maptype = "Ad Hoc";

        public AdHoc_24x32_L()
        {
        ...
        {
            get { return "Ad Hoc 24x32 Landscape"; }
        }
