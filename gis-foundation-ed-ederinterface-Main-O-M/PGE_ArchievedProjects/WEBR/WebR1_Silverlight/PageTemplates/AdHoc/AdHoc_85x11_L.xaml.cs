...
namespace PageTemplates
{
    ...
    public partial class AdHoc_85x11_L : UserControl, IPageTemplate, IPageTemplateView, IPageTemplateExport
    {
        private const string _maptype = "Ad Hoc";

        public AdHoc_85x11_L()
        {
        ...
        {
            get { return "Ad Hoc 8.5x11 Landscape"; }
        }
