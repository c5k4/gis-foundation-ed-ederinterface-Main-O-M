...
namespace PageTemplates
{
    ...
    public partial class AdHoc_11x17_L : UserControl, IPageTemplate, IPageTemplateView, IPageTemplateExport
    {
        private const string _maptype = "Ad Hoc";
        
        public AdHoc_11x17_L()
        {
        ...
        {
            get { return "Ad Hoc 11x17 Landscape"; }
        }
