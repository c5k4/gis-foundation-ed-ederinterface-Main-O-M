...
namespace PageTemplates
{
    ...
    public partial class AdHoc_11x17_P : UserControl, IPageTemplate, IPageTemplateView, IPageTemplateExport
    {
        private const string _maptype = "Ad Hoc";

        public AdHoc_11x17_P()
        {
        ...
        {
            get { return "Ad Hoc 11x17 Portrait"; }
        }
