...
[Export(typeof(IPageTemplate))]
    public partial class AdHoc_24x32_P : UserControl, IPageTemplate, IPageTemplateView, IPageTemplateExport
    {
        private const string _maptype = "Ad Hoc";

        public AdHoc_24x32_P()
        {
        ...
        {
            get { return "Ad Hoc 24x32 Portrait"; }
        }
