...
namespace PageTemplates
{
    ...
    public partial class AdHoc_18x24_L : UserControl, IPageTemplate, IPageTemplateView, IPageTemplateExport
    {
        private const string _maptype = "Ad Hoc";
        
        public AdHoc_18x24_L()
        {
        ...
        {
            get { return "Ad Hoc 18x24 Landscape"; }
        }
