...
namespace PageTemplates
{
    ...
    public partial class Circuit_MapName_85x11P : UserControl, IPageTemplate, IPageTemplateView, IPageTemplateExport
    {
        private const string _maptype = "Circuit";

        public Circuit_MapName_85x11P()
        {
        ...
        {
            get { return "Circuit MapName 8.5x11 Portrait"; }
        }
