...
namespace PageTemplates
{
    ...
    public partial class Circuit_MapName_18x24L : UserControl, IPageTemplate, IPageTemplateView, IPageTemplateExport
    {
        private const string _maptype = "Circuit";

        public Circuit_MapName_18x24L()
        {
        ...
        {
            get { return "Circuit MapName 18x24 Landscape"; }
        }
