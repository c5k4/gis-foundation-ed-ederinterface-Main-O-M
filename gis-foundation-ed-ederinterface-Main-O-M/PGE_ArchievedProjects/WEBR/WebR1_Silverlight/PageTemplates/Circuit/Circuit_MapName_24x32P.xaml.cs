...
namespace PageTemplates
{
    ...
    public partial class Circuit_MapName_24x32P : UserControl, IPageTemplate, IPageTemplateView, IPageTemplateExport
    {
        private const string _maptype = "Circuit";

        public Circuit_MapName_24x32P()
        {
        ...
        {
            get { return "Circuit MapName 24x32 Portrait"; }
        }
