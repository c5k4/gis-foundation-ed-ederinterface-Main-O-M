...
namespace PageTemplates
{
    ...
    public partial class Circuit_MapName_18x24P : UserControl, IPageTemplate, IPageTemplateView, IPageTemplateExport
    {
        private const string _maptype = "Circuit";

        public Circuit_MapName_18x24P()
        {
        ...
        {
            get { return "Circuit MapName 18x24 Portrait"; }
        }
