...
namespace PageTemplates
{
    ...
    public partial class Circuit_MapName_11x17L : UserControl, IPageTemplate, IPageTemplateView, IPageTemplateExport
    {
        private const string _maptype = "Circuit";

        public Circuit_MapName_11x17L()
        {
        ...
        {
            get { return "Circuit MapName 11x17 Landscape"; }
        }
