...
namespace PageTemplates
{
    ...
    public partial class Circuit_MapName_24x32L : UserControl, IPageTemplate, IPageTemplateView, IPageTemplateExport
    {
        private const string _maptype = "Circuit";

        public Circuit_MapName_24x32L()
        {
        ...
        {
            get { return "Circuit MapName 24x32 Landscape"; }
        }
