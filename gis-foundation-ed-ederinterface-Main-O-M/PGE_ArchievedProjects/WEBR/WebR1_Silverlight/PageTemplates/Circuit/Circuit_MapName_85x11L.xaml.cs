...
namespace PageTemplates
{
    ...
    public partial class Circuit_MapName_85x11L : UserControl, IPageTemplate, IPageTemplateView, IPageTemplateExport
    {
        private const string _maptype = "Circuit";
        
        public Circuit_MapName_85x11L()
        {
            Presenter = new TemplatePresenter
            {
                MapTitle = "Circuit Map Elements"
            };
        ...
        {
            get { return "Circuit MapName 8.5x11 Landscape"; }
        }
