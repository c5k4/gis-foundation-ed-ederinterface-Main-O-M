...
namespace PageTemplates
{
    ...
    public partial class DuctBlock_MapName_85x11L : UserControl, IPageTemplate, IPageTemplateView, IPageTemplateExport
    {
        private const string _maptype = "Duct/Block";
                
        public DuctBlock_MapName_85x11L()
        {
            Presenter = new TemplatePresenter
            {
                MapTitle = "Duct / Block Map Elements"
            };
        ...
        {
            get { return "Duct/Block MapName 8.5x11 Landscape"; }
        }
