...
namespace PageTemplates
{
    ...
    public partial class DuctBlock_MapName_24x32L : UserControl, IPageTemplate, IPageTemplateView, IPageTemplateExport
    {
        private const string _maptype = "Duct/Block";

        public DuctBlock_MapName_24x32L()
        {
        ...
        {
            get { return "Duct/Block MapName 24x32 Landscape"; }
        }
