...
namespace PageTemplates
{
    ...
    public partial class DuctBlock_MapName_85x11P : UserControl, IPageTemplate, IPageTemplateView, IPageTemplateExport
    {
        private const string _maptype = "Duct/Block";

        public DuctBlock_MapName_85x11P()
        {
        ...
        {
            get { return "Duct/Block MapName 8.5x11 Portrait"; }
        }
