...
namespace PageTemplates
{
    ...
    public partial class DuctBlock_MapName_18x24P : UserControl, IPageTemplate, IPageTemplateView, IPageTemplateExport
    {
        private const string _maptype = "Duct/Block";

        public DuctBlock_MapName_18x24P()
        {
        ...
        {
            get { return "Duct/Block MapName 18x24 Portrait"; }
        }
