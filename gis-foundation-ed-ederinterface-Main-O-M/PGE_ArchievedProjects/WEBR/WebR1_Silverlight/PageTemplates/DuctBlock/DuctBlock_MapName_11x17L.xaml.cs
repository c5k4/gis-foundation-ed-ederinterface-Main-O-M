...
namespace PageTemplates
{
    ...
    public partial class DuctBlock_MapName_11x17L : UserControl, IPageTemplate, IPageTemplateView, IPageTemplateExport
    {
        private const string _maptype = "Duct/Block";

        public DuctBlock_MapName_11x17L()
        {
        ...
        {
            get { return "Duct/Block MapName 11x17 Landscape"; }
        }
