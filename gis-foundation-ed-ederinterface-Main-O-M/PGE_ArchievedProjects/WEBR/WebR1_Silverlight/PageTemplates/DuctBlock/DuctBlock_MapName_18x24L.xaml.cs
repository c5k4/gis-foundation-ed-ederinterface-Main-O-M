...
namespace PageTemplates
{
    ...
    public partial class DuctBlock_MapName_18x24L : UserControl, IPageTemplate, IPageTemplateView, IPageTemplateExport
    {
        private const string _maptype = "Duct/Block";
        
        public DuctBlock_MapName_18x24L()
        {
        ...
        {
            get { return "Duct/Block MapName 18x24 Landscape"; }
        }
