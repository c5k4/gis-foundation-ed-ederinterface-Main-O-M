...
namespace PageTemplates
{
    ...
    public partial class Schematic_MapName_85x11P : UserControl, IPageTemplate, IPageTemplateView, IPageTemplateExport
    {
        private const string _maptype = "Schematic";

        public Schematic_MapName_85x11P()
        {
        ...
        {
            get { return "Schematic MapName 8.5x11 Portrait"; }
        }
