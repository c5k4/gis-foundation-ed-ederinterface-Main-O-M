...
namespace PageTemplates
{
    ...
    public partial class Schematic_MapName_11x17L : UserControl, IPageTemplate, IPageTemplateView, IPageTemplateExport
    {
        private const string _maptype = "Schematic";

        public Schematic_MapName_11x17L()
        {
        ...
        {
            get { return "Schematic MapName 11x17 Landscape"; }
        }
