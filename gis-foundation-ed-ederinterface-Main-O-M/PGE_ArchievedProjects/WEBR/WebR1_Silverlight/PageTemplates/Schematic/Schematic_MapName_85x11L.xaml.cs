...
namespace PageTemplates
{
    ...
    public partial class Schematic_MapName_85x11L : UserControl, IPageTemplate, IPageTemplateView, IPageTemplateExport
    {
        private const string _maptype = "Schematic";

        public Schematic_MapName_85x11L()
        {
            Presenter = new TemplatePresenter
            {
                MapTitle = "Schematic Map Elements"
            };
        ...
        {
            get { return "Schematic MapName 8.5x11 Landscape"; }
        }
