...
namespace PageTemplates
{
    ...
    public partial class Schematic_MapName_24x32P : UserControl, IPageTemplate, IPageTemplateView, IPageTemplateExport
    {
        private const string _maptype = "Schematic";

        public Schematic_MapName_24x32P()
        {
        ...
        {
            get { return "Schematic MapName 24x32 Portrait"; }
        }
