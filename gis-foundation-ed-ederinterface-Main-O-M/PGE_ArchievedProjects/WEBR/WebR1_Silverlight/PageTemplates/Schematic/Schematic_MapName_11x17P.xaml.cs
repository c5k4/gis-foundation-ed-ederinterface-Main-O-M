...
namespace PageTemplates
{
    ...
    public partial class Schematic_MapName_11x17P : UserControl, IPageTemplate, IPageTemplateView, IPageTemplateExport
    {
        private const string _maptype = "Schematic";

        public Schematic_MapName_11x17P()
        {
        ...
        {
            get { return "Schematic MapName 11x17 Portrait"; }
        }
