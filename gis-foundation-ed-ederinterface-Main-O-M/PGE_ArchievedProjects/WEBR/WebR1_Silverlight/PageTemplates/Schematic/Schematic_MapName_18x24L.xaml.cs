...
namespace PageTemplates
{
    ...
    public partial class Schematic_MapName_18x24L : UserControl, IPageTemplate, IPageTemplateView, IPageTemplateExport
    {
        private const string _maptype = "Schematic";

        public Schematic_MapName_18x24L()
        {
        ...
        {
            get { return "Schematic MapName 18x24 Landscape"; }
        }
