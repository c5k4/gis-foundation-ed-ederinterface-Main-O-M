...
namespace PageTemplates
{
    ...
    public partial class Schematic_MapName_24x32L : UserControl, IPageTemplate, IPageTemplateView, IPageTemplateExport
    {
        private const string _maptype = "Schematic";

        public Schematic_MapName_24x32L()
        {
        ...
        {
            get { return "Schematic MapName 24x32 Landscape"; }
        }
