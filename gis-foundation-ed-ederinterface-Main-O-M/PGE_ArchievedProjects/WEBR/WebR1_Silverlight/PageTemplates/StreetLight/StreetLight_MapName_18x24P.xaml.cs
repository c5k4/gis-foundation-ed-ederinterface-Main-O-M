...
namespace PageTemplates
{
    ...
    public partial class StreetLight_MapName_18x24P : UserControl, IPageTemplate, IPageTemplateView, IPageTemplateExport
    {
        private const string _maptype = "Street Light";

        public StreetLight_MapName_18x24P()
        {
        ...
        {
            get { return "Street Light MapName 18x24 Portrait"; }
        }
