...
namespace PageTemplates
{
    ...
    public partial class StreetLight_MapName_85x11P : UserControl, IPageTemplate, IPageTemplateView, IPageTemplateExport
    {
        private const string _maptype = "Street Light";

        public StreetLight_MapName_85x11P()
        {
        ...
        {
            get { return "Street Light MapName 8.5x11 Portrait"; }
        }
