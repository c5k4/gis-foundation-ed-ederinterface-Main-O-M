...
namespace PageTemplates
{
    ...
    public partial class StreetLight_MapName_24x32P : UserControl, IPageTemplate, IPageTemplateView, IPageTemplateExport
    {
        private const string _maptype = "Street Light";

        public StreetLight_MapName_24x32P()
        {
        ...
        {
            get { return "Street Light MapName 24x32 Portrait"; }
        }
