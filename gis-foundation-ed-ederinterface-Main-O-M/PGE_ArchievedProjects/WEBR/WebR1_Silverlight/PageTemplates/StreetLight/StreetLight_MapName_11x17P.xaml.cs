...
namespace PageTemplates
{
    ...
    public partial class StreetLight_MapName_11x17P : UserControl, IPageTemplate, IPageTemplateView, IPageTemplateExport
    {
        private const string _maptype = "Street Light";

        public StreetLight_MapName_11x17P()
        {
        ...
        {
            get { return "Street Light MapName 11x17 Portrait"; }
        }
