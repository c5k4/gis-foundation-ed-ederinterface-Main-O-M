...
#endif
{
    internal class CustomLineSymbol : LineSymbol, ILayerName
    {
        private readonly string _name;

        public CustomLineSymbol(SolidColorBrush fillColor, SolidColorBrush selectionColor, string name, string imagePath)
        {
                ...
                @"<ControlTemplate xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation""
                                ...
                                <Grid>
                                    <Grid.Resources>
                                        ...
                                        <miner:CenterOfPathConverter x:Key=""PathCenterConverter"" />
                                        <miner:BooleanToVisibilityConverter x:Key=""BooleanToVisibilityConverter"" />
                                    </Grid.Resources>
                                    <Path x:Name=""Element"" Stroke=""Red"" StrokeStartLineCap=""Round""
                                          StrokeThickness=""4"" 
                                    ...
                                    <Canvas IsHitTestVisible=""{Binding Source={StaticResource MarkerManager}, Path=IsSelected, Mode=OneWay}"" >
                                        <Grid Opacity=""{Binding Source={StaticResource MarkerManager}, Path=Opacity}"" Margin=""{Binding PathGeometry, RelativeSource={RelativeSource TemplatedParent}, Converter={StaticResource PathCenterConverter}}"">
                                            <!-- Cheap Shadow -->
                                            ...
                                            <Viewbox VerticalAlignment=""Center"" HorizontalAlignment=""Center"" Width=""17"" Height=""18"" Margin=""0"">
                                                <TextBlock x:Name=""Number"" Text=""{Binding Attributes[RowIndex]}"" HorizontalAlignment=""Center"" 
                                                    VerticalAlignment=""Center"" TextAlignment=""Center"" Margin=""0"" Foreground=""White""/>
                                            </Viewbox>
                                            <Image Width=""16"" 
                                                   Height=""16""
