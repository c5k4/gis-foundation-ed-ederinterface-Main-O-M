...
namespace PGE.Interface.Powerbase_To_GIS
{
    public class ReadConfigurations
    {
        ...
        public const string ConnString_EDWorkSpace = "EDER_SDEConnection";
        public const string ConnectionString_pbuser = "EDER_ConnectionStr_pbuser";
        public const string ConnectionString_pgedata = "EDER_ConnectionStr_pgedata";
        ...
        public static string GetValue(string argStrKey)
        {
            ...
            try
            {
                ...
                // m4jf edgisrearch 919 - Commented below lines - Now Connection string will be configured using Password management tool - no need to decrypt password .
                
                //if (argStrKey == ReadConfigurations.ConnectionString_pgedata)
                //{
                //    string encryptedPassword = setting.Split(',')[2];
                //    string decryptedPassword = Encrypt.PasswordEncryption.GetDecryptConnectionStringPassword(encryptedPassword);
