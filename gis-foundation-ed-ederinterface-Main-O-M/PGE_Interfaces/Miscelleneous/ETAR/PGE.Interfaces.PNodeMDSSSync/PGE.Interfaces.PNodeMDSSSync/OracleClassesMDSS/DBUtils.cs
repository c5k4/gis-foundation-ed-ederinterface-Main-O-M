...
namespace PGE.Interface.PNodeMDSSSync.OracleClasses
{
    class DBUtils
    {
        ...
        /// </summary>
        public static OracleConnection GetDBConnection(bool gisCon, bool mDSSCon)
        {
            //string host = null;
            //int port = 0;
            //string sid = null;
            ...
            {
                //host = ConfigSettings.MDSSOraclehost;
                //port = ConfigSettings.GISPort;
                //sid = ConfigSettings.MDSSSid;

                //Changes done for Removing MDSS conenction and objects : Start                
                //serviceName = ConfigSettings.MDSSService;
                //user = ConfigSettings.MDSSUserName;
                //password = ConfigSettings.MDSSPass;
        ...
        //        // Call procedure.
        //        noOfRowsEffected = (int)cmd.ExecuteNonQuery();
        //        _logger.Info("-rows effected " + noOfRowsEffected.ToString());
        //        cmd.Dispose();
        //    }
        //    catch (Exception Ex)
