...
spool ChangeDetectionPkg_1.0.1.10.lst
    ...
    BEGIN
      ...
      INTO SM_CAPACITOR_HIST
        (
          ...
          VOLT_VAR_TEAM_MEMBER,RTU_EXIST, RTU_MODEL_NUM, RTU_SERIAL_NUM, RTU_FIRMWARE_VERSION, RTU_SOFTWARE_VERSION, RTU_MANF_CD,ENGINEERING_COMMENTS,FLISR_ENGINEERING_COMMENTS
        )
    ...
    BEGIN
      ...
      INTO SM_NETWORK_PROTECTOR_HIST
        (
          ...
          TRANSMIT_ENABLE_DELAY,
          TRIP_MODE,
          WATT_VAR_TRIP_CHAR,RTU_EXIST, RTU_MODEL_NUM, RTU_SERIAL_NUM, RTU_FIRMWARE_VERSION, RTU_SOFTWARE_VERSION, RTU_MANF_CD,ENGINEERING_COMMENTS,FLISR_ENGINEERING_COMMENTS,FLISR
        )
    ...
    BEGIN
      ...
      INTO SM_RECLOSER_HIST
        (
          ...
          ALT2_PHA_VMUL_FAST,
          ALT2_PHA_FAST_CRV,
          ALT2_GRD_FAST_CRV,RTU_EXIST, RTU_MODEL_NUM, RTU_SERIAL_NUM, RTU_FIRMWARE_VERSION, RTU_SOFTWARE_VERSION, RTU_MANF_CD,MULTI_FUNCTIONAL
        )
      SELECT EFFECTIVE_DT,
        TIMESTAMP,
        DATE_MODIFIED,
