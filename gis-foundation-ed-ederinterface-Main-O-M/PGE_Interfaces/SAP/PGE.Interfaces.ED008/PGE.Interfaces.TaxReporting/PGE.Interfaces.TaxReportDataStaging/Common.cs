...
namespace PGE.Interfaces.TaxReportDataStaging
{
    public class Common
    {
        private static readonly PGE.Common.Delivery.Diagnostics.Log4NetLogger _logger = new PGE.Common.Delivery.Diagnostics.Log4NetLogger(MethodBase.GetCurrentMethod().DeclaringType, "ED08.log4net.config");
        ...
        public static IWorkspace SetWorkspace()   
        {
            ...
            catch (Exception ex)
            {
                ...
                Console.WriteLine("Error: Invalid SDE database connection.  Workspace could not set. Please check the config entry. " + ex.Message);
                throw;
            }
