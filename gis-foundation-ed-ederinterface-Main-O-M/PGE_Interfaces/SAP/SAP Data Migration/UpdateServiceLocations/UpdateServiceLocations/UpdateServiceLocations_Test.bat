...
rem echo off
rem Script Name: UpdateServiceLocations_Test.bat

rem ---------------------------------------------------------------------------
rem Set script variables.
rem ---------------------------------------------------------------------------
set cmdPath="D:\PrimaryGenReplacementProcess\Release"
set cmdLine="D:\PrimaryGenReplacementProcess\Release\UpdateServiceLocations.exe" TEST
