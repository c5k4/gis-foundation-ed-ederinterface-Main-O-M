...
{
    /// <summary>
    /// Contains methods for handling XML.
    /// </summary>
    public class XmlFacade
    {
        ...
        public static bool ValidateXML(string xmlString, Stream schemaStream)
        {
            ...
            {
                //_logger.Error("Error validating XML.", XmlSchExp);
                return false;
            }
            catch (Exception GenExp)
            {
        ...
        public static bool Transform(string xmlFilePath, string xslFilePath, string outputFilePath, XsltArgumentList xsltArgsList)
        {
            ...
            if (File.Exists(xmlFilePath) && File.Exists(xslFilePath))
            {
                ...
                {
                    // XslTransform Load exception, most likely invalid XSL syntax.
                    //_logger.Error(" XslTransform Load exception, most likely invalid XSL syntax.", xce);
                    return false;
                }
                catch (Exception ex)
                {
                    // Unknown exception, but most likely invalid html path.
                    //_logger.Error("Unknown exception, but most likely invalid html path.", ex);
                    return false;
                }
                finally
                {
        ...
        /// <summary>
        /// Turn XML into an object class
        /// </summary>
        /// <typeparam name="T">The type of object class</typeparam>
        /// <param name="xmlToDeSerialize">The XML representation of the object class</param>
        ...
        /// <summary>
        /// Convert an object class into XML
        /// </summary>
        /// <typeparam name="T">The type of object class</typeparam>
        /// <param name="objectToSerialize">The object to change to XML</param>
