...
{
    /// <summary>
    /// Class that reads the configuration file from a configurable location
    /// </summary>
    public class Config
    {
        /// <summary>
        ...
        /// </summary>
        /*private static string _configFileName = "Telvent.PGE.SAP.PMOrder.exe.config";*/

        private static string _configFileName = "PGE.Interfaces.SAP.PMOrder.exe.config";
        ...
        public static Configuration ReadConfig()
        {
            if (_configObject == null)
            {
                ...
                string installDir = registry.Directory;
    ...
    /// <summary>
    /// Configuration Section holds the XML Node and Field Mapping
    /// </summary>
