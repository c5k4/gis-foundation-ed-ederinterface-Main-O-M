...
namespace PGE.Interfaces.ED11_12.SessionManager
{
    /// <summary>
    ...
    public class MinerSession
    {
        ...
        private static int PostPriority = 10;
        ...
        public void SubmitSessionToGDBM()
        {
            ...
            // m4jf - edgirearch - commented below line to set seession state to data processing state initially
            // const int POST_QUEUE_STATE = 5;
            int sessionState = int.Parse(Common.Session_state);
            ...
            try
            {
                ...
                // m4jf -edgisrearch - commented below line  - now session will be sent to data processing state first
                ...
                Console.WriteLine("Subtak executed : " + executedSuccessfully);
                _logger.Debug("Setting Node State to POST_QUEUE");
                // SetNodeState(_pxApplication, node, POST_QUEUE_STATE);
                SetNodeState(_pxApplication, node, sessionState);
        ...
        private void InsertSessionIntoPostingQueue(IMMSession session)
        {
            ...
            newRow.set_Value(newRow.Fields.FindField("PRIORITY"), PostPriority);
