...
namespace PGE.BatchApplication.ED
{
    public class FieldInstance
    {
        ...
        public static FieldInstance FromFieldName(IRow row, string fieldName)
        {
            ...
            catch
            {
                ...
                new Log4NetLogger(callingMethod.DeclaringType, "PGE.BatchApplication.PSPSMapProduction1.0.log4net.config").Warn(string.Format("Error finding field named {0}", fieldName));
                return null;
            }
        }
        ...
        public static FieldInstance FromModelName(IObject obj, string fieldModelName)
        {
            ...
            {
                MethodBase callingMethod = new StackFrame(1).GetMethod();
                new Log4NetLogger(callingMethod.DeclaringType, "PGE.BatchApplication.PSPSMapProduction1.0.log4net.config").Warn(string.Format("Error finding field with model {0}", fieldModelName));
                return null;
            }
        }
