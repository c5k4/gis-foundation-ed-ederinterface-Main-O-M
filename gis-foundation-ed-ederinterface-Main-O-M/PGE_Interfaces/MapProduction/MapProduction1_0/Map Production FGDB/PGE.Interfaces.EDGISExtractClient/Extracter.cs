...
using PGE.Interfaces.GeodatabaseUtils;
    ...
    class Extracter
    {
        ...
        public void PackageOutputGDB(string mapGeo, ExtractType pExtractType)
        {
            try
            {
                ...
                PGE.Interfaces.GeodatabaseUtils.ExtractUtils pExtractUtils =
                    new PGE.Interfaces.GeodatabaseUtils.ExtractUtils(_logfileInfo);
        ...
        /// </summary>
        public void RebuildSpatialIndexesForFCs(PGE.Interfaces.GeodatabaseUtils.ExtractUtils pExtractUtils)
        {
            try
            {
                //Load up the workspaces
        ...
        //            pQF.WhereClause = "EXPORTSTATEoutlook IN(" + _clipExportStateList + ")";
            ...
            int maxTries)
        {
            ...
            try
            {
                ...
                PGE.Interfaces.GeodatabaseUtils.ExtractUtils pExtractUtils = new PGE.Interfaces.GeodatabaseUtils.ExtractUtils(
                    _logfileInfo,
                    _toSpatialRef,
                    _transformation);
