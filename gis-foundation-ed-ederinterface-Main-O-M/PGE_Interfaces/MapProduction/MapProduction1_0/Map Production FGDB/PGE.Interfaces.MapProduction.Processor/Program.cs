...
using PGE.Interfaces.MapProduction.PreProcessing;
using PGE.Common.Delivery.Diagnostics;
using PGE.Common.Delivery.Framework;

namespace PGE.Interfaces.MapProduction.Processor
{
    /// <summary>
    ...
    public class Program
    {
        ...
        /// </summary>
        private static Log4NetLogger _logger = new Log4NetLogger(MethodBase.GetCurrentMethod().DeclaringType,"\\pge.interfaces.mapproduction.log4net.config","MapProduction");
            ...
            try
            {
                ...
                if (MapProductionConfigurationHandler.GetSettingValue("RunExport").ToUpper() != "FALSE")
                {
                    ...
                    for (int i = 1; i <= totalNumberOfProcesses; i++)
                    {
                        ...
                        ProcessStartInfo processInfo = new ProcessStartInfo(@"PGE.Interfaces.MapProduction.Exporter.exe", i.ToString());
