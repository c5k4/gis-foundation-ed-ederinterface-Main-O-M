...
using System.Linq;
using System.Text;
using Telvent.PGE.MapProduction;
...
namespace Telvent.PGE.MapProduction
{
    ...
    public abstract class BaseMapLookUpTable : IMPMapLookUpTable
    {
        ...
        /// </summary>
        /// <param name="parameterPrefix">The Parameter Prefix as defined by the Database. Use <see cref="Telvent.Delivery.System.Data.IDatabaseConnection"/>.GetParameterPrefix method to get the right parameter prefix</param>
        /// <param name="databaseConnection"><see cref="Telvent.Delivery.System.Data.IDatabaseConnection"/></param>
