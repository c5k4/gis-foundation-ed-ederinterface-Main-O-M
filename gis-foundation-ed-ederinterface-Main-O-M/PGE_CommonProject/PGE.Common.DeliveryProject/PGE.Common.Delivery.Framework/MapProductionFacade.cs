...
namespace PGE.Common.Delivery.Framework
{
    ...
    /// </summary>
    public class MapProductionFacade
    {
        ...
        /// <summary>
        /// Caption of the <c>PGE Layout Graphic </c> Page layout polygon graphic element.
        /// </summary>
        public static string PGELayoutPolygonGraphicCaption
        {
            get { return "PGE Hash Buffer Graphic"; }
        }
        /// <summary>
        /// Caption of the <c>PGE Hash Buffer</c> AutoTextElement
        /// </summary>
        public static string PGEHashBufferATECaption
        {
            get { return "PGE Hash Buffer"; }
        }
        ...
        /// 
        /// </summary>
        public static string PGECountyCaption
        {
            get { return "PGE County"; }
        }
        /// <summary>
        /// 
        /// </summary>
        public static string PGEDivisionCaption
        {
            get { return "PGE Division"; }
        }
        /// <summary>
        /// 
        /// </summary>
        public static string PGEZipCaption
        {
            get { return "PGE Zip"; }
        }
        ...
        public static void StoreElementPropeties(IElement element)
        {
            if (element == null)
            {
                MapProductionFacade.OriginalHashPolygonGeometry = null;
                MapProductionFacade.OriginalHashSymbol = null;
                return;
            }

            //Stores the properties only if they are not stored already
            if (MapProductionFacade.OriginalHashPolygonGeometry != null || MapProductionFacade.OriginalHashSymbol != null) return;

            //Store Geometry
            if (element.Geometry == null) MapProductionFacade.OriginalHashPolygonGeometry = null;
            else
            {
                //MapProductionFacade.OriginalHashPolygonGeometry = objCopy.Copy(element.Geometry) as IGeometry;
                MapProductionFacade.OriginalHashPolygonGeometry = (element.Geometry as IClone).Clone() as IGeometry;
            }
            ...
            {
                MapProductionFacade.OriginalHashSymbol = (polygonElement.Symbol as IClone).Clone() as ISymbol;
            }
            else MapProductionFacade.OriginalHashSymbol = null;
        }
        ...
        public static void RestoreElementPropeties(IGraphicsContainer container, IElement element, bool reset)
        {
            ...
            if (MapProductionFacade.OriginalHashPolygonGeometry != null)
            {
                element.Geometry = (MapProductionFacade.OriginalHashPolygonGeometry as IClone).Clone() as IGeometry;
            }
            IFillSymbol symbol = MapProductionFacade.OriginalHashSymbol as IFillSymbol;
            if (symbol != null)
            {
            ...
            if (reset)
            {
                if (MapProductionFacade.OriginalHashPolygonGeometry != null)
                {
                    while (Marshal.ReleaseComObject(MapProductionFacade.OriginalHashPolygonGeometry) > 0) { }
                    MapProductionFacade.OriginalHashPolygonGeometry = null;
                }

                if (MapProductionFacade.OriginalHashSymbol != null)
                {
                    while (Marshal.ReleaseComObject(MapProductionFacade.OriginalHashSymbol) > 0) { }
                    MapProductionFacade.OriginalHashSymbol = null;
                }
            }
        }
