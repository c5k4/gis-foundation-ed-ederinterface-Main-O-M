...
namespace PGE.Common.Delivery.Framework
{
    ...
    public class LicenseManager : IDisposable
    {
        ...
        public LicenseManager(esriLicenseProductCode esri, mmLicensedProductCode arcfm)
        {
        ...
        public bool Initialize(mmLicensedProductCode prodCode)
        {
            ...
            if (mmlicenseStatus == mmLicenseStatus.mmLicenseCheckedOut||mmlicenseStatus==mmLicenseStatus.mmLicenseAlreadyInitialized)
            {
                return true;
            }
        ...
        public static esriLicenseProductCode ToESRI(string esri)
        {
            ...
            return (esriLicenseProductCode)Enum.Parse(typeof(esriLicenseProductCode), "esriLicenseProductCodeArcInfo");
        }
        #endregion
