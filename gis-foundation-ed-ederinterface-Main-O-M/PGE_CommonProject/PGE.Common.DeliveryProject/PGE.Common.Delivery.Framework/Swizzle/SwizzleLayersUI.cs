...
namespace PGE.Common.Delivery.Framework
{
    ...
    public partial class SwizzleLayersUI : Form
    {
        ...
        public SwizzleLayersUI(IApplication app):this()
        {
            _app = app;
        }
        ...
        private void swizzleLayersDataSource(IPropertySet originConnectionProperties, IPropertySet destinationConnectionProperties, IFileNames fNames)
        {
            ...
            while (fname != null)
            {
                ...
                Swizzle.FindAndReplaceSourceConnection(fname, destinationConnectionProperties,originConnectionProperties,_app);
                fname = fNames.Next();
            }
        }
