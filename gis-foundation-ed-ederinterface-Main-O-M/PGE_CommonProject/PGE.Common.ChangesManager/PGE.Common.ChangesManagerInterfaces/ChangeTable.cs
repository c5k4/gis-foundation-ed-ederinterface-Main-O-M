...
namespace PGE.Common.ChangesManagerShared
{
    ...
    //TODO: Remove? Not sure it's being used or of any use
    /// <summary>
    ...
    public class ChangeTable : KeyedCollection<int, ChangeRow>
    {
        ...
        public ChangeTable(string tableName, bool isFC)
        {
            IsFC = isFC;
            TableName = tableName;
        ...
        /// </summary>
        /// <param name="table">The table.</param>
        public ChangeTable(ITable table, string x)
        {
        ...
        public override string ToString()
        {
            ...
            retval = String.IsNullOrEmpty(TableName) ? "Empty TableName!" : TableName;
