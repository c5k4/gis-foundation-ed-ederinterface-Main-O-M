...
namespace PGE.Common.ChangesManagerShared
{
    ...
    {
        private string PrimaryWorkspaceExtractGDB
        {
            get;
            set;
        }
        private string SecondaryWorkspaceExtractGDB
        {
            get;
            set;
        }

        public IDictionary<string, ChangedFeatures> changedFeatures;
        ...
        public ChangeDictionary(string primaryWorkspaceFGDB, params esriDataChangeType[] differenceTypes)
            : this(differenceTypes)
        {
            changedFeatures = new Dictionary<string, ChangedFeatures>();
            this.PrimaryWorkspaceExtractGDB = primaryWorkspaceFGDB;
            this.UsePrimaryWorkspace = true;
        }
        ...
        /// <param name="secondaryWorkspace">The secondary workspace.</param>
        /// <param name="differenceTypes">The difference types.</param>
        public ChangeDictionary(string primaryWorkspaceFGDB, string secondaryWorkspaceFGDB, params esriDataChangeType[] differenceTypes)
            : this(primaryWorkspaceFGDB, differenceTypes)
        {
            changedFeatures = new Dictionary<string, ChangedFeatures>();
            this.SecondaryWorkspaceExtractGDB = secondaryWorkspaceFGDB;
        }
        ...
        protected IWorkspace _primaryWorkspace = null;
        protected IWorkspace _secondaryWorkspace = null;

        /// <summary>
        /// Gets or sets the primary workspace.
        /// </summary>
        /// <value>The primary workspace.</value>
        public IWorkspace PrimaryWorkspace
        {
            get
            {
                if (_primaryWorkspace == null && !String.IsNullOrEmpty(PrimaryWorkspaceExtractGDB))
                {
                    _primaryWorkspace = AOHelper.ExtractGdbWorkspaceFromPath(PrimaryWorkspaceExtractGDB);
                }
                return _primaryWorkspace;
            }
            set
            {
                _primaryWorkspace = value;
            }
        }
        ...
        public IWorkspace SecondaryWorkspace
        {
            get
            {
                if (_secondaryWorkspace == null && !String.IsNullOrEmpty(SecondaryWorkspaceExtractGDB))
                {
                    _secondaryWorkspace = AOHelper.ExtractGdbWorkspaceFromPath(SecondaryWorkspaceExtractGDB);
                }
                return _secondaryWorkspace;
            }
            set
            {
                _secondaryWorkspace = value;
            }
        }
        ...
        public override string ToString()
        {
            ...
            retval = Enum.GetName(typeof (esriDifferenceType), this.DifferenceTypes.First());
            retval += this.PrimaryWorkspace != null ?  " " + PrimaryWorkspace.PathName : "";
            retval += this.SecondaryWorkspace != null ? " " + SecondaryWorkspace.PathName : "";
        ...
        {
            if (_primaryWorkspace != null) System.Runtime.InteropServices.Marshal.FinalReleaseComObject(_primaryWorkspace);
            if (_secondaryWorkspace != null) System.Runtime.InteropServices.Marshal.FinalReleaseComObject(_secondaryWorkspace);
