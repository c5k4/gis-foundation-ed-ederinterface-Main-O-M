...
namespace PGE.Desktop.EDER.Tests.Common
{
    /// <summary>
    ...
    {
        internal static CustomTextWriterTraceListener FileLogger = new CustomTextWriterTraceListener("Output.log", "schematicsLog");
        ...
        {
            FileLogger = new CustomTextWriterTraceListener((!string.IsNullOrEmpty(outputFilePrefix) ? outputFilePrefix + "." : "") + "Output.log", "schematicsLog");
