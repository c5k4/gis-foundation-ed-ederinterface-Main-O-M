...
using Telvent.PGE.ED.Desktop.GDBM.CircuitProcessing;
using Comm = IBM.PGE.ED.Desktop.Tests.Common.Common;
using Miner.Interop;
...
namespace IBM.PGE.ED.Desktop.Tests
{
    ...
    {
        private const string SdeConn = @"C:\Users\a1nc\AppData\Roaming\ESRI\Desktop10.2\ArcCatalog\EDGISA1D_EDGIS.sde";
