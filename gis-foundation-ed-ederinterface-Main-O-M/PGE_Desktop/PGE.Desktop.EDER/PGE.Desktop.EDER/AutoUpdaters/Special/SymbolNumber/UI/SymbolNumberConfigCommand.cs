...
namespace PGE.Desktop.EDER.SymbolNumber.UI
{
    ...
    /// </summary>
    [Guid("ABFD4780-04E3-475F-B0CC-BD71AEF121DD")]
    [ProgId("PGE.Desktop.EDER.SymbolNumberConfigCommand")]
    [ComponentCategory(ComCategory.ArcMapCommands)]
    [ComVisible(true)]
    public class SymbolNumberConfigCommand : BaseMxCommand, IDisposable
    {
        ...
        /// </summary>
        public SymbolNumberConfigCommand()
            : base("Symbol Number Config",
                   "Symbol Number Config",
                   "Symbol Number Config",
                   "Edit and Validate Symbol Number Rules.")
        {
        ...
        protected override void InternalClick()
        {
            ...
            if (wrkSpace == null)
            {
                MessageBox.Show(_err_no_login, "Symbol Number Config", MessageBoxButtons.OK, MessageBoxIcon.Information);
            ...
            if (form == null)
            {
                ...
                form = new SymbolNumberConfigForm(wrkSpace, SchemaInfo.General.ClassModelNames.SymbolNumberRules);
