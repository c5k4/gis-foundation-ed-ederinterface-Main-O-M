...
{
    /// <summary>
    /// Class for UI and searching the SAPID Search based on user provided input "SAPEQUIPID" from ArcFM locator tool
    /// </summary>
    [Guid("D84E6CCD-8337-4412-B483-866047ECCB0F")]
    [ProgId("PGE.Desktop.EDER.LocatorTools.SAPIDSearchLocator")]
    [ComponentCategory(ComCategory.MMLocatorSearchStrategyUI)]
    public partial class PGE_SAPIDSearchLocatorUI : UserControl, IMMSearchStrategyUI, IMMResultsProcessor
    {
        public PGE_SAPIDSearchLocatorUI()
        {
            InitializeComponent();
        }
        ...
        public IMMSearchConfiguration GetSearchConfiguration(mmSearchOptionFlags optionFlags)
        {
            ...
            properties.SetProperty("SAPID Search", txtSAPIDSearch.Text);
        ...
        public void Reset()
        {
            txtSAPIDSearch.Text = string.Empty;
        }
        ...
        {
            get { return new SAPIDSearchLocator(); }
        }
