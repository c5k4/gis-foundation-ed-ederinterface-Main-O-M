...
{
    /// <summary>
    /// PGE_AgreementNumberUI Class for UI and searching the MLX Number/Customer Agreement number based on user provided input from locator tool
    /// </summary>
    [Guid("A00DC1E6-0057-4867-BCFF-35E2FC8803E2")]
    [ProgId("PGE.Desktop.EDER.PGE_AgreementNumberUI")]
    [ComponentCategory(ComCategory.MMLocatorSearchStrategyUI)]
    public partial class PGE_AgreementNumberUI : UserControl, IMMSearchStrategyUI, IMMResultsProcessor
    {
        ...
        /// </summary>
        private const string _caption = "Customer Agreement Search";

        /// <summary>
        /// Set the priority of the caption. We can change the priority when we want our caption should be shown up.
        /// </summary>
        private int _priority = 202; // As 100 to 600 reserved for arcFm only.
        ...
        #region IMMSearchStrategyUI member
        ...
        public IMMSearchConfiguration GetSearchConfiguration(mmSearchOptionFlags optionFlags)
        {
            ...
            properties.SetProperty("Agreement Number", txtAgreementNumber.Text);
            properties.SetProperty("ObjectId", txtObjectId.Text);
        ...
        {
            get { return new PGE_AgreementNumber(); }
        }
