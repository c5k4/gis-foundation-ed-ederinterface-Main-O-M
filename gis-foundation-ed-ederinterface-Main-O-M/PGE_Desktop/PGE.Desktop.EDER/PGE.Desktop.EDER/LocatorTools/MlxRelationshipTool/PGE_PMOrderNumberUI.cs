...
{
    /// <summary>
    /// Class for UI and searching the PM Order Number based on user provided input from locator tool
    /// </summary>
    [Guid("4D41120E-B92D-4AFD-B326-18263B82C750")]
    [ProgId("PGE.Desktop.EDER.PGE_PMOrderNumberUI")]
    [ComponentCategory(ComCategory.MMLocatorSearchStrategyUI)]
    public partial class PGE_PMOrderNumberUI : UserControl, IMMSearchStrategyUI, IMMResultsProcessor
    {
        ...
        /// </summary>
        private const string _caption = "PM Order Number";

        /// <summary>
        /// Set the priority of the caption. We can change the priority when we want our caption should be shown up.
        /// </summary>
        private int _priority = 1; // As XY Coordinates has 500 reserved.
        ...
        public IMMSearchConfiguration GetSearchConfiguration(mmSearchOptionFlags optionFlags)
        {
            ...
            properties.SetProperty("PM Order Number", txtPMOrderNumber.Text);
        ...
        {
            get { return new PMOrderNumberLocator(); }
        }
