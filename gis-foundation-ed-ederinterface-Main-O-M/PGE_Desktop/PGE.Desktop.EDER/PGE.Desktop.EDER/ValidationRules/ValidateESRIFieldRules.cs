...
namespace PGE.Desktop.EDER.ValidationRules
{
    ...
    [ComVisible(true)]
    [Guid("04C51DC9-4122-427c-9E58-93A759219C5D")]
    public class ValidateESRIFieldRules : BaseValidationRule
    {
        #region Private fields

        private string _progIdOfRule = "MMStandardRules.MMEsriFieldRules";
        ...
        #region Constructor
        public ValidateESRIFieldRules()
            : base("PGE Validate ESRI Field Rules")
        {
        ...
        protected override ID8List InternalIsValid(IRow pRow)
        {
            try
            {
                ...
                Type pMMRuleClass = Type.GetTypeFromProgID("MMStandardRules.MMEsriFldRules");
                ...
                //***Need to loop through the list and use base.AddError for each 
                //one so that it includes the severity 
                return _ErrorList;
            }
            catch (Exception ex)
            {
