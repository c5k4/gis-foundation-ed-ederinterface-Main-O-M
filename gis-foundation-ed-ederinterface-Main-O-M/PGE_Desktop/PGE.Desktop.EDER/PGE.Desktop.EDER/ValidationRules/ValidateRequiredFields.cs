...
namespace PGE.Desktop.EDER.ValidationRules
{
    ...
    [ComVisible(true)]
    [Guid("04D61DC9-4122-427c-9E58-93A759219C5D")]
    public class ValidateRequiredFields : BaseValidationRule
    {
        #region Private fields

        private string _progIdOfRule = "MMStandardRules.MMRequiredField";
        ...
        public ValidateRequiredFields()
            : base("PGE Validate Required Fields")
        {
