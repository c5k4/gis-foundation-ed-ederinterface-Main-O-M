...
namespace PGE.Desktop.Custom.Utility.Annotation
{
    /// <summary>
    ...
    public static class AnnotationFacade
    {
        ...
        {
            ApplySettingsToNewAnno_CalmTool(AnnoRelClass, ProcessObject, alignment, angle, annoClassID, inlineGroupAnno,
                newXOffset, newYOffset, null, fontSize);
        }
        ...
        /// <summary>
        /// Add new method to fix the incident : Issue INC000004289099 (To resolve Anno Overstrikes)
        /// </summary>
        /// <param name="AnnoRelClass"></param>
        /// <param name="ProcessObject"></param>
        /// <param name="alignment"></param>
        /// <param name="angle"></param>
        /// <param name="annoClassID"></param>
        /// <param name="inlineGroupAnno"></param>
        /// <param name="newXOffset"></param>
        /// <param name="newYOffset"></param>
        /// <param name="newPlacementPoint"></param>
        /// <param name="fontSize"></param>
        private static void ApplySettingsToNewAnno_CalmTool(IRelationshipClass AnnoRelClass, IObject ProcessObject, int alignment,
          double angle, int annoClassID, bool inlineGroupAnno, double newXOffset, double newYOffset, IPoint newPlacementPoint,
          double fontSize)
        {
            //Code=3 in the horizontalalignment domain is used for 'full'. However we do not use that code in this class so change it to no change.
