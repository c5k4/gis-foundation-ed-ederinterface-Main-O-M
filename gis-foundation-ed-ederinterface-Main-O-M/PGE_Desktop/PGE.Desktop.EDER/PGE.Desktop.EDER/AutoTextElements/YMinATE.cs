...
{
    [Guid("518F4B18-F85C-4447-B13F-6FBEC0AD412F")]
    [ProgId("PGE.Desktop.EDER.YMinATE")]
    [ComponentCategory(ComCategory.MMCustomTextSources)]
    public class YMinATE : BaseAutoTextElement
    {
        ...
        /// <summary>
        /// Creates an instance of <see cref="YMinATE"/>
        /// </summary>
        public YMinATE()
            : base("PGE.Desktop.EDER.YMinATE", MapProductionFacade.PGEYMinCaption, MapProductionFacade.PGEYMinCaption, MapProductionFacade.PGEYMinCaption)
        {
        ...
        /// <returns></returns>
        /// <remarks>
        /// Basically, returns the YMin coordinate of the printing,exporting grid.
        /// </remarks>
        protected override string OnStart(mmAutoTextEvents eTextEvent, IMMMapProductionInfo pMapProdInfo)
        {
            ...
            return Math.Round(transformedMapGridEnvelopeGeometry.Envelope.YMin,6).ToString();
        }
