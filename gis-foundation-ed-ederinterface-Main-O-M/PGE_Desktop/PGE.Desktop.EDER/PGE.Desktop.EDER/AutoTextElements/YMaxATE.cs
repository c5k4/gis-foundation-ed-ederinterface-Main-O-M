...
{
    [Guid("79D82CFD-BB38-4753-A009-171C670D6DDB")]
    [ProgId("PGE.Desktop.EDER.YMaxATE")]
    [ComponentCategory(ComCategory.MMCustomTextSources)]
    public class YMaxATE : BaseAutoTextElement
    {
        ...
        /// <summary>
        /// Creates an instance of <see cref="YMaxATE"/>
        /// </summary>
        public YMaxATE()
            : base("PGE.Desktop.EDER.YMaxATE", MapProductionFacade.PGEYMaxCaption, MapProductionFacade.PGEYMaxCaption, MapProductionFacade.PGEYMaxCaption)
        {
        ...
        /// <returns></returns>
        /// <remarks>
        /// Basically, returns the YMax coordinate of the printing,exporting grid.
        /// </remarks>
        protected override string OnStart(mmAutoTextEvents eTextEvent, IMMMapProductionInfo pMapProdInfo)
        {
            ...
            return Math.Round(transformedMapGridEnvelopeGeometry.Envelope.YMax,6).ToString();
        }
