...
namespace PGE.Desktop.EDER.ArcMapCommands
{
    ...
    /// </summary>
    [Guid("193cdbd5-ecc6-438c-81ef-502ee2609e1c")]
    [ComponentCategory(ComCategory.ArcMapCommandBars)]
    [ComVisible(true)]
    [ProgId("PGE.Desktop.EDER.ArcMapCommands.PGE_ViewWebViewerToolbar")]
    public sealed class PGE_ViewWebViewerToolbar : BaseToolbar
    {
        ...
        public PGE_ViewWebViewerToolbar()
        {
            ...
            AddItem("PGE.Desktop.EDER.ArcMapCommands.ViewWebr");
        }
