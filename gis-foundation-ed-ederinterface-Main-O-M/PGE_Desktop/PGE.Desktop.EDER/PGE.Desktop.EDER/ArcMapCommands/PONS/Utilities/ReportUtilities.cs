...
namespace Telvent.PGE.ED.Desktop.ArcMapCommands.PONS
{
    class ReportUtilities
    {
            ...
            try
            {
                ...
                foreach (Customer customer in pReport.AffectedCustomers)
                {
                    ...
                    object[] obj = new object[] {pReport.SubmitterID.Substring(0,(pReport.SubmitterID.Length>4?4:pReport.SubmitterID.Length)),
                                             ...
                                             DBNull.Value,//Convert.ToDateTime(pReport.OutageDetails[0].ON_Time),
                                             DBNull.Value,
        ...
        { 
            try
            {
                ...
                ptable.DefaultCell.FixedHeight = 12f;
                ...
                //foreach (Customer customer in pReport.AffectedCustomers.ToList())
                {
                    ...
                    pCell.Border = 0;
                    pCell.BorderColor = BaseColor.WHITE;
                    pCell.Phrase = new Phrase() { Font = font_Arial8 };
                    ...
                    ptable.AddCell(new Phrase(address.Trim(new char[] { ',', ' ' }), font_Arial8));
                    ...
                    ptable.AddCell(new PdfPCell(new Phrase(customer.CGC12, font_Arial8)) { Border = Rectangle.NO_BORDER, HorizontalAlignment = 2, NoWrap = false, FixedHeight = 12f });
                    ptable.AddCell(new PdfPCell(new Phrase(customer.SSD, font_Arial8)) { Border = Rectangle.NO_BORDER, HorizontalAlignment = 2, NoWrap = true, FixedHeight = 12f });
                    ptable.AddCell(new PdfPCell(new Phrase(GetPhoneNumber(customer, pReport), font_Arial8)) { Border = Rectangle.NO_BORDER, HorizontalAlignment = 2, NoWrap = false, FixedHeight = 12f });
    ...
    class PDFPageEvent : PdfPageEventHelper
    {
        ...
        public override void OnStartPage(PdfWriter writer, Document doc)
        {
            ...
            ptable.AddCell(new PdfPCell(new Phrase("Type", font_Arial8Normal)) { HorizontalAlignment = 0, BorderColor = BaseColor.WHITE });
            ptable.AddCell(new PdfPCell(new Phrase("Customer Name", font_Arial8Normal)) { HorizontalAlignment = 0, BorderColor = BaseColor.WHITE });
            ptable.AddCell(new PdfPCell(new Phrase("Address", font_Arial8Normal)) { HorizontalAlignment = 0, BorderColor = BaseColor.WHITE });
            ptable.AddCell(new PdfPCell(new Phrase("City, State, ZIP", font_Arial8Normal)) { HorizontalAlignment = 0, BorderColor = BaseColor.WHITE });
            ptable.AddCell(new PdfPCell(new Phrase("CGC/TNum", font_Arial8Normal)) { HorizontalAlignment = 2, BorderColor = BaseColor.WHITE });
            ptable.AddCell(new PdfPCell(new Phrase("SSD", font_Arial8Normal)) { HorizontalAlignment = 2, BorderColor = BaseColor.WHITE });
            ptable.AddCell(new PdfPCell(new Phrase("Phone", font_Arial8Normal)) { HorizontalAlignment = 2, BorderColor = BaseColor.WHITE });
