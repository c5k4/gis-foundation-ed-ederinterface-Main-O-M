...
namespace Telvent.PGE.ED.Desktop.ArcMapCommands.PONS.Utilities
{
    class PGE_EDGIS_Tracing
    {
            ...
            out IList<string> PriMeterCGCs)
        {
            ...
            try
            {
                ...
                if (DownstreamTrace(geomNet, objEID, StartDeviceElementType, BarrierIds, BarrierTypes, ExcludeCustomers, versionname,
                    out TransformerCGCs, out PriMeterCGCs))
                    bReturn = true;
            }
            catch (Exception ex)
            {
        ...
        public bool DownstreamTrace(IGeometricNetwork inGeomNetwork, int startElementEID, esriElementType elementType,
            ...
            out IList<string> TransformerCGCs, out IList<string> PriMeterCGCs)
        {
            ...
            if (elementType == esriElementType.esriETNone || elementType == esriElementType.esriETTurn) return bReturn;
            ...
            try
            {
                ...
                while (pEIDInfo != null)
                {
                    ...
                    {
                        TransformerCGCs.Add(Convert.ToString(pFeature.get_Value(pFeature.Fields.FindField(objUtilityFunctions.ReadConfigurationValue("Field_CGC12")))));
                    }
                    else if (pDataSet.Name.Equals(objUtilityFunctions.ReadConfigurationValue("PrimaryMeter")))
                    {
                        PriMeterCGCs.Add(Convert.ToString(pFeature.get_Value(pFeature.Fields.FindField(objUtilityFunctions.ReadConfigurationValue("Field_CGC12")))));
                    }
