...
namespace Telvent.PGE.ED.Desktop.ArcMapCommands.PONS
{
    ...
    {
        private IList<Customer> _CustomersList_Original = new List<Customer>();
        ...
        private bool _ExcludeCustomerifMailAddress = false;
        ...
        public IList<Customer> AffectedCustomers_Original
        {
            get
            {
                return _CustomersList_Original;
            }
            set
            {
                _CustomersList_Original = value;
            }
        }
        ...
        public Boolean ExcludeCustomer_Checked
        {
            get
            {
                return _ExcludeCustomerifMailAddress;
            }
            set
            {
                _ExcludeCustomerifMailAddress = value;
            }
        }
    }
