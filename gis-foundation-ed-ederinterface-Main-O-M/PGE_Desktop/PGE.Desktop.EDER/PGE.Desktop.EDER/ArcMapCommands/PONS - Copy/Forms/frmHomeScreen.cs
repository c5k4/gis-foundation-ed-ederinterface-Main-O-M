    ...
    public partial class PONSHomeScreen : Form
    {
        ...
        private void btnGetCustomer_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                                ...
                                {
                                    {
                                        ...
                                        DataTable dtCustomerList = objUtilityFunctions.ExecuteSP(objUtilityFunctions.ReadConfigurationValue("EDER_ConnectionString"),
                ...
                pReport.AffectedCustomers = CustomerList;
        ...
        private void LoadConsumerstoGrid()
        {
            try
            {
                ...
                for (int iCount = 0; iCount < pReport.AffectedCustomers.Count; ++iCount)
                {
                    Customer customer = pReport.AffectedCustomers[iCount];
                    if (customer.Excluded) continue;
                    string sNameAddressTemp = string.Empty;
                    sNameAddressTemp += customer.CustomerName.MailName1;
                    sNameAddressTemp += (!string.IsNullOrEmpty(sNameAddressTemp.Trim()) ? " " : "") + customer.CustomerName.MailName2;
                    if (!string.IsNullOrEmpty(customer.MailAddress.City))
                    {
                        sNameAddressTemp += (!string.IsNullOrEmpty(sNameAddressTemp.Trim()) ? ", " : "") + customer.MailAddress.StreetName1;
                        sNameAddressTemp += (!string.IsNullOrEmpty(sNameAddressTemp.Trim()) ? " " : "") + customer.MailAddress.StreetName2;
                        sNameAddressTemp += (!string.IsNullOrEmpty(sNameAddressTemp.Trim()) ? " " : "") + customer.MailAddress.City;
                        sNameAddressTemp += (!string.IsNullOrEmpty(sNameAddressTemp.Trim()) ? ", " : "") + customer.MailAddress.State;
                        sNameAddressTemp += (!string.IsNullOrEmpty(sNameAddressTemp.Trim()) ? " " : "") + customer.MailAddress.ZIPCode;
                    }
                    else
                    {
                        sNameAddressTemp += (!string.IsNullOrEmpty(sNameAddressTemp.Trim()) ? ", " : "") + customer.CustomerAddress.StreetName1;
                        sNameAddressTemp += (!string.IsNullOrEmpty(sNameAddressTemp.Trim()) ? " " : "") + customer.CustomerAddress.StreetName2;
                        sNameAddressTemp += (!string.IsNullOrEmpty(sNameAddressTemp.Trim()) ? " " : "") + customer.CustomerAddress.City;
                        sNameAddressTemp += (!string.IsNullOrEmpty(sNameAddressTemp.Trim()) ? ", " : "") + customer.CustomerAddress.State;
                        sNameAddressTemp += (!string.IsNullOrEmpty(sNameAddressTemp.Trim()) ? " " : "") + customer.CustomerAddress.ZIPCode;
                    }
                    sNameAddressTemp = sNameAddressTemp.TrimEnd(new char[] { ',', ' ' });
                    dgCustomerList.Rows.Add(!customer.Excluded, customer.CustomerType, customer.ServicePointID, sNameAddressTemp, customer.MeterNumber, customer.SNO);
                    icountEx += customer.Excluded ? 0 : 1;
                }
                lblcustlistNo.Text = icountEx.ToString();
                btncustlistNext.Enabled = Convert.ToInt32(lblcustlistNo.Text) > 0;
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        private void ActivatePanel(Panel p)
        {
            ...
            pnlOutageInfo.Visible = false;
            pnlEmail.Visible = false;
            pnlAveryLabel.Visible = false;
            pnlCustomerNotificationPrint.Visible = false;
            pnlCustomerNotification.Visible = false;
            p.Visible = true;
            //p.Location = new System.Drawing.Point() { X = 0, Y = 0 };
        ...
        private void LoadPSCList()
        {
            try
            {
                ...
                {
                    combosource.Add(pRow["LANID"].ToString().Trim() + "," + pRow["ContactID"].ToString().Trim(), pRow["FName"] + " " + pRow["LName"] + " [" + pRow["Division"].ToString().Trim() + "]");
        ...
        private void btnSearchAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else if (this.rbTransformerSearch.Checked)
                {
                    ...
                    if (ValidateTransformerInputValue(this.txtTransformer.Text, out CircuitID, out FeatureClass))
                    {
                        ...
                        CircuitID, "TransformerSearch", this.txtTransformer.Text, FeatureClass});
        ...
        private bool ValidateTransformerInputValue(string InputText, out string CircuitID, out string FeatureClass)
        {
            bool bReturn = false;
            ...
            try
            {
                ...
                {
                    MessageBox.Show("Enter CGC number.");
                    CircuitID = "";
                    return bReturn;
                }
                ...
                List<TransformerDetails> circuitids = mu.GetTransformerCircuitIdsdetails(InputText, out FeatureClass);
        ...
        {
           // dtpshutdowndateON2.MinDate = dtpshutdowndate2.Value;
        }
        ...
        private void btnoutageReset_Click(object sender, EventArgs e)
        {
            ...
            this.dtpshutdowntimeon.Value = new System.DateTime(dtpshutdowndate.Value.Year, dtpshutdowndate.Value.Month, dtpshutdowndate.Value.Day, 00, 30, 00, 0);
            this.dtpshutdowntimeoff.Value = new System.DateTime(dtpshutdowndate.Value.Year, dtpshutdowndate.Value.Month, dtpshutdowndate.Value.Day, 00, 00, 00, 0);
            this.dtpshutdowntimeon2.Value = new System.DateTime(dtpshutdowndate2.Value.Year, dtpshutdowndate2.Value.Month, dtpshutdowndate2.Value.Day, 00, 30, 00, 0);
            this.dtpshutdowntimeoff2.Value = new System.DateTime(dtpshutdowndate2.Value.Year, dtpshutdowndate2.Value.Month, dtpshutdowndate2.Value.Day, 00, 00, 00, 0);
        }
        ...
        private void dgCustomerList_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                if (e.ColumnIndex == 0)
                {
                    ...
                    lblcustlistNo.Text = iCountSelected.ToString();
                }
                btncustlistNext.Enabled = Convert.ToInt32(lblcustlistNo.Text) > 0;
            }
            catch (Exception ex)
        ...
        private void btnWelcomeProceed_Click_1(object sender, EventArgs e)
        {
