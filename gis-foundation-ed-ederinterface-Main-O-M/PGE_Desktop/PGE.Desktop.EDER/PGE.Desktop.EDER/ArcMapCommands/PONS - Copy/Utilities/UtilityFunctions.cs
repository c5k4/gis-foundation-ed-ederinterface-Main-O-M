                    ...
                    for (int i = 0; i <= Params.Rows.Count - 1; i++)
                    {
                        try
                        {
                            ...
                            switch (Convert.ToString(Params.Rows[i][1]))
                            {
                                case "String":
                                    {
                                        param = OraCmd.Parameters.Add(Convert.ToString(Params.Rows[i][0]), OracleType.NVarChar);
                                ...
                                case "DateTime":
                                    {
                                        param = OraCmd.Parameters.Add(Convert.ToString(Params.Rows[i][0]), OracleType.DateTime);
                                        if (Params.Rows[i][2] == null)
                                        {
                                            param.Value = DBNull.Value;
                                        }
                                ...
                                case "Integer":
                                    {
                                        param = OraCmd.Parameters.Add(Convert.ToString(Params.Rows[i][0]), OracleType.Int32);
                                        if (Params.Rows[i][2] == null)
                                        {
                                            param.Value = DBNull.Value;
                                        }
            ...
            try
            {
                ...
                try
                {
                    ...
                    if (!string.IsNullOrEmpty(VersionName))
                    {
                        ...
                        param.Direction = ParameterDirection.Input;
                        param = OraCmd.Parameters.Add("P_VERSION", OracleType.VarChar);
                        ...
                        try
                        {
                            ...
                            switch (Convert.ToString(Params.Rows[i][1]))
                            {
                                ...
                                case "OracleType.VarChar":
                                    {
                                        param = OraCmd.Parameters.Add(Convert.ToString(Params.Rows[i][0]), OracleType.VarChar);
                                        if (Params.Rows[i][2] == null)
                                        {
                                            param.Value = DBNull.Value;
                                        }
                                ...
                                case "OracleType.Number":
                                    {
                                        param = OraCmd.Parameters.Add(Convert.ToString(Params.Rows[i][0]), OracleType.Number);
                                        if (Params.Rows[i][2] == null)
                                        {
                                            param.Value = DBNull.Value;
                                        }
                    ...
                    param = default(OracleParameter);
                    param = OraCmd.Parameters.Add("p_cursor", OracleType.Cursor);
                ...
                {
                    {
                        ...
                        DataTable dtCustomerList = ExecuteSP(ReadConfigurationValue("EDER_ConnectionString"),
