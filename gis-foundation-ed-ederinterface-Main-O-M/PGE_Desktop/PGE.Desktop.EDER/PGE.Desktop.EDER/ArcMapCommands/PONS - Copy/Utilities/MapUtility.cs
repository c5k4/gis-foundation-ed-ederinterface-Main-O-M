...
namespace Telvent.PGE.ED.Desktop.ArcMapCommands.PONS
{
    ...
    class MapUtility
    {
        ...
        public List<TransformerDetails> GetTransformerCircuitIdsdetails(string cgcno, out string FeatureClass)
        {
        ...
        public Dictionary<string, string> GetSubStations()
        {
            ...
            try
            {
                ...
                IQueryFilter queryFilter = new QueryFilterClass();
                queryFilter.WhereClause = "DIVISION='" + Convert.ToInt32(PGEGlobal.WIZARD_DIVISION_CODE) + "'";
            ...
            try
            {
                ...
                if (pSubstation != null)
                {
                    ...
                    if (dConductors.Count > 0)
                    {
                        ...
                        dConductors = dConductors.OrderBy(x => x.Value).ToDictionary(x => x.Key, x => x.Value);
                        int iRecordCount = 0;
        ...
        private List<string> GetCircuitIdsforbank(string substationid, string bankcode)
        {
            ...
            try
            {
                ...
                dtCircuitIDs = objUtilityFunctions.ExecuteQuery("SELECT FEEDERID FROM " +
                            ...
                            " WHERE FEEDERFEDBY = '" + bankcode + "' AND FEEDERID IS NOT NULL", objUtilityFunctions.ReadConfigurationValue("WEBR_ConnectionString"));
        ...
        private IFeatureLayer GetFeatureLayerfromFCName(string featureclassName)
        {
            IFeatureLayer fLayer = null;
            try
            {
