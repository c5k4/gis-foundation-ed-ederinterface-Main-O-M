...
using PGE.Desktop.EDER.Utility.Annotation;
...
namespace PGE.Desktop.EDER.ArcMapCommands
{
    ...
    [ProgId("PGE.Desktop.EDER.ReplaceAnnotation")]
    ...
    public sealed class ReplaceAnnotation : BaseTool
    {
        ...
        public ReplaceAnnotation()
        {
            ...
            try
            {
                ...
                base.m_bitmap = new Bitmap(Assembly.GetExecutingAssembly().GetManifestResourceStream("PGE.Desktop.EDER.Bitmaps.ReplaceAnnotation.bmp"));
