...
using PGE.BatchApplication.ArcFmWebConfigLimited.Core.Output;
using PGE.Common.CommandFlags;
using PGE.Common.Delivery.Diagnostics;

namespace PGE.BatchApplication.ArcFmWebConfigLimited
{
    public static class Program
    {
        ...
        private static void ProcessArguments(string[] args)
        {
            ...
            if (_showHelp)
            {
                Logger.Warn("Usage: \nPGE.BatchApplication.ArcFmWebConfigLimited.exe -o " +
                            ...
                            "\nPGE.BatchApplication.ArcFmWebConfigLimited.exe -h" +
                            "\nProvides help with command usage\n");

                Logger.Warn("Ex: " +
                            "\nPGE.BatchApplication.ArcFmWebConfigLimited.exe -o WriteDbToCsv");
                Logger.Warn(
