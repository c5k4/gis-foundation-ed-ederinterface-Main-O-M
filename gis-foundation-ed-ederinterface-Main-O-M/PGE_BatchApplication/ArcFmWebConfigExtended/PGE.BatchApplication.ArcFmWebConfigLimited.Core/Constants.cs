        ...
        internal class SimpleSetting
        {
            ...
            public static readonly Dictionary<mmFieldSettingType, Property> Settings
                = new Dictionary<mmFieldSettingType, Property>
                {
                    ...
                    {mmFieldSettingType.mmFSClearOnCreate, new Property(8, mmFieldSettingType.mmFSClearOnCreate.ToString())},
                    {mmFieldSettingType.mmSSSplitOnFeature, new Property(9, mmFieldSettingType.mmSSSplitOnFeature.ToString())},
                };
