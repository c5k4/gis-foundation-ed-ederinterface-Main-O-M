...
namespace PGE.BatchApplication.Version_report.DBHelper
{
       
        public static class cls_DBHelper_For_EDER
        {
        ...
        //    public static Log4NetLogger _log = new Log4NetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType, ReadConfigurations.LOGCONFIG);
            ...
            public static void OpenConnection(out OracleConnection objconOra)
            {
                ...
                try
                {
                    if (conOraEDER == null)
                    {
                    // mejf edgisrearch 919 - get connection string using Password management tool  
                    ...
                    string oracleConnectionString = ReadEncryption.GetConnectionStr(ConfigurationManager.AppSettings["EDER_ConnectionStr"].ToUpper());
