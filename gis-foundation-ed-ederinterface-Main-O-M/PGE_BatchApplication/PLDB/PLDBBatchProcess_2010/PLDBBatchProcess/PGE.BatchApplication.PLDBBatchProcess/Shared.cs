...
namespace PGE.BatchApplication.PLDBBatchProcess
{
    public static class Shared
    {
            ...
            try
            {
                ...
                if (_logFilename == string.Empty)
                    _logFilename = 
                        ...
                        ConfigurationManager.AppSettings.Get(
                            PLDBBatchConstants.CONFIG_LOG_FILE) + "_" + DateTime.Now.ToString("dd_MM_yyyy_hh_mm")  + ".txt";
        ...
        public static void LoadWorkspaces()
        {
            try
            {
                ...
                _hshWorkspaces.Add("electric", GetWorkspace(ReadEncryption.GetSDEPath( 
                    ConfigurationManager.AppSettings.Get(
                        PLDBBatchConstants.CONFIG_EDGIS_SDE).ToUpper())));
                _hshWorkspaces.Add("wip", GetWorkspace(ReadEncryption.GetSDEPath(
                    ConfigurationManager.AppSettings.Get(
                        PLDBBatchConstants.CONFIG_WIP_SDE).ToUpper())));
    ...
    public class Pole
    {
        ...
        private string _PGE_SketchLocation;
        private string _PGE_OrderNumber;
        private string _PGE_NotificationNumber;
        private string _PGE_MatCode;
        private string _PGE_Description;
        private string _PGE_LANID;
        ...
        private long sapEquipId;
        private string globalId;
        private string snowLoadDistrict;
        private string PGE_SketchLocation;
        private string PGE_OrderNumber;
        private string PGE_NotificationNumber;
        private string PGE_MatCode;
        private string PGE_Description;
        private string PGE_LANID;
        private double xVal;
        private double yVal; 
            ...
            double yVal)
        {
            ...
            _PGE_Description = PGE_Description;
            _PGE_LANID = PGE_LANID;
            _PGE_MatCode = PGE_MatCode;
            _PGE_NotificationNumber = PGE_NotificationNumber;
            _PGE_OrderNumber = PGE_OrderNumber;
            _PGE_SketchLocation = PGE_SketchLocation;
            _xVal = xVal;
            _yVal = yVal; 
        }
        ...
        {
            get { return _PGE_SketchLocation; }
        }
        public string OrderNumber
        {
            get { return _PGE_OrderNumber ; }
        }
        public string NotificationNumber
        {
            get { return _PGE_NotificationNumber; }
        }
        public string PGEMatCode
        {
            get { return _PGE_MatCode; }
        }
        //public string Description
        //{
        //    get { return _PGE_Description; }
        //}
        public string LANID
        {
            get { return _PGE_LANID; }
        }
