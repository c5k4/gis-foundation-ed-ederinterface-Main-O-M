    ...
    public class DBHelper
    {
      ...
      //  log4net.ILog objLogger = null;
        ...
        public void OpenPGEDataConnection()
        {
            ...
            {
                objLogger.Info("OpenConnection():", ex);
                throw ex;
        ...
        public void BulkInsert(DataTable DT, bool blTransactionBased)
        {
            try
            {
                if (conOra == null)
                ...
                using (OracleBulkCopy bulkCopy = new OracleBulkCopy(conOra))
                {
                    ...
                    bulkCopy.DestinationTableName = "PGEDATA.Ed06_GISPLDB_Interface";
                    bulkCopy.WriteToServer(DT);
                    Console.WriteLine("PGEDATA.Ed06_GISPLDB_Interface Inserted Success!!");
                }
            }
            catch (Exception ex)
            {
