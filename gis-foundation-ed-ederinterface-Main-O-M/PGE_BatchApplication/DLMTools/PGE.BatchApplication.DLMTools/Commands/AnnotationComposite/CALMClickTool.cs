...
namespace PGE.BatchApplication.DLMTools.Commands.AnnotationComposite
{
    ...
    /// </summary>
    [Guid("9FCDA8A6-5479-4F00-A73D-AB03594B0DAE")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("PGE.BatchApplication.DLMTools.MOWEDClickTool")]
    ...
    public sealed class CALMClickTool : BaseCALMTool
    {
        ...
        {
            base.m_caption = "Move Anno";  //localizable text 
            ...
            base.m_name = "MOWED";   //unique id, non-localizable (e.g. "MyCategory_ArcMapTool")
            try
            {
                base.m_bitmap = new Bitmap(Assembly.GetExecutingAssembly().GetManifestResourceStream("PGE.BatchApplication.DLMTools.Bitmaps.CALM.bmp"));
        ...
        public override void OnMouseUp(int Button, int Shift, int X, int Y)
        {
            ...
            try
            {
                if (ReadSettings())
                {
                    ...
                    _pEditor.StopOperation("MOWED Annotation Tool");
                }
            }
            catch (Exception)
            {
