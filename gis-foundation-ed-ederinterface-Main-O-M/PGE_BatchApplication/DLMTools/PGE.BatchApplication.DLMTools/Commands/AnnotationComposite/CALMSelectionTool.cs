...
namespace PGE.BatchApplication.DLMTools.Commands.AnnotationComposite
{
    ...
    /// </summary>
    [Guid("0AD9365C-347B-47FA-95F0-C88836FA9E9E")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("PGE.BatchApplication.DLMTools.MOWEDSelectionTool")]
    ...
    public sealed class CALMSelectionTool : BaseCALMTool
    {
        ...
        {
            base.m_caption = "Move Selected Anno";  //localizable text 
            ...
            base.m_name = "MOWED Selection";   //unique id, non-localizable (e.g. "MyCategory_ArcMapTool")
            try
            {
                base.m_bitmap = new Bitmap(Assembly.GetExecutingAssembly().GetManifestResourceStream("PGE.BatchApplication.DLMTools.Bitmaps.CALMSelection.bmp"));
            }
            catch (Exception ex)
            {
        ...
        public override void OnClick()
        {
            ...
            {
                MessageBox.Show("Must be editing!", "MOWED", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            ...
            try
            {
                if (ReadSettings())
                {
                    ...
                    _pEditor.StopOperation("MOWED Annotation Selection Tool");
                }
            }
            catch (Exception)
            {
