...
namespace PGE.BatchApplication.DLMTools.Utility.Annotation
{
    ...
    public class CALMConfig
    {
        ...
        public string FilePath
        {
            get
            {
                string directory = Path.Combine(Path.GetDirectoryName(Assembly.GetAssembly(this.GetType()).Location), "MOWEDConfig");
                if (!Directory.Exists(directory))
                    Directory.CreateDirectory(directory);

                return Path.Combine(directory, "MOWEDSettings.xml");
            }
        }
        ...
        public CALMConfig()
        {
            ...
            _userSettings = new DataTable("MOWEDFavorite");
            ...
            else
            {
                ...
                {
                    MessageBox.Show("Error reading the MOWED Toolbar settings. Check to ensure that the values are accurate.", "MOWED Toolbar", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
        }
