...
namespace PGE.BatchApplication.DLMTools.Utility
{
    ...
    public class ModelNameFacade
    {
        ...
        public static IRelationshipClass RelationshipClassFromModelName(IObjectClass oclass, esriRelRole relRole, params string[] modelNames)
        {
            var enumClasses = oclass.RelationshipClasses[relRole];
            try
            {
        ...
        public static List<IFeatureLayer> FeatureLayerByModelName(string featureClassModelName, IMap map, bool all)
        {
            ...
            try
            {
                ...
                while ((featLayer = (IFeatureLayer)enumLayer.Next()) != null)
                {
                    ...
                    if (ModelNameManager.ContainsClassModelName(featLayer.FeatureClass, featureClassModelName))
                    {
        ...
        public static IRelationshipClass GetRelationshipByModelName(IObjectClass pObjectClass, string relatedObjectModelName)
        {
            ...
            try
            {
                ...
                while (rc != null)
                {
                    ...
                    if (ContainsClassModelName(rc.OriginClass, relatedObjectModelName) ||
                        ContainsClassModelName(rc.DestinationClass, relatedObjectModelName))
                    {
                        relClass = rc;
                        break;
                    }
        ...
        public static IList<IObject> GetRelatedObjectsByModelNamesList(IRow pRow, String[] modelNames)
        {
            IList<IObject> objects = new List<IObject>();
            foreach (String modelName in modelNames)
            {
                ISet relatedObjects = GetRelatedObjects(pRow, modelName);

                for (object o = relatedObjects.Next(); o != null; o = relatedObjects.Next())
                {
                    objects.Add(o as IObject);
                }
            }
