...
//                                _logger.Debug("Licenses successfully checked out");
                                ...
                                PGE_SSD_Initialization cache_Tracing = new PGE_SSD_Initialization();
                            ...
                            else
                            {
                                ...
                                _logger.Debug("Beginning execution");
                                PGE_SSD_Initialization ssd_Init = new PGE_SSD_Initialization();
                    ...
                    else
                    {
                        ...
                        Console.WriteLine("Invalid configuration.  Please check the PGE.BatchApplication.PGE_SSD_Initialization.exe.config file" +
